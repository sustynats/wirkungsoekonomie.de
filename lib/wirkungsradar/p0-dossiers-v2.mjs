...
function derivedFactsLayer(slug, item, whatIsTrue, whatIsMissing) {
  ...
  return {
    ...
    accountingBoundaries: [
      {
        label: "Bilanzgrenze",
        explanation: item.bilanzgrenze || "Fakten, Folgekosten, bessere Loesungswege, Alternativen, Vertrauen und demokratische Entscheidung.",
...
function makeDossier(slug, item) {
  ...
  return {
    ...
    trustBlock: {
      ...
      bilanzgrenze: item.bilanzgrenze || "Fakten, Folgekosten, bessere Loesungswege, Alternativen, Vertrauen und demokratische Entscheidung.",
...
const rawP0DossiersV2 = [
  ...
  makeDossier("radwege-in-peru", {
    ...
    claim: "Für Radwege in Peru ist Geld da.",
    topicCluster: ["Steuergeld", "Globale Verantwortung", "Mobilität"],
    shortJudgement: "Spottbild statt Wirkungsprüfung.",
    sayThisNow: "Nicht alles ist Geschenk: Die Radwege sind ein kleiner Zuschussteil, die Metro ist der große Kreditteil. Entscheidend ist Wirkung: sichere Wege, weniger Stau, Kontrolle und Nutzen auch für Deutschland.",
    ...
    betterQuestion: "Welcher Teil ist Zuschuss, welcher Kredit, was wird zurückgezahlt, was bewirkt das Projekt und welchen Nutzen hat es auch für Deutschland?",
    ...
    simpleMechanism: "Ein Spottbild ersetzt die Wirkungsprüfung. Die bessere Rechnung trennt Ort, Finanzierungsform, Rückzahlung, Kontrolle, Mobilitätsnutzen und deutschen Nutzen durch Klima, Standards, Partnerschaft und Aufträge.",
    responses: {
      comment: {
        text: "Radwege in Lima sind kein Luxusbild, sondern Teil eines Verkehrssystems. Wichtig ist die Trennung: Radwege-Zuschuss, Metro-Kredit, Rückzahlung, Kontrolle, Wirkung und deutscher Nutzen.",
      },
      live: {
