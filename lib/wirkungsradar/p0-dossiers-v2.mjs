...
function makeDossier(slug, item) {
  ...
  return {
    ...
    explain: {
      whatIsTrue: item.whatIsTrue || ["Es gibt einen pruefbaren wahren Punkt."],
      whatIsMissing: item.whatIsMissing || ["Die Aussage laesst Folgen, Alternativen und Bilanzgrenzen aus."],
    ...
    deepDive: {
      sections: [
        { title: "Wahrer Punkt", body: item.whatIsTrue?.join(" ") || "Es gibt einen pruefbaren Kern." },
        { title: "Fehlende Rechnung", body: item.whatIsMissing?.join(" ") || "Die Aussage laesst Wirkung und Alternativen aus." },
      ],
    },
    quality: {
...
export const p0DossiersV2 = [
  makeDossier("migration-kostet-nur", {
    ...
    oldFrame: "Migration als Kostenlast.",
