...
- Extra tracked source HTML not in sitemap: **14201**
- Routes with non-default #253 action: **1425**
...
- Tracked support text files inventoried: **938**
- Combined matrix items (routes + extra HTML + support): **17188**
...
| `scripts/academy/build-v4-main-domain.mjs` | site_generator_or_quality_tool | NO_CHANGE_REQUIRED | folgenabschaetzung, nachhaltigkeitspruefung, enap, egfa, dns, alternativen, evaluation |
