...
Dieses Skript zu **V13 Handlung, Unterlassen und Zustandsveränderung** ist als Langformtext angelegt. Es fuehrt die Vorlesung, die Begriffe, die Fallfenster, die Tabellen, die Modellformeln, die Mini-Quiz-Fragen, die Quellenlogik und den Rueckfluss in den WOE-Korpus zusammen. Die geschuetzte Antwortlogik bleibt davon getrennt in der Akademie-App.

Der Abschluss liest **Handlung, Unterlassen und Zustandsveränderung** im Feld **Grundstudium Wirkungsoekonomie**. Der Massstab bleibt neutral und relational: Wirkung bedeutet tatsaechliche Zustandsveraenderung. Wirkungspotenzial beschreibt plausible Moeglichkeit. Wirkungsrisiko beschreibt moegliche negative Veraenderung. Wenn eine Zielgroesse gemeint ist, geht es um positive Netto-Wirkung. Genau diese Trennung entscheidet, ob das Skript fachlich traegt.

### Abschlussmatrix

| Pruefebene | Anwendung in V13 | Grenze |
|---|---|---|
...
### Schlussvertiefung 1: Handlung, Unterlassen und Zustandsveränderung im Anwendungsfall
...
**Bewertung und rote Linien.** In Grundstudium Wirkungsoekonomie wird **Vom Verstehen zum Erkennen** erst steuerungsfaehig, wenn daraus eine Entscheidung folgt. Die Grundbegriffe muessen in spaeteren Modulen wiedererkennbar bleiben. Ohne diese Rueckkopplung bleibt Reporting eine Beschreibung. Mit Rueckkopplung wird aus Bewertung eine veraenderte Routine: ein anderer Prozess, ein geaenderter Anreiz, eine bessere Datenpflicht, eine korrigierte Kommunikation oder eine neue Priorisierung.

Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Vom Verstehen zum Erkennen** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Vom Verstehen zum Erkennen** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

**Steuerung und Rueckkopplung.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Wirkung ist Zustandsveränderung** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.

Fuer die Pruefung ist **Wirkung ist Zustandsveränderung** dann verstanden, wenn daraus eine belastbare Fallantwort entsteht. Eine gute Antwort unterscheidet Beobachtung, Kausalannahme, Bewertung und Steuerungsfolge. Sie bewertet keine Menschen, sondern Wirkpfade, Zustandsveraenderungen, Risiken und institutionelle Bedingungen.

**Pruefungsnahe Anwendung.** Wirkung durch Handlung zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.

Eine Kommune, ein Unternehmen oder eine Bildungsorganisation will **Handlung, Unterlassen und Zustandsveränderung** praktisch anwenden. Der erste Schritt ist nicht die Auswahl eines Instruments, sondern die Klaerung der Zustandsveraenderung. Bei **Wirkung durch Handlung** muss deshalb benannt werden, wer betroffen ist, welcher Zustand sich veraendert, welche Frist gilt und welche Gegenbeobachtung die Annahme widerlegen wuerde. Erst danach entsteht eine begruendete Entscheidung im Feld Begriff, Fallbewertung, Wirkpfad, rote Linie, Quellenbeurteilung oder Rueckkopplungsregel.

**Rueckfluss.** Fuer den WOE-Korpus bedeutet das: Begriffe aus **Handlung, Unterlassen und Zustandsveränderung** sollten dort geschaerft werden, wo sie in Glossar, Werkzeugen, Journal oder Readern doppeldeutig bleiben. Offene Forschungsfragen werden nicht versteckt. Sie markieren die Stelle, an der spaetere Evidenz, ein besserer Datensatz oder eine praezisere Fallstudie die Bewertung veraendern kann.

**Transfer in den WOE-Korpus.** In V13 muss **Wirkung durch Unterlassen** immer mit Empfaengern gelesen werden. Wirkung entsteht nicht beim Sender, sondern an veraenderten Zustaenden von Menschen, Oekosystemen, Institutionen, Oeffentlichkeit oder kuenftigen Handlungsspielraeumen. Darum reicht es nicht, interne Aktivitaeten zu dokumentieren. Entscheidend ist, ob sich ein Zustand nachvollziehbar veraendert und ob diese Veraenderung im Referenzrahmen Mensch, Planet, Demokratie, SDGs, Agenda 2030 und SDG+ tragfaehig bewertet werden kann.

Ein Bericht behauptet, die Massnahme zu **Handlung, Unterlassen und Zustandsveränderung** sei erfolgreich. Die WOE-Lesart fragt bei **Wirkung durch Unterlassen** nach belastbaren Nachweisen: begriffliche Praezision, Fallbeschreibung, Quellenklarheit, Plausibilitaet und offene Unsicherheit. Wenn diese Nachweise fehlen, bleibt die Aussage Wirkungspotenzial oder Kommunikationsbehauptung. Sie kann wichtig sein, aber sie ist noch keine belegte Wirkung.

**Grenzen der Aussage.** Wissenschaftliche Anschlussfaehigkeit entsteht hier durch Quellenklarheit. Bei **Warum das Unterlassen zählt** werden interne WOE-Begriffe nicht als Ersatz fuer Belege benutzt, sondern mit Grundlagenwerk, WOE-Referenz, Glossar, Werkzeuge, Journal und externe Fachquellen verbunden. Wo die Datenlage offen bleibt, wird das offengelegt. Wo eine Aussage nur plausibel ist, bleibt sie als Wirkungspotenzial markiert. Wo ein Schaden eine rote Linie beruehrt, greift Nichtkompensation vor Durchschnittslogik.

In einer kontroversen Entscheidung wirkt **Warum das Unterlassen zählt** als Pruefpunkt fuer Ambivalenz. Ein Nutzen fuer eine Gruppe kann mit Risiken fuer andere Wirkungsempfaenger einhergehen. Das Skript verlangt deshalb, positive und negative Zustandsveraenderungen getrennt zu fuehren, bevor von positiver Netto-Wirkung gesprochen wird.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Warum das Unterlassen zählt** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

### Schlussvertiefung 2: Handlung, Unterlassen und Zustandsveränderung im Anwendungsfall

Die folgenden Abschnitte sind keine neue Pruefungsloesung. Sie verdichten die vorhandenen Kapitel zu einer Lesart, mit der Studierende einen Fall selbststaendig analysieren koennen. Im Mittelpunkt stehen Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung, nicht moralische Personenbewertung.

**Begriffliche Schlussklaerung.** In Grundstudium Wirkungsoekonomie wird **Ein Beispiel: dieselbe Firma, zwei Wege** erst steuerungsfaehig, wenn daraus eine Entscheidung folgt. Die Grundbegriffe muessen in spaeteren Modulen wiedererkennbar bleiben. Ohne diese Rueckkopplung bleibt Reporting eine Beschreibung. Mit Rueckkopplung wird aus Bewertung eine veraenderte Routine: ein anderer Prozess, ein geaenderter Anreiz, eine bessere Datenpflicht, eine korrigierte Kommunikation oder eine neue Priorisierung.

Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Ein Beispiel: dieselbe Firma, zwei Wege** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Wirkpfad und Empfaenger.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Die Grenze: nicht alles ist jedem zuzurechnen** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.

Fuer die Pruefung ist **Die Grenze: nicht alles ist jedem zuzurechnen** dann verstanden, wenn daraus eine belastbare Fallantwort entsteht. Eine gute Antwort unterscheidet Beobachtung, Kausalannahme, Bewertung und Steuerungsfolge. Sie bewertet keine Menschen, sondern Wirkpfade, Zustandsveraenderungen, Risiken und institutionelle Bedingungen.

**Daten, Quellen und Evidenz.** Handeln und Unterlassen zusammen sehen zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.

Eine Kommune, ein Unternehmen oder eine Bildungsorganisation will **Handlung, Unterlassen und Zustandsveränderung** praktisch anwenden. Der erste Schritt ist nicht die Auswahl eines Instruments, sondern die Klaerung der Zustandsveraenderung. Bei **Handeln und Unterlassen zusammen sehen** muss deshalb benannt werden, wer betroffen ist, welcher Zustand sich veraendert, welche Frist gilt und welche Gegenbeobachtung die Annahme widerlegen wuerde. Erst danach entsteht eine begruendete Entscheidung im Feld Begriff, Fallbewertung, Wirkpfad, rote Linie, Quellenbeurteilung oder Rueckkopplungsregel.

**Bewertung und rote Linien.** In V13 muss **Der geübte Blick auf die Ausgangslage** immer mit Empfaengern gelesen werden. Wirkung entsteht nicht beim Sender, sondern an veraenderten Zustaenden von Menschen, Oekosystemen, Institutionen, Oeffentlichkeit oder kuenftigen Handlungsspielraeumen. Darum reicht es nicht, interne Aktivitaeten zu dokumentieren. Entscheidend ist, ob sich ein Zustand nachvollziehbar veraendert und ob diese Veraenderung im Referenzrahmen Mensch, Planet, Demokratie, SDGs, Agenda 2030 und SDG+ tragfaehig bewertet werden kann.

Ein Bericht behauptet, die Massnahme zu **Handlung, Unterlassen und Zustandsveränderung** sei erfolgreich. Die WOE-Lesart fragt bei **Der geübte Blick auf die Ausgangslage** nach belastbaren Nachweisen: begriffliche Praezision, Fallbeschreibung, Quellenklarheit, Plausibilitaet und offene Unsicherheit. Wenn diese Nachweise fehlen, bleibt die Aussage Wirkungspotenzial oder Kommunikationsbehauptung. Sie kann wichtig sein, aber sie ist noch keine belegte Wirkung.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Der geübte Blick auf die Ausgangslage** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.
...
Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Wirkungsökonomische Vertiefung** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Transfer in den WOE-Korpus.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Begriffliche Präzision** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.
...
**Grenzen der Aussage.** Wirkpfad zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.

Eine Kommune, ein Unternehmen oder eine Bildungsorganisation will **Handlung, Unterlassen und Zustandsveränderung** praktisch anwenden. Der erste Schritt ist nicht die Auswahl eines Instruments, sondern die Klaerung der Zustandsveraenderung. Bei **Wirkpfad** muss deshalb benannt werden, wer betroffen ist, welcher Zustand sich veraendert, welche Frist gilt und welche Gegenbeobachtung die Annahme widerlegen wuerde. Erst danach entsteht eine begruendete Entscheidung im Feld Begriff, Fallbewertung, Wirkpfad, rote Linie, Quellenbeurteilung oder Rueckkopplungsregel.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Wirkpfad** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

### Schlussvertiefung 3: Handlung, Unterlassen und Zustandsveränderung im Anwendungsfall

Die folgenden Abschnitte sind keine neue Pruefungsloesung. Sie verdichten die vorhandenen Kapitel zu einer Lesart, mit der Studierende einen Fall selbststaendig analysieren koennen. Im Mittelpunkt stehen Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung, nicht moralische Personenbewertung.

**Begriffliche Schlussklaerung.** In V13 muss **Leitthese** immer mit Empfaengern gelesen werden. Wirkung entsteht nicht beim Sender, sondern an veraenderten Zustaenden von Menschen, Oekosystemen, Institutionen, Oeffentlichkeit oder kuenftigen Handlungsspielraeumen. Darum reicht es nicht, interne Aktivitaeten zu dokumentieren. Entscheidend ist, ob sich ein Zustand nachvollziehbar veraendert und ob diese Veraenderung im Referenzrahmen Mensch, Planet, Demokratie, SDGs, Agenda 2030 und SDG+ tragfaehig bewertet werden kann.

Ein Bericht behauptet, die Massnahme zu **Handlung, Unterlassen und Zustandsveränderung** sei erfolgreich. Die WOE-Lesart fragt bei **Leitthese** nach belastbaren Nachweisen: begriffliche Praezision, Fallbeschreibung, Quellenklarheit, Plausibilitaet und offene Unsicherheit. Wenn diese Nachweise fehlen, bleibt die Aussage Wirkungspotenzial oder Kommunikationsbehauptung. Sie kann wichtig sein, aber sie ist noch keine belegte Wirkung.
...
Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Analysemodell** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Bewertung und rote Linien.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Modellformel** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.
...
Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Kernaussage** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Kernaussage** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

**Rueckfluss.** Fuer den WOE-Korpus bedeutet das: Begriffe aus **Handlung, Unterlassen und Zustandsveränderung** sollten dort geschaerft werden, wo sie in Glossar, Werkzeugen, Journal oder Readern doppeldeutig bleiben. Offene Forschungsfragen werden nicht versteckt. Sie markieren die Stelle, an der spaetere Evidenz, ein besserer Datensatz oder eine praezisere Fallstudie die Bewertung veraendern kann.

### Schlussvertiefung 4: Handlung, Unterlassen und Zustandsveränderung im Anwendungsfall

Die folgenden Abschnitte sind keine neue Pruefungsloesung. Sie verdichten die vorhandenen Kapitel zu einer Lesart, mit der Studierende einen Fall selbststaendig analysieren koennen. Im Mittelpunkt stehen Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung, nicht moralische Personenbewertung.

**Begriffliche Schlussklaerung.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Quelltext und fachliche Grundlegung** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.
...
**Wirkpfad und Empfaenger.** Vom Verstehen zum Erkennen zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.

Eine Kommune, ein Unternehmen oder eine Bildungsorganisation will **Handlung, Unterlassen und Zustandsveränderung** praktisch anwenden. Der erste Schritt ist nicht die Auswahl eines Instruments, sondern die Klaerung der Zustandsveraenderung. Bei **Vom Verstehen zum Erkennen** muss deshalb benannt werden, wer betroffen ist, welcher Zustand sich veraendert, welche Frist gilt und welche Gegenbeobachtung die Annahme widerlegen wuerde. Erst danach entsteht eine begruendete Entscheidung im Feld Begriff, Fallbewertung, Wirkpfad, rote Linie, Quellenbeurteilung oder Rueckkopplungsregel.

**Daten, Quellen und Evidenz.** In V13 muss **Wirkung ist Zustandsveränderung** immer mit Empfaengern gelesen werden. Wirkung entsteht nicht beim Sender, sondern an veraenderten Zustaenden von Menschen, Oekosystemen, Institutionen, Oeffentlichkeit oder kuenftigen Handlungsspielraeumen. Darum reicht es nicht, interne Aktivitaeten zu dokumentieren. Entscheidend ist, ob sich ein Zustand nachvollziehbar veraendert und ob diese Veraenderung im Referenzrahmen Mensch, Planet, Demokratie, SDGs, Agenda 2030 und SDG+ tragfaehig bewertet werden kann.

Ein Bericht behauptet, die Massnahme zu **Handlung, Unterlassen und Zustandsveränderung** sei erfolgreich. Die WOE-Lesart fragt bei **Wirkung ist Zustandsveränderung** nach belastbaren Nachweisen: begriffliche Praezision, Fallbeschreibung, Quellenklarheit, Plausibilitaet und offene Unsicherheit. Wenn diese Nachweise fehlen, bleibt die Aussage Wirkungspotenzial oder Kommunikationsbehauptung. Sie kann wichtig sein, aber sie ist noch keine belegte Wirkung.

**Bewertung und rote Linien.** Wissenschaftliche Anschlussfaehigkeit entsteht hier durch Quellenklarheit. Bei **Wirkung durch Handlung** werden interne WOE-Begriffe nicht als Ersatz fuer Belege benutzt, sondern mit Grundlagenwerk, WOE-Referenz, Glossar, Werkzeuge, Journal und externe Fachquellen verbunden. Wo die Datenlage offen bleibt, wird das offengelegt. Wo eine Aussage nur plausibel ist, bleibt sie als Wirkungspotenzial markiert. Wo ein Schaden eine rote Linie beruehrt, greift Nichtkompensation vor Durchschnittslogik.

In einer kontroversen Entscheidung wirkt **Wirkung durch Handlung** als Pruefpunkt fuer Ambivalenz. Ein Nutzen fuer eine Gruppe kann mit Risiken fuer andere Wirkungsempfaenger einhergehen. Das Skript verlangt deshalb, positive und negative Zustandsveraenderungen getrennt zu fuehren, bevor von positiver Netto-Wirkung gesprochen wird.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Wirkung durch Handlung** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

**Steuerung und Rueckkopplung.** In Grundstudium Wirkungsoekonomie wird **Wirkung durch Unterlassen** erst steuerungsfaehig, wenn daraus eine Entscheidung folgt. Die Grundbegriffe muessen in spaeteren Modulen wiedererkennbar bleiben. Ohne diese Rueckkopplung bleibt Reporting eine Beschreibung. Mit Rueckkopplung wird aus Bewertung eine veraenderte Routine: ein anderer Prozess, ein geaenderter Anreiz, eine bessere Datenpflicht, eine korrigierte Kommunikation oder eine neue Priorisierung.

Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Wirkung durch Unterlassen** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Pruefungsnahe Anwendung.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Warum das Unterlassen zählt** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.

Fuer die Pruefung ist **Warum das Unterlassen zählt** dann verstanden, wenn daraus eine belastbare Fallantwort entsteht. Eine gute Antwort unterscheidet Beobachtung, Kausalannahme, Bewertung und Steuerungsfolge. Sie bewertet keine Menschen, sondern Wirkpfade, Zustandsveraenderungen, Risiken und institutionelle Bedingungen.

**Rueckfluss.** Fuer den WOE-Korpus bedeutet das: Begriffe aus **Handlung, Unterlassen und Zustandsveränderung** sollten dort geschaerft werden, wo sie in Glossar, Werkzeugen, Journal oder Readern doppeldeutig bleiben. Offene Forschungsfragen werden nicht versteckt. Sie markieren die Stelle, an der spaetere Evidenz, ein besserer Datensatz oder eine praezisere Fallstudie die Bewertung veraendern kann.

**Transfer in den WOE-Korpus.** Ein Beispiel: dieselbe Firma, zwei Wege zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.

Eine Kommune, ein Unternehmen oder eine Bildungsorganisation will **Handlung, Unterlassen und Zustandsveränderung** praktisch anwenden. Der erste Schritt ist nicht die Auswahl eines Instruments, sondern die Klaerung der Zustandsveraenderung. Bei **Ein Beispiel: dieselbe Firma, zwei Wege** muss deshalb benannt werden, wer betroffen ist, welcher Zustand sich veraendert, welche Frist gilt und welche Gegenbeobachtung die Annahme widerlegen wuerde. Erst danach entsteht eine begruendete Entscheidung im Feld Begriff, Fallbewertung, Wirkpfad, rote Linie, Quellenbeurteilung oder Rueckkopplungsregel.

**Grenzen der Aussage.** In V13 muss **Die Grenze: nicht alles ist jedem zuzurechnen** immer mit Empfaengern gelesen werden. Wirkung entsteht nicht beim Sender, sondern an veraenderten Zustaenden von Menschen, Oekosystemen, Institutionen, Oeffentlichkeit oder kuenftigen Handlungsspielraeumen. Darum reicht es nicht, interne Aktivitaeten zu dokumentieren. Entscheidend ist, ob sich ein Zustand nachvollziehbar veraendert und ob diese Veraenderung im Referenzrahmen Mensch, Planet, Demokratie, SDGs, Agenda 2030 und SDG+ tragfaehig bewertet werden kann.

Ein Bericht behauptet, die Massnahme zu **Handlung, Unterlassen und Zustandsveränderung** sei erfolgreich. Die WOE-Lesart fragt bei **Die Grenze: nicht alles ist jedem zuzurechnen** nach belastbaren Nachweisen: begriffliche Praezision, Fallbeschreibung, Quellenklarheit, Plausibilitaet und offene Unsicherheit. Wenn diese Nachweise fehlen, bleibt die Aussage Wirkungspotenzial oder Kommunikationsbehauptung. Sie kann wichtig sein, aber sie ist noch keine belegte Wirkung.

**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Die Grenze: nicht alles ist jedem zuzurechnen** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

### Schlussvertiefung 5: Handlung, Unterlassen und Zustandsveränderung im Anwendungsfall

Die folgenden Abschnitte sind keine neue Pruefungsloesung. Sie verdichten die vorhandenen Kapitel zu einer Lesart, mit der Studierende einen Fall selbststaendig analysieren koennen. Im Mittelpunkt stehen Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung, nicht moralische Personenbewertung.

**Begriffliche Schlussklaerung.** Wissenschaftliche Anschlussfaehigkeit entsteht hier durch Quellenklarheit. Bei **Handeln und Unterlassen zusammen sehen** werden interne WOE-Begriffe nicht als Ersatz fuer Belege benutzt, sondern mit Grundlagenwerk, WOE-Referenz, Glossar, Werkzeuge, Journal und externe Fachquellen verbunden. Wo die Datenlage offen bleibt, wird das offengelegt. Wo eine Aussage nur plausibel ist, bleibt sie als Wirkungspotenzial markiert. Wo ein Schaden eine rote Linie beruehrt, greift Nichtkompensation vor Durchschnittslogik.

In einer kontroversen Entscheidung wirkt **Handeln und Unterlassen zusammen sehen** als Pruefpunkt fuer Ambivalenz. Ein Nutzen fuer eine Gruppe kann mit Risiken fuer andere Wirkungsempfaenger einhergehen. Das Skript verlangt deshalb, positive und negative Zustandsveraenderungen getrennt zu fuehren, bevor von positiver Netto-Wirkung gesprochen wird.

**Wirkpfad und Empfaenger.** In Grundstudium Wirkungsoekonomie wird **Der geübte Blick auf die Ausgangslage** erst steuerungsfaehig, wenn daraus eine Entscheidung folgt. Die Grundbegriffe muessen in spaeteren Modulen wiedererkennbar bleiben. Ohne diese Rueckkopplung bleibt Reporting eine Beschreibung. Mit Rueckkopplung wird aus Bewertung eine veraenderte Routine: ein anderer Prozess, ein geaenderter Anreiz, eine bessere Datenpflicht, eine korrigierte Kommunikation oder eine neue Priorisierung.

Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Der geübte Blick auf die Ausgangslage** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Daten, Quellen und Evidenz.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Was du aus dieser Vorlesung mitnimmst** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.
...
**Bewertung und rote Linien.** Wirkungsökonomische Vertiefung zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.
...
Die typische Fehlstelle bei **Handlung, Unterlassen und Zustandsveränderung** liegt darin, Absicht, Aktivitaet oder Reporting als Wirkung zu behandeln. Bei **Leitthese** wird diese Fehlstelle konkret: Ein scheinbar plausibler Befund darf nicht zur Abkuerzung werden. Quellen, Systemgrenzen, Unsicherheit und Rueckkopplung bleiben sichtbar.

**Grenzen der Aussage.** Die Grenze gegen Scheingenauigkeit verlaeuft bei **Didaktische Einordnung im Studiengang** nicht zwischen Optimismus und Pessimismus. Sie verlaeuft zwischen offengelegter Unsicherheit und rhetorischer Sicherheit. Wer **Handlung, Unterlassen und Zustandsveränderung** belastbar anwenden will, benennt Systemgrenze, Zeitraum, Vergleichspunkt und offene Gegenhypothese. Gerade dadurch bleibt das Skript anschlussfaehig fuer Forschung, Praxis und spaetere Revision.
...
**Kontrollfrage.** Welche Entscheidung waere falsch, wenn **Didaktische Einordnung im Studiengang** in V13 missverstanden wird? Die Antwort muss mindestens eine Daten- oder Quellenannahme, eine betroffene Gruppe oder Schutzdimension, eine moegliche Nebenwirkung und einen Rueckkopplungsschritt nennen. Richtig ist nicht die lauteste Bewertung, sondern diejenige, die Begriff, Beleg und Steuerungsfolge zusammenhaelt.

### Schlussvertiefung 6: Handlung, Unterlassen und Zustandsveränderung im Anwendungsfall

Die folgenden Abschnitte sind keine neue Pruefungsloesung. Sie verdichten die vorhandenen Kapitel zu einer Lesart, mit der Studierende einen Fall selbststaendig analysieren koennen. Im Mittelpunkt stehen Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung, nicht moralische Personenbewertung.

**Begriffliche Schlussklaerung.** Analysemodell zeigt, warum **Handlung, Unterlassen und Zustandsveränderung** mehr ist als ein Schlagwort im Feld Wirkpfade, Wirkungsempfaenger, Bewertung und Rueckkopplung. Die wirkungsoekonomische Frage lautet: Welche reale Veraenderung wird moeglich, welche bleibt nur Potenzial und wo entsteht ein Wirkungsrisiko? Diese Unterscheidung schuetzt vor Impact-Washing, weil sie Absicht, Aktivitaet, Reichweite und Wirkung auseinanderhaelt.

Eine Kommune, ein Unternehmen oder eine Bildungsorganisation will **Handlung, Unterlassen und Zustandsveränderung** praktisch anwenden. Der erste Schritt ist nicht die Auswahl eines Instruments, sondern die Klaerung der Zustandsveraenderung. Bei **Analysemodell** muss deshalb benannt werden, wer betroffen ist, welcher Zustand sich veraendert, welche Frist gilt und welche Gegenbeobachtung die Annahme widerlegen wuerde. Erst danach entsteht eine begruendete Entscheidung im Feld Begriff, Fallbewertung, Wirkpfad, rote Linie, Quellenbeurteilung oder Rueckkopplungsregel.

### V1-Abschlussnotiz

Diese Finalisierung schliesst die Codex-Inhaltsproduktion fuer V13. Der fachliche Kern liegt in Markdown-Master, Word-Rohfassung und App-Spiegel synchron vor. Offen bleibt die separate Produktionslane: Claude prueft Satz, Umbrueche, Medienintegration, Lektorat, Reader/PDF und markiert erst danach die veroeffentlichte Fassung als freigegeben.
