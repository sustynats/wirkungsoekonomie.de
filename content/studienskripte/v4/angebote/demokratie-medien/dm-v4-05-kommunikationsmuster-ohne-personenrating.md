...
## Taktiken beschreiben, ohne Personen oder Motive zu etikettieren

## Lernziele
- Kommunikationsmuster am konkreten Objekt beschreiben
- Motiv und Absicht nicht aus Mustern ableiten
- Misinformation und Desinformation trennen
- Keyword-/Personenklassifikation vermeiden
...
## Konkretes Beispiel
Eine Frage lautet „Warum verschweigt die Regierung X?“. Moderatorisch kann zuerst geprüft werden, ob X tatsächlich verschwiegen wurde. Daraus folgt noch keine Aussage über Motiv oder Weltbild der fragenden Person.

## Gegenbeispiel / typische Fehlinterpretation
„Dieses Wort zeigt, dass der Gast absichtlich desinformiert.“ Ohne Intent-Evidenz unzulässig.

## Was bestehende Methoden/Institutionen bereits leisten
Rhetorik-, Argumentations- und Desinformationsforschung beschreiben Muster. Redaktionelle Praxis übersetzt sie in Prüffragen.

## WÖk-spezifische Einordnung
WÖk dokumentiert Kommunikationsobjekt, Kontext, plausiblen Mechanismus, Beobachtung und Unsicherheit.
...
Markiere in einem Interview zwei Muster und formuliere jeweils eine objektbezogene Prüfintervention ohne Personenetikett.
