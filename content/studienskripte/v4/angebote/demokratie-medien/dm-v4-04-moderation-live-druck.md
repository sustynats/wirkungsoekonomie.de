<!-- WOEK_PUBLIC_MASTER source=sustynats/woek-akademie-app@aa10de6b5a5c26badb3747fd3e4a97b540e327a7 path=content/lehrgaenge/akademie/curriculum-v4/offerings/demokratie-medien/lectures/dm-v4-04-moderation-live-druck.md curriculum=4.0 sanitized=true -->
...
## Status markieren, schützen und mit der kleinsten wirksamen Intervention arbeiten

## Lernziele
- Moderationsinterventionen als Optionen mit Wirkungshypothese behandeln
- Aussagestatus sichtbar machen
- Redegelegenheiten und Schutz fair gestalten
- Ruhe/Beschwerdezahl nicht als demokratische Wirkung missverstehen
...
- **Aussagestatus**
- **proportionale Intervention**
- **Redegelegenheit**
- **Schutzgrenze**
- **Nebenwirkung**

## Konkretes Beispiel
Eine unbelegte Zahl wird live genannt. Eine mögliche Mindestintervention: Quelle verlangen und Status „nicht verifiziert“ markieren, statt sofort Motiv oder Person zu bewerten.

## Gegenbeispiel / typische Fehlinterpretation
„Weniger Beschwerden nach der Sendung beweisen bessere Demokratiequalität.“ Beschwerden sind kein ausreichender Outcome-Indikator.

## Was bestehende Methoden/Institutionen bereits leisten
Redaktionelle Richtlinien, Pressekodex und Rundfunk-/Medienrecht strukturieren Moderationsentscheidungen.

## WÖk-spezifische Einordnung
WÖk ergänzt Intervention -> Mechanismus -> erwartete Zustandsänderung -> Beobachtung/Recheck.
...
Entwirf für drei Live-Situationen jeweils Problem, Ziel, zwei Optionen, kleinste Intervention und möglichen Recheck.

## Prüfungsrelevante Kernaussagen
Moderationsoptionen, Schutzgrenzen, proportionale Intervention und keine Outcome-Scheinsignale.
