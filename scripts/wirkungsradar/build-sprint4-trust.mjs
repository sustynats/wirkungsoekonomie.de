...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/style.css?v=20260604-sprint4">
  </head>
  <body>
    ...
    <script src="../../assets/js/main.js?v=20260604-sprint4"></script>
  </body>
</html>`;
}
...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="${base}assets/css/style.css?v=20260604-sprint4">
  </head>
  <body>
    ...
    <script src="${base}assets/js/main.js?v=20260604-sprint4"></script>
  </body>
</html>`;
}

function radarNav(base = "../") {
  return `<nav class="topic-subnav radar-sprint-nav" aria-label="Wirkungsradar Navigation" data-search-exclude><a href="${base}">Suchen</a><a href="${base}live/">Live-Karten</a><a href="${base}quellen/">Quellen</a><a href="${base}status/">Status</a><a href="${base}redaktion/">Redaktion</a><a href="${base}glossar/">Glossar</a><a href="${base}methode/">Methode</a></nav>`;
}
