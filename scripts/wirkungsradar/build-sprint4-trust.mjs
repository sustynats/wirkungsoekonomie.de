...
const packTemplates = {
  ...
  "e-autos-schlimmer-als-verbrenner": pack("e-autos-schlimmer-als-verbrenner", ["iea_evs", "icct_lifecycle_evs", "uba_emissions_inventory"], "lebenszyklusbezogen, gesundheitlich, geopolitisch", "Batterien brauchen Rohstoffe. Deshalb sind Lieferketten, Recycling, kleinere Fahrzeuge und sauberer Strom wichtig."),
...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="../../assets/css/style.css?v=20260604-sprint5b">
  </head>
  <body>
    ...
    <script src="../../assets/js/main.js?v=20260604-sprint5b"></script>
  </body>
</html>`;
}
...
function radarNav(base = "../") {
  return `<nav class="topic-subnav radar-sprint-nav" aria-label="Wirkungsradar Navigation" data-search-exclude><a href="${base}">Suchen</a><a href="${base}live/">Live-Karten</a><a href="${base}studio/">Studio</a><a href="${base}templates/">Templates</a><a href="${base}workshops/">Workshops</a><a href="${base}unterricht/">Unterricht</a><a href="${base}embed/">Embed</a><a href="${base}mythos-melden/">Mythos melden</a><a href="${base}host-playbook/">Host-Playbook</a><a href="${base}quellen/">Quellen</a><a href="${base}status/">Status</a><a href="${base}redaktion/">Redaktion</a><a href="${base}glossar/">Glossar</a><a href="${base}methode/">Methode</a></nav>`;
}
