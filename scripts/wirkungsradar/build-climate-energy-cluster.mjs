...
const claims = [
  ...
  },
  {
    ...
    summary: {
      ...
      true_core: "Windenergie hat reale Prüfaufgaben: Artenschutz, Waldstandorte, Fundamente, Rückbau, Rotorblatt-Recycling und SF₆ in bestimmten Schaltanlagen.",
      problem: "Aus lösbaren Prüfaufgaben wird ein pauschales Windkraft-Killerargument, während fossile Schäden unsichtbar bleiben.",
      narrative: "Windrad gegen Natur / Windräder sind Sondermüll / SF₆ macht Windkraft klimaschädlich.",
      ...
      host_answer: "Windenergie ist nicht wirkungsfrei. Aber Kohle, Gas und Öl sind es auch nicht. Prüfaufgaben lösen - nicht fossile Schäden verlängern.",
    },
    answers: {
      ten_seconds:
        "Windenergie ist nicht wirkungsfrei. Aber Kohle, Gas und Öl sind es auch nicht. Die Frage ist nicht: Gibt es Prüfaufgaben? Sondern: Welche Energieform verursacht insgesamt weniger Schaden?",
      thirty_seconds:
        "Ja, Windräder brauchen Artenschutz, Rückbau und Recycling. SF₆ ist bei bestimmten Schaltanlagen ein echtes Klimagas-Thema. Aber daraus folgt nicht, dass Windkraft klimaschädlicher oder naturfeindlicher als fossile Energie wäre. Die saubere Antwort lautet: Risiken prüfen, Technik verbessern, Rückbau sichern - und fossile Schäden nicht ausblenden.",
      two_minutes:
        "Ich würde das auseinanderziehen. Windenergie ist nicht automatisch gut und nicht wirkungsfrei. Es gibt echte Prüfaufgaben: Vögel, Fledermäuse, Waldstandorte, Fundamente, Rückbau, Rotorblätter und Schaltanlagen. SF₆ ist ein sehr starkes Treibhausgas und war in bestimmten elektrischen Schaltanlagen relevant. Das ist ernst, aber kein Rotorblattproblem und kein Beweis gegen Windenergie insgesamt. Gleichzeitig sind Windenergieanlagen zu großen Teilen recycelbar; schwierig waren vor allem Rotorblätter aus Verbundmaterialien. Genau dort entstehen Recyclingverfahren, Produktverantwortung und recyclebare Designs. Der Denkfehler ist, diese Punkte gegen eine ideale Natur zu halten und Kohle, Öl und Gas nicht mitzuzählen. Fossile Energie verursacht Klimaschäden, Luftschadstoffe, Bergbau, Wasserbelastung, Importabhängigkeit und Gesundheitskosten. Die bessere Antwort ist deshalb: Prüfaufgaben lösen - Artenschutz, Rückbau, Recycling, SF₆-freie Technik und gute Standorte - statt fossile Schäden zu verlängern.",
    },
    effectPath: [
    ...
    frameKey: "verzoegerung",
    redirectQuestion: "Vergleichst du Windkraft gerade mit perfekter Natur - oder mit den realen Folgen von Kohle, Gas und Öl?",
    dontDo: [
    ...
    facts: [
      ...
      "Fundamente, Wege, Kabel, Stahl, Rotorblätter, Betriebsmittel und Schaltanlagen brauchen Rückbau-, Recycling- und Sicherungsstandards.",
      "SF₆ ist ein sehr starkes Treibhausgas und betrifft bestimmte elektrische Schaltanlagen; es ist kein Rotorblattproblem und kein pauschales Windkraft-Killerargument.",
      "Windenergieanlagen bestehen zu großen Teilen aus recycelbaren Materialien; Rotorblätter aus Verbundwerkstoffen waren die schwierigste Fraktion.",
...
const windKeyPoints = [
  ["Prüfaufgaben sind real", "Artenschutz, Waldstandorte, Fundamente, Rückbau, Rotorblätter und Schaltanlagen müssen fachlich geprüft werden.", "warning"],
  ["SF₆ ist ein Schaltanlagen-Thema", "Schwefelhexafluorid ist ein starkes Treibhausgas. Es gehört in elektrische Schaltanlagen, nicht in Rotorblätter, und wird regulatorisch zurückgedrängt.", "warning"],
  ["Recycling ist differenziert", "Stahl, Beton, Kupfer und viele Anlagenbestandteile sind gut verwertbar. Rotorblätter waren die schwierige Fraktion; genau dort entstehen Verfahren und recyclebare Designs.", "neutral"],
  ...
  ["Wald und Arten bleiben Schutzgüter", "Sensible Lebensräume brauchen Ausschluss, Monitoring, Abschaltungen, Antikollisionssysteme und konkrete Standortdaten.", "warning"],
  ["WÖk-Lösung: Prüfaufgaben lösen", "Standortscorecard, Rückbaupflicht, Recyclingpfade, SF₆-freie Technik und Bürgerbeteiligung statt fossiler Verzögerung.", "positive"],
];
...
const windSubclaims = [
  ["„Windräder sind Sondermüll“", "Falsch als Gesamturteil; richtig ist: Recyclingpfade müssen nachgewiesen werden.", "Windenergieanlagen bestehen nicht pauschal aus Sondermüll. Viele Hauptbestandteile wie Stahl, Beton, Kupfer und weitere Metalle sind gut verwertbar. Schwieriger waren Rotorblätter aus faserverstärkten Kunststoffen. Genau dafür braucht es Produktverantwortung, Rückbaupflichten, Recyclingkapazitäten und Designs, die am Ende besser verwertet werden können.", "Welche Bestandteile sind gut recycelbar, welche nicht, und welcher Rückbau- und Recyclingnachweis liegt vor?"],
  ["„Rotorblätter kann man nicht recyceln“", "Zu pauschal. Rotorblätter waren schwierig, aber Verfahren und Designs entwickeln sich.", "Rotorblätter sind wegen Verbundmaterialien anspruchsvoller als Stahl oder Beton. Daraus folgt aber nicht, dass Windkraft insgesamt ein Entsorgungsproblem ohne Lösung ist. Mechanische, thermische und chemische Verfahren, Zement-Koprozessierung, neue Harze und recyclebare Blattdesigns verschieben die Bilanz. Entscheidend ist, ob Projekte Rückbau, Logistik, Nachweis und echte Kreislaufpfade verbindlich mitplanen.", "Wird hier über alte Rotorblätter, aktuelle Recyclingverfahren oder neue recyclebare Designs gesprochen?"],
  ["„SF₆ macht Windräder klimaschädlich“", "SF₆ ist ernst, aber kein Rotorblattproblem und kein Windkraft-Killerargument.", "SF₆, also Schwefelhexafluorid, ist ein sehr starkes Treibhausgas und wurde in elektrischen Schaltanlagen eingesetzt. Das Problem gehört zur Strom- und Netztechnik, nicht zum Rotorblatt. Es muss über Leckagekontrolle, Rückgewinnung, Verbotsschritte, Alternativgase und SF₆-freie Schaltanlagen gelöst werden. Es ersetzt aber nicht den Lebenszyklusvergleich mit Kohle, Gas und Öl.", "Reden wir über konkrete Schaltanlagen und Leckagen - oder wird SF₆ als pauschaler Windkraft-Stopp benutzt?"],
  ["„Betonsockel bleiben für immer im Boden“", "Rückbau ist eine Pflicht- und Nachweisfrage, kein Naturgesetz.", "Fundamente sind reale Eingriffe. Sie müssen in Genehmigung, Rückstellung, Rückbaukonzept und Bodenschutz berücksichtigt werden. Je nach Anlage und Rechtsrahmen geht es um vollständigen oder definierten Rückbau, Verwertung von Beton und Stahl sowie Renaturierung. Der richtige Hebel ist nicht Pauschalblockade, sondern verbindlicher Rückbau- und Kontrollnachweis.", "Welche Rückbaupflicht, Rückstellung und Bodenschutzauflage gilt für diesen konkreten Standort?"],
  ["„Windräder werden vergraben“", "Als Einzelfall oder Altproblem prüfen; nicht als Gesamtbild verwenden.", "Es gab in verschiedenen Ländern Entsorgungsprobleme mit alten Rotorblättern. Daraus darf man keine pauschale Gegenwartsregel machen. Entscheidend ist, ob Deponierung vermieden, Recycling verpflichtend gemacht und neue Anlagen kreislauffähiger gebaut werden. Der faire Vergleich zählt außerdem fossile Brennstoffe mit: Benzin, Diesel, Kohle und Gas werden nicht recycelt, sondern verbrannt.", "Ist das ein aktueller Standard, ein Altfall oder ein Bild, das eine ganze Technologie diskreditieren soll?"],
];
...
const windExternalSources = [
  ...
  ["UBA - Rotorblattaufbereitung und Recycling", "Rotorblätter aus faserverstärkten Kunststoffen sind eine besondere Recyclingfraktion.", "Rotorblatt-Recycling, Verbundmaterialien und Verwertungspfade.", "Nicht auf die gesamte Anlage übertragen; Stahl, Beton und Metalle separat bilanzieren.", "https://www.umweltbundesamt.de/themen/abfall-ressourcen/produktverantwortung-in-der-abfallwirtschaft/windenergieanlagen/rotorblattaufbereitung-recycling-von"],
  ["Fachagentur Wind & Solar - Rückbau und Recycling", "Praxisnahe Übersicht zu Rückbau, Recycling und Weiterbetrieb.", "Rückbaupflicht, Recyclingpraxis und Repowering-Kommunikation.", "Projekt- und Rechtsstand prüfen.", "https://www.fachagentur-wind-solar.de/wind/rueckbau-und-recycling"],
  ["EU-Kommission - Fluorinated greenhouse gases", "SF₆ gehört zu den fluorierten Treibhausgasen und unterliegt europäischer Regulierung.", "SF₆/F-Gase, Klimawirkung und Regulierungsrahmen.", "Allgemeine F-Gas-Quelle; konkrete Schaltanlagen separat prüfen.", "https://climate.ec.europa.eu/eu-action/fluorinated-greenhouse-gases/about-f-gases_en"],
  ["UBA - Verbot des klimaschädlichen SF₆", "Einordnung des SF₆-Problems bei Mittelspannungsschaltanlagen.", "SF₆ in Schaltanlagen, Alternativen und Regulierung.", "Nicht als Rotorblatt- oder Gesamt-Windkraftargument verwenden.", "https://www.umweltbundesamt.de/themen/verbot-des-klimaschaedlichen-sf6-in"],
  ["EU-Verordnung 2024/573", "Aktueller EU-Rechtsrahmen zu fluorierten Treibhausgasen.", "Regulatorischer Pfad für F-Gase und SF₆.", "PDF; Rechtsänderungen und Anwendungstermine prüfen.", "https://eur-lex.europa.eu/legal-content/EN/TXT/PDF/?uri=OJ:L_202400573"],
  ["WindEurope - Circularity", "Branchenüberblick zur Kreislaufführung von Windenergieanlagen.", "Circularity, Recycling und Designpfade.", "Branchenquelle; mit öffentlichen Quellen gegenlesen.", "https://windeurope.org/about-wind/circularity/"],
  ["WindEurope - Decommissioned blades", "Einordnung, wohin Rotorblätter nach Betriebsende gehen können.", "Rotorblatt-End-of-Life und Verwertungswege.", "Branchenquelle; nationale Entsorgungsregeln separat prüfen.", "https://windeurope.org/news/where-do-wind-turbine-blades-go-when-they-are-decommissioned/"],
  ["Siemens Gamesa - RecyclableBlade", "Beispiel für recyclebare Rotorblatt-Designs.", "Technologische Entwicklung bei Rotorblättern.", "Herstellerquelle; kein Beleg für alle Anlagen.", "https://www.siemensgamesa.com/global/en/home/explore/journal/recyclable-blade.html"],
  ["Vestas - Turn wind recyclable", "Industrieprogramm zur Kreislaufführung von Rotorblättern.", "Recyclingverfahren und Produktentwicklung.", "Herstellerquelle; Umsetzung und Skalierung prüfen.", "https://www.vestas.com/en/energy-solutions/development/turnwindrecyclable"],
  ...
  const main = `    <main id="inhalt" data-pagefind-body>
      ...
      <section class="section section-soft dossier-tab-panel" id="zielkonflikt-verstehen">
        <div>
          ...
          <div class="card-grid two">
            <article class="card"><p class="card-kicker">Was stimmt?</p><ul class="clean-list"><li>Windräder greifen in Landschaft, Boden und lokale Ökosysteme ein.</li><li>Vögel und Fledermäuse können betroffen sein.</li><li>Fundamente, Wege, Kabel, Rotorblätter und Betriebsmittel brauchen Rückbau- und Recyclingregeln.</li><li>SF₆ ist ein sehr starkes Treibhausgas und war in bestimmten elektrischen Schaltanlagen ein Problem.</li><li>Rotorblätter aus Verbundwerkstoffen waren lange die schwierigste Recyclingfraktion.</li></ul></article>
            <article class="card"><p class="card-kicker">Was fehlt?</p><ul class="clean-list"><li>Fossile Energie zerstört Natur ebenfalls: durch Klimaschäden, Luftschadstoffe, Bergbau, Wasserbelastung, Infrastruktur, Transport und Extremwetter.</li><li>Klimawandel ist selbst ein massives Risiko für Arten, Wälder, Böden und Ökosysteme.</li><li>SF₆ steckt nicht im Rotorblatt. Es betrifft Schaltanlagen und muss dort ersetzt, zurückgewonnen und kontrolliert werden.</li><li>Die Anlage ist größtenteils gut recycelbar; schwierig waren vor allem Rotorblätter.</li><li>Der Denkfehler ist nicht, Artenschutz, Rückbau oder SF₆ zu prüfen. Der Denkfehler ist, Prüfaufgaben in ein fossiles Verzögerungsargument zu verwandeln.</li></ul></article>
          </div>
          <div class="card-grid two">
            <article class="card"><p class="card-kicker">SF₆ sauber einordnen</p><h3 class="card-title">Schaltanlagen-Thema, kein Rotorblatt-Mythos.</h3><p class="card-text">SF₆ ist ein reales Klimagasproblem. Es wurde wegen seiner technischen Eigenschaften in elektrischen Schaltanlagen eingesetzt. Die richtige Reaktion ist nicht, Windenergie pauschal zu diskreditieren, sondern SF₆-Leckagen zu vermeiden, Gas zurückzugewinnen, Alternativen einzusetzen und EU-Verbote umzusetzen.</p><p class="card-text"><strong>Kurzsatz:</strong> SF₆ ernst nehmen, aber nicht als Windkraft-Killerargument missbrauchen.</p></article>
            <article class="card"><p class="card-kicker">Recycling und Rückbau</p><h3 class="card-title">Nicht Sondermüll-Frame, sondern Kreislaufpflicht.</h3><p class="card-text">Windenergieanlagen bestehen überwiegend aus verwertbaren Materialien. Rotorblätter waren wegen Verbundwerkstoffen die anspruchsvolle Fraktion. Genau dort entstehen neue Verfahren, Recyclingpfade und recyclebare Designs. Rückbaupflicht, Rückstellungen und Nachweise gehören deshalb in jede Standortscorecard.</p><p class="card-text"><strong>Kurzsatz:</strong> Prüfaufgaben lösen - nicht fossile Schäden verlängern.</p></article>
          </div>
          <div class="dossier-matrix-wrap">
            <table class="dossier-matrix">
      ...
      <section class="section section-soft" id="psychologischer-wirkungscheck">
        <div>
          ...
          ${summaryGrid([["Verfügbarkeitsheuristik", "Tote Vögel, gerodete Flächen oder Betonfundamente sind sichtbarer als verteilte fossile Schäden.", "warning"], ["Moralischer Schutzimpuls", "Der Schutz von Tieren und Wald ist berechtigt, kann aber als Totalstopp gegen jede Abwägung benutzt werden.", "warning"], ["Angstanker", "Wörter wie Sondermüll, SF₆ oder Infraschall bleiben hängen und überdecken die konkrete Prüf- und Lösungsfrage.", "warning"]], "Wind Psychologie", "deep-dive-inline-summary")}
        </div>
      </section>
