...
const manualCanonical = {
  ...
  "altparteien": "diktatur-der-altparteien",
  "altparteiendiktatur": "diktatur-der-altparteien",
  ...
  "die-boesen-reichen": "sind-die-reichen-schuld",
  "leistungstraeger-werden-ausgepresst": "leistungstraeger-ausgepresst",
  "remigration": "remigration-remigrationslotsen",
...
const manualSynonyms = {
  ...
  "diktatur-der-altparteien": ["Altparteien", "Altparteiendiktatur", "Diktatur der Altparteien"],
  ...
  "sind-die-reichen-schuld": ["Die bösen Reichen", "Reiche sind schuld", "Vermögende als Schuldige"],
  "leistungstraeger-ausgepresst": ["Leistungsträger werden ausgepresst", "Leistungsträger ausgepresst"],
