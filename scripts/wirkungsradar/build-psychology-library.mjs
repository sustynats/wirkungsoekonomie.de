...
const patterns = [
  ...
  ["heilsversprechen", "Heilsversprechen", "Eine einfache, perfekte Lösung wird versprochen, die komplexe Nebenfolgen ausblendet.", "Fusion löst das Problem. Kernkraft wäre die einfache Lösung.", "Heute verfügbare Maßnahmen verlieren Dringlichkeit.", "Zeithorizont, Skalierung und Opportunitätskosten prüfen.", "Forschung ja. Aber was wirkt rechtzeitig und skalierbar?"],
