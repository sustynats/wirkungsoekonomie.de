...
const sources = [
  ["BMZ - Nachhaltige Mobilität in Lima", "bmz_lima_mobilitaet", "https://www.bmz.de/de/laender/peru/nachhaltige-mobilitaet-in-lima", ["20 Mio. Euro Zuschuss für Radwege in Lima", "bis zu 24 Mio. Euro weitere Zusage 2022", "114 km Radwege geplant; erste rund 30 km gebaut", "Radwege als Teil integrierter Verkehrssysteme und Zubringer zu Bus und Metro", "Nutzen für Mobilität, Gesundheit, Klima, Wirtschaft und internationale Beziehungen"], "BMZ ist Ministeriumsquelle; bei Kritik und Umsetzung zusätzlich KfW-Projektdaten und unabhängige Evaluierungen prüfen."],
      ["KfW - Fakten zur Entwicklungszusammenarbeit", "kfw_entwicklungszusammenarbeit", "https://www.kfw.de/%C3%9Cber-die-KfW/Newsroom/Aktuelles/Entwicklungszusammenarbeit.html", ["KfW-Förderkredite und Entwicklungskredite", "weniger als die Hälfte der KfW-Zusagen stammt aus Bundeshaushalt", "überwiegend Kredite", "Kreditnehmer zahlen verzinst zurück", "Metro als Hauptposten in Lima", "Radwege als kleinere ergänzende Zuschussmaßnahme", "deutsche Unternehmen mit ca. 100 Mio. Euro Beauftragungen im Programm", "internationale Kooperation im deutschen Interesse"], "KfW ist Umsetzungs- und Finanzierungsakteur; Angaben durch externe Evaluierungen ergänzen."],
...
const dossiers = [
  {
    ...
    points: [
      ...
      ["Zuschuss und Kredit trennen", "Beim konkreten Radwege-Projekt nennt das BMZ 20 Mio. Euro Zuschuss 2020 und weitere 24 Mio. Euro Zusage 2022. Der größere Mobilitätsrahmen in Lima umfasst aber auch rückzahlbare KfW-Kredite, vor allem für die Metro."],
      ["Nicht nur Peru profitiert", "KfW nennt im nachhaltigen Stadtverkehrsprogramm Beauftragungen deutscher Unternehmen von rund 100 Mio. Euro. Dazu kommen Klima-, Handels-, Standard-, Partnerschafts- und Stabilitätsnutzen."],
    ...
    answers: {
      ten: "Nicht alles ist Geschenk: Die Radwege sind ein kleiner Zuschussteil, die Metro ist der große Kreditteil. Entscheidend ist Wirkung: sichere Wege, weniger Stau, Kontrolle und Nutzen auch für Deutschland.",
      thirty:
        "Der wahre Punkt ist: Öffentliches Geld muss geprüft werden. Der Denkfehler ist, alles als verschenktes Steuergeld zu erzählen. Bei Lima muss man trennen: Die Radwege sind laut BMZ ein Zuschussbestandteil. Der große Mobilitätsrahmen mit der Metro läuft über KfW-Kredite, die von Peru bedient werden. Wirkungsökonomisch zählt: Wird Mobilität sicherer, günstiger, sauberer - und gibt es Kontrolle sowie Nutzen für Deutschland?",
      two:
        "Das Radwege-in-Peru-Narrativ funktioniert, weil es ein einfaches Spottbild liefert: Dort Radwege, hier Probleme. Wirkungsökonomisch ist diese Rechnung zu klein. Erstens muss man die Finanzierungsform trennen: Beim konkreten Radwege-Projekt nennt das BMZ einen Zuschuss von 20 Mio. Euro und eine weitere Zusage von 24 Mio. Euro. Der große nachhaltige Stadtverkehr in Lima ist aber vor allem Metro und ÖPNV; dafür nennt die KfW Kredite, die von Peru bedient werden. Zweitens muss man den Nutzen prüfen: Radwege sind dort nicht Dekoration, sondern Zubringer zu Metro, Bus, Schule, Ausbildung, Arbeit und Markt. Das kann Stau, Luftbelastung, Mobilitätskosten und CO₂ senken und Teilhabe erhöhen. Drittens hat Deutschland ebenfalls Interessen: Die KfW nennt im Programm Beauftragungen deutscher Unternehmen von rund 100 Mio. Euro; außerdem geht es um Klima, Handelsbeziehungen, Standards, Vertrauen und regelbasierte Kooperation. Viertens bleibt Kritik nötig: Baufortschritt, Nutzung, Umwelt- und Sozialprüfung, Vergabe, Korruptionsschutz und Evaluation müssen sichtbar sein. Die bessere Frage ist deshalb nicht: Warum zahlen wir Radwege in Peru? Die bessere Frage ist: Welcher Teil ist Zuschuss, welcher Kredit, was wird zurückgezahlt, was bewirkt das Projekt, wer kontrolliert es und welchen Nutzen hat es für Menschen dort und für Deutschland?",
      comment:
        "Radwege in Lima sind kein Luxusbild, sondern Teil eines Verkehrssystems. Wichtig ist die Trennung: Radwege-Zuschuss, Metro-Kredit, Rückzahlung, Kontrolle, Wirkung und deutscher Nutzen.",
      calm:
        "Ich verstehe den Reflex: Man fragt sich, warum Geld ins Ausland geht, wenn hier auch viel fehlt. Aber genau deshalb muss man sauber prüfen: Welcher Teil ist Zuschuss, welcher Kredit, was wird zurückgezahlt, was bewirkt es, wie wird es kontrolliert und welchen Nutzen hat es auch für Deutschland?",
    },
    ...
    trust: {
      ...
      sicher: ["Radwege in Lima sind Teil eines integrierten Verkehrssystems.", "Deutschland bezuschusst das Fahrradschnellwegenetz in Lima laut BMZ mit 20 Mio. Euro; weitere 24 Mio. Euro wurden 2022 für Radwege in Peru zugesagt.", "KfW nennt den Ausbau der Metro als Hauptposten des nachhaltigen Stadtverkehrsprogramms.", "KfW nennt die Radwege eine kleinere ergänzende Zuschussmaßnahme.", "KfW nennt Kredite für die Metro, die von peruanischer Seite bedient werden.", "KfW nennt Beauftragungen deutscher Unternehmen von rund 100 Mio. Euro im Programm.", "KfW-Förderkredite werden überwiegend über den Kapitalmarkt refinanziert und von Kreditnehmern verzinst zurückgezahlt."],
...
function radwegePage(dossier, detail = false) {
  ...
  const main = `    <main id="inhalt" data-pagefind-body>
      ...
      <section class="section" id="positive-beispiele"><div><div class="section-header"><p class="hero-kicker">Gute Bilder</p><h2>Erst den besseren Alltag zeigen.</h2><p>Nicht beim Spottbild starten. Zeigen, was ein gutes Projekt konkret verändert.</p></div>${positiveExamples(dossier.positiveExamples)}</div></section>
