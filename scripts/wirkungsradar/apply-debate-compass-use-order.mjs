...
function fallbackSourcesSection(html) {
  ...
  const sources = sourceLinks.length
    ...
    : `<article class="card"><p class="card-text">Quellenprüfung redaktionell nachführen. Bis dahin muss die Seite als vorläufige Debattenkarte gelesen werden.</p></article>`;
