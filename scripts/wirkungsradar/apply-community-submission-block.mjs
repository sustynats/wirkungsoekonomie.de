...
function normalizeHtml(file) {
  ...
  html = html
    .replace(/assets\/css\/style\.css\?v=[^"' <)]+/g, "assets/css/style.css?v=20260612-shell-audio-fix")
    .replace(/assets\/js\/main\.js\?v=[^"' <)]+/g, "assets/js/main.js?v=20260612-shell-audio-fix")
