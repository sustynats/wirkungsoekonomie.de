...
const JS_VERSION = "20260605-debate-tool-order";
...
function normalizeHtml(file) {
  ...
  html = html
    .replace(/assets\/css\/style\.css\?v=[^"' <)]+/g, "assets/css/style.css?v=20260612-journal-mobile-fix")
    .replace(/assets\/js\/main\.js\?v=[^"' <)]+/g, "assets/js/main.js?v=20260612-journal-mobile-fix")
