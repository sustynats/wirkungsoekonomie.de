...
function publicImpactRoomPage() {
  ...
  <section class="section section-soft"><div><article class="card important-card"><p class="card-kicker">Langdossier</p><h2>Der öffentliche Wirkungsraum: Stein, Wellen und Tiefe.</h2><p>Die Online-Langfassung vertieft das Modell des öffentlichen Wirkungsraums: vom einzelnen Satz über Resonanz, Aufmerksamkeit, Agenda, Ursache und demokratische Resilienz bis zur Frage, warum Faktenchecks allein nicht reichen.</p><p><a class="btn btn-primary" href="dossier-stein-wellen-tiefe/">Onlinefassung lesen</a> <a class="btn btn-secondary" href="../assets/downloads/woek_dossier_oeffentlicher_wirkungsraum_wellen_tiefe_v0_1.pdf">PDF herunterladen</a></p></article></div></section>
