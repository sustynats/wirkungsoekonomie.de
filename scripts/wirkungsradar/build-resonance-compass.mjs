...
<head>
  ...
  <link rel="canonical" href="${esc(canonical)}">
${optionalHead}  <link rel="stylesheet" href="${base}assets/css/style.css?v=20260612-mobile-table-fix">
</head>
<body>
...
function publicImpactRoomPage() {
  ...
  const main = `<section class="hero radar-page-hero"><div><nav class="breadcrumb" aria-label="Breadcrumb"><a href="../index.html">Start</a></nav><p class="hero-kicker">Die fünf Wellen öffentlicher Wirkung</p><h1 class="hero-title">Öffentlicher Wirkungsraum</h1><p class="hero-subtitle">Antworten finden. Narrative einordnen. Debatten wirksamer führen. Öffentliche Aussagen wirken nicht nur über Fakten. Sie treffen auf Erfahrungen, Ängste, Loyalitäten, Plattformlogiken und politische Interessen. Der Öffentliche Wirkungsraum hilft, konkrete Aussagen schnell einzuordnen, passende Antworten zu finden und die tieferen Wirkpfade sichtbar zu machen.</p></div></section>
  ${impactNav}
