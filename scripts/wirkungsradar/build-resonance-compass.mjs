...
function publicImpactRoomPage() {
  ...
  <figure class="woek-visual-figure woek-visual-figure--compact"><img class="woek-visual" src="../assets/img/generated/oeffentlicher-wirkungsraum-fuenf-wellen.webp" alt="Infografik Die fünf Wellen öffentlicher Wirkung: Aufmerksamkeitswelle, Emotionswelle, Deutungswelle, Resonanzwelle und Verschiebungswelle."><figcaption class="woek-visual-caption">Nicht der einzelne Stein verändert den öffentlichen Raum allein, sondern die Wellen: Aufmerksamkeit, Emotion, Deutung, Resonanz und Verschiebung.</figcaption></figure>
