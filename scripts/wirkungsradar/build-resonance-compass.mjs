...
function publicImpactRoomPage() {
  ...
  const entryCards = [
    ...
    ["Ich suche eine Debattenkarte.", "Debattenkarten", "Alle Karten nach Aussage, Thema, Narrativ und Antwortbedarf durchsuchen.", "wirkungsradar/debattenkarten/", "Debattenkarten öffnen"],
  ...
  return shell({ title: "Öffentlicher Wirkungsraum", description: "Antworten finden, Narrative einordnen und Debatten wirksamer führen: der Öffentliche Wirkungsraum erklärt die fünf Wellen öffentlicher Wirkung und führt zu Debattenkarten, Resonanz-Kompass, Agenda-Radar, Ursachen-Navigator und Vertiefungen.", canonical: `${SITE_URL}/oeffentlicher-wirkungsraum/`, base: "../", main });
}
