      ...
      <section class="section" id="backlog-regeln">
        <div>
          ...
          <div class="radar-rule-grid">
            ...
            <article class="card"><p class="card-kicker">Redaktionsstatus</p><p class="card-text">Idee, Entwurf, Quellen offen, Psychologie offen, positives Beispiel offen, v2-geprüft, aktualisieren, archiviert.</p></article>
