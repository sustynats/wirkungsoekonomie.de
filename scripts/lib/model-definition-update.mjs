...
export function applyModelDefinitionUpdate(root='.') {
 ...
 const edition=JSON.parse(fs.readFileSync('assets/data/model-explainer-edition-2026-09-06-v1-1.json','utf8')).files[0];
