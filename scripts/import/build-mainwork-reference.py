...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="{prefix}assets/css/style.css?v=20260605-wirkungsraum-stage5">
  </head>
  <body>
    ...
    {body}
    <script src="{prefix}assets/js/main.js?v=20260605-wirkungsraum-stage5"></script>
