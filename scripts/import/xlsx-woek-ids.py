...
PUBLIC_WORKBOOK = ROOT / "data/master-register/WOeK_Masterregister_v1.5_2026-08-21.xlsx"
...
def main() -> None:
    ...
    public_url = "/assets/downloads/woek-register/v1.5/WOeK_Masterregister_v1.5_2026-08-21.xlsx"
    payload = {
        "sourceFile": "data/master-register/WOeK_Masterregister_v1.5_2026-08-21.xlsx",
        "originalFileUrl": public_url,
        "sourceHash": source_hash,
        "sourceVersion": "v1.5",
        "importVersion": "2026.5-import",
        "liveReferenceVersion": "2026.5-live-reference",
...
<html lang="de"><head>
  ...
  <title>WÖk-Masterregister v1.5 | Wirkungsökonomie</title>
  <meta name="description" content="Führendes MasterItems-Register mit 621 stabilen WÖk-IDs, Zwei-Ebenen-Architektur und dokumentiertem Prüfstatus.">
  ...
  <nav class="breadcrumb"><a href="../../bibliothek/">Bibliothek</a> / WÖk-Masterregister v1.5</nav>
  <h1>WÖk-Masterregister v1.5</h1>
  <p class="lead">Führendes MasterItems-Register mit getrenntem Wirkindikatorenregister, amtlichen Bundesreferenzen und sichtbaren offenen Mappingstatus.</p>
  ...
  <section class="callout"><h2>Einordnung</h2><p>v1.5 trennt MasterItems (WAS betrachten wir?) vom Wirkindikatorenregister (WOMIT beobachten wir Zustände?). Alle 621 IDs aus v1.4 bleiben unverändert; offene Zuordnungen bleiben OPEN_REVIEW_REQUIRED.</p></section>
  <section><h2>Registerumfang</h2><dl><dt>WÖk-IDs</dt><dd>{len(items)}</dd><dt>Scoring-Regeln</dt><dd>{rules_count}</dd><dt>Quellenkatalog</dt><dd>{source_count}</dd><dt>Stand</dt><dd>21. August 2026</dd><dt>Quelldatei</dt><dd>WOeK_Masterregister_v1.5_2026-08-21.xlsx</dd><dt>SHA-256</dt><dd>{esc(source_hash)}</dd></dl></section>
  <section><h2>Versionshinweis</h2><p>v1.5 ersetzt v1.4 als führende MasterItems-Fassung; v1.4 bleibt unverändert als historische Quelle erhalten.</p></section>
    ...
    print(f"Wrote {len(items)} WÖk-ID rows from leading Master Register v1.5.")
