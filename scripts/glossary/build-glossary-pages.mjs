...
<html lang="de">
  <head>
    ...
    <link rel="stylesheet" href="${depth}assets/css/style.css?v=20260605-wirkungsraum-stage7">
  </head>
  <body>
${renderHeader(depth)}
    <main class="section">
...
${renderFooter(depth)}
    <script src="${depth}assets/js/main.js?v=20260605-wirkungsraum-stage7"></script>
  </body>
</html>
`.replace(/[ \t]+$/gm, "");
}
