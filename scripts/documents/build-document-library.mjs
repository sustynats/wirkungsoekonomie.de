...
function buildDownloadsPage() {
  ...
  const main = `
      ...
      <section class="section" aria-labelledby="free-access-title">
        <div>
          <div class="section-header">
            <p class="hero-kicker">Offener Zugang</p>
            <h2 id="free-access-title">Warum die Bibliothek frei zugänglich ist</h2>
            <p>Die Wirkungsökonomie ist als offener Wissens-, Lern- und Anwendungsraum angelegt. Deshalb sind die zentralen Dokumente kostenlos online lesbar: Begriffe, Annahmen, Beispiele und Methoden sollen nachvollziehbar sein und von Bürger:innen, Politik, Verwaltung, Unternehmen, Wissenschaft, Medien und Bildung geprüft, genutzt und weiterentwickelt werden können.</p>
          </div>
          <div class="concept-grid">
            <article class="concept-card">
              <p class="hero-kicker">Nachvollziehbarkeit</p>
              <h3>Alle sollen sehen können, worauf sich Aussagen stützen.</h3>
              <p>Wirkungsökonomie arbeitet mit Annahmen, Begriffen, Beispielen und Modelllogiken. Offene Dokumente machen sichtbar, welche Argumente, Datenbezüge und Grenzen dahinterstehen.</p>
            </article>
            <article class="concept-card">
              <p class="hero-kicker">Lernen und Anwendung</p>
              <h3>Materialien sollen praktisch nutzbar sein.</h3>
              <p>Die Bibliothek ist nicht als Verkaufskatalog gedacht, sondern als Arbeitsgrundlage für Orientierung, Unterricht, Verwaltung, politische Debatten, Unternehmenspraxis und Forschung.</p>
            </article>
            <article class="concept-card">
              <p class="hero-kicker">Transparenz</p>
              <h3>Offen heißt nicht amtlich.</h3>
              <p>Die Dokumente sind modellhafte Ausarbeitungen und Lernmaterialien. Sie ersetzen keine amtliche Bewertung, keine Rechtsberatung und keine fachliche Einzelfallprüfung.</p>
            </article>
          </div>
        </div>
      </section>
