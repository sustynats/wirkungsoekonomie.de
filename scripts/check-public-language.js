...
const BLOCKED_TERMS = [
  ...
  "Du liest die Onlinefassung dieses Konzeptpapiers",
  "wird als fachlicher Unterbereich der Wirkungsökonomie online erklärt",
  "Die alte Logik betrachtet [Thema]",
  "Kernformel.",
  "Original 2026.0bleibt zitierfähig",
  "2026.2-live-referencelesbar",
  "Prüfstand erste Online-Prüfungweitere",
  "Soll ich jetzt",
  "Codex-Anweisung",
  "CodeX-Anweisung",
...
const CODE_EXAMPLE_RE = /<pre\b[\s\S]*?<\/pre>|<code\b[\s\S]*?<\/code>/gi;
...
function visibleText(html) {
  ...
  const body = (bodyMatch ? bodyMatch[1] : withoutTechnicalCanonical)
    .replace(HIDDEN_FROM_SCREEN_RE, " ")
    .replace(CODE_EXAMPLE_RE, " ");
