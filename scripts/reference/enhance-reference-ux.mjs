...
const relatedDocsByCluster = {
  methodik: ["WOeK_Master_Items_v1.3_geprueft", "T-SROI-Rechenstandard v1.1", "Technische Leitlinien WUStG"],
  ...
  "digitalisierung-ki": ["WOeK_Master_Items_v1.3_geprueft", "Systemmodell der Wirkungsökonomie"],
  ...
  return `<main class="reference-portal" data-pagefind-body>
    ...
    <section class="reference-section reference-split">
      <div>
        ...
        ${pillList(["Führender Begriffsleitfaden v1.3", "Die neue Ordnung des Wohlstands / Onlinefassung", "WÖk Master Items v1.3", "WStG 2.0", "WUStG v2.1", "T-SROI v2.0", "Schutzrahmen Social Credit"])}
      </div>
      <aside class="reference-emphasis">
