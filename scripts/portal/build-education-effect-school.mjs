...
function modulePage(module) {
  ...
  const conceptReader = `<section class="section article-section" aria-labelledby="konzeptpapier-title"><details class="reader-disclosure" id="konzeptpapier"><summary><span>Konzeptpapier</span><small>Kapitel anzeigen</small></summary><article class="article-body fulltext-reader"><p class="hero-kicker">Konzeptpapier</p><span id="detailkonzept" class="anchor-alias no-print" aria-hidden="true"></span><h2 id="konzeptpapier-title">Konzeptpapier</h2>${detail.html}</article></details></section>`;
  const dossierReader = `<section class="section article-section" aria-labelledby="dossier-title"><details class="reader-disclosure" id="dossier"><summary><span>Dossier</span><small>Kapitel anzeigen</small></summary><article class="article-body fulltext-reader"><p class="hero-kicker">Dossier</p><h2 id="dossier-title">Dossier</h2>${dossier.html}</article></details></section>`;
  page({
    rel: `wirkungsfelder/bildung/${module.slug}/index.html`,
    title: `${module.name} | Bildung & Wirkungsschule`,
    description: module.thesis,
    type: "Unterbereich",
    body: (base) => `<section class="hero portal-hero"><div class="hero-content"><nav class="breadcrumb"><a href="${href(base, "index.html")}">Start</a> / <a href="${href(base, "wirkungsfelder/bildung/")}">Bildung</a></nav><p class="hero-kicker">Bildung & Wirkungsschule</p><h1>${esc(module.name)}</h1><p class="hero-subtitle">${esc(module.thesis)}</p><div class="hero-actions no-print"><button class="btn btn-secondary" type="button" onclick="window.print()" aria-label="Diese Seite drucken">Seite drucken</button></div></div></section><section class="section" id="publikationszugang" aria-labelledby="publikationszugang-title"><div class="download-card"><div><p class="card-kicker">Lesefassung</p>${h2("publikationszugang-title", "Konzeptpapier und Dossier")}<p class="card-text">Konzeptpapier und Dossier sind als einklappbare Lesefassungen eingebunden. PDF-Downloads stehen im Materialbereich am Ende.</p></div><div class="portal-card-actions no-print"><a class="btn btn-secondary" href="${href(base, documents.details.download)}">Konzeptpapiere als PDF herunterladen</a><a class="btn btn-secondary" href="${href(base, documents.singleDossiers.download)}">Dossiers als PDF herunterladen</a></div></div></section>${tocBlock([...detail.toc, ...dossier.toc])}<section class="section" aria-labelledby="kurzfassung"><div class="section-header"><p class="hero-kicker">Kurzfassung</p>${h2("kurzfassung", "Kurzfassung und Wirkungspfad")}</div><div class="card-grid three"><article class="card"><h3 class="card-title">Worum es geht</h3><p class="card-text">${esc(module.thesis)}</p></article><article class="card"><h3 class="card-title">Werkzeugbezug</h3><p class="card-text">${esc(module.tool)}</p></article><article class="card"><h3 class="card-title">Schutzlinie</h3><p class="card-text">Bewertet werden Lernräume, Strukturen, Unterstützungsangebote und Wirkungspfade. Keine Kinder-, Lehrkräfte- oder Familien-Scores.</p></article></div></section>${conceptReader}${dossierReader}${toolBlock(base)}${protectionBlock()}${politicalBlock()}${referenceBlock(base)}${bookBlock(base)}${relatedBlock(base)}${sourceBlock()}${downloadBlock(base, [{ label: "Konzeptpapiere als PDF herunterladen", href: documents.details.download }, { label: "Dossiers als PDF herunterladen", href: documents.singleDossiers.download }])}`,
  });
}
