...
${body(b)}
    ...
    <script src="${b}assets/js/main.js?v=20260529-glossary-hover-audit"></script>
  </body>
</html>`);
}
    ...
    <div class="card-grid two" data-auto-calculator>
      ...
      <article class="card">
        ...
        <div class="impact-kpis">
          ...
          <div class="impact-kpi"><span>Faktor</span><strong data-auto-result="impactFactorLabel">0 / Anpassung 1,0</strong></div>
        </div>
