...
const fields = [
  ...
  },
  {
    ...
    docs: [{ label: "Wirkungssteuer und WStG 3.0", href: "bibliothek/wirkungssteuer-wstg-3-0/" }, { label: "Wirkungsrat Konzept", href: "dokumente/wirkungsrat-konzept/" }],
...
const legacyMethodMapTools = [
  ...
  ["Impact-Controlling-Rechner", "Einfache Demo für Scorecard, Netto-Wirkungs-Index, IOI und T-SROI.", "B", "Demo", "erleben/impact-controlling-rechner/", ["Impact Controlling", "NWI", "IOI", "T-SROI"], "Modellhaft, keine Prüfung und keine Beratung."],
...
function workshopPages() {
  ...
  const simplePages = [
    ["gesetze", "Gesetze und Rechtsentwürfe", [["Wirkungssteuer und WStG 3.0", "Gesamtneufassung der modularen Wirkungssteuerarchitektur.", "bibliothek/wirkungssteuer-wstg-3-0/"], ["Technische Leitlinien WUStG", "Leitlinien zur Produktwirkungssteuer.", "dokumente/technische-leitlinien-wustg-v2/"], ["Wirkungsrat", "Governance und institutionelle Sicherung.", "dokumente/wirkungsrat-konzept/"]]],
