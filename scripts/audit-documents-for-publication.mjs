...
const REVIEW_RELEASE_OVERRIDES = new Map(Object.entries({
  ...
  "woek-master-items-register": {
    ...
    subtitle: "Geprüftes Arbeits- und Governance-Register für WÖk-IDs, Scorecards und Benchmarks",
    fileName: "WOeK_Master_Items_v1.3_geprueft.xlsx",
    filePath: "assets/downloads/woek-register/WOeK_Master_Items_v1.3_geprueft.xlsx",
    ...
    level: "expert",
    summaryShort: "Geprüftes Register mit 621 WÖk-IDs, 28 Regeln, getrennten aktiven und historischen Benchmarkwerten sowie Prüfstatus.",
    whatToExpect: "Ein technisches Register für Expert:innen: Itemlogik, Regelzuordnung, Quellen, Systemgrenzen, Datenqualität, Assurance und Benchmarkstatus.",
    ...
    editorialNote: "Geprüfte Fassung v1.3, Stand 13. August 2026. Leere Eingaben bleiben unbewertet; das Arbeitsmodell ist keine Rechtsnorm und keine automatische Entscheidung.",
...
const DOCUMENTS = [
  ...
  },
  {
    ...
    audience: ["Methodik", "Daten", "Wissenschaft"],
    level: "technisch",
    summaryShort: "Geprüftes Register mit 621 WÖk-IDs, 28 Regeln, getrennten Benchmarkstatus und Prüfprotokoll.",
    whatToExpect: "Ein technisches Register mit Itemlogik, Regelzuordnung, Systemgrenzen, Quellen und Assurance.",
