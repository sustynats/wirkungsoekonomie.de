...
const DOCUMENTS = [
  ...
  },
  {
    ...
    level: "fortgeschritten",
    summaryShort: "Führende Sprachreferenz v1.3 mit Nachhaltigkeit als langfristig gesicherter Wirkungsresilienz und acht Analysebausteinen von Resilienz und Systementwicklung.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit Definitionen, Abgrenzungen, Stabilitätslandschaft, Rückstell- und Dämpfungsfähigkeit, Anpassung, Transformation, Quellen und bevorzugten Formulierungen.",
    keyQuestions: ["Welche Begriffe sind maßgeblich?", "Wie werden Nachhaltigkeit, Resilienz, Systemresilienz und Wirkungsresilienz unterschieden?", "Welche Formulierungen sind zu vermeiden?"],
    topics: ["Begriffe", "Glossar", "Sprachregelwerk", "Wirkungsresilienz", "Systemresilienz"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "leitbild-mensch-planet-demokratie"],
    version: "v1.3",
    date: "2026-07-30",
    editorialNote: "Aus der kumulativen Markdown-Quelle und versionierten Resilienz-Deltas als öffentliche Onlinefassung und PDF-Exportfassung veröffentlicht. Version 1.0 bis 1.2 bleiben als zitierfähige ältere Fassungen erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
  ...
  },
  {
    ...
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.2?", "Wo ist die aktuelle Fassung v1.3?"],
