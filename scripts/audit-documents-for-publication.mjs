...
const REVIEW_RELEASE_OVERRIDES = new Map(Object.entries({
  "beispiel-apfel-wirkungssteuer": {
    title: "Beispiel: Regionaler Apfel vs. Chile-Apfel",
    subtitle: "Automatisierte Einstufung einer Wirkungssteuer als Modellbeispiel",
    fileName: "Beispiel_Apfel_Wirkungssteuer_Bonusregel.pdf",
    filePath: "public/downloads/originals/Beispiel_Apfel_Wirkungssteuer_Bonusregel.pdf",
    contentHtmlPath: "content/documents/online/beispiel-apfel-wirkungssteuer.inc",
    documentType: "fallbeispiel",
    status: "aktuell",
    visibility: "public",
    audience: ["Praxis", "Methodik", "Politik"],
    level: "intermediate",
    summaryShort: "Modellbeispiel zur Frage, wie eine Wirkungssteuer bei zwei äußerlich ähnlichen Produkten unterschiedliche Wirkpfade sichtbar machen kann.",
    whatToExpect: "Ein konkretes Beispiel zur wirkungsökonomischen Produktbewertung am Vergleich regionaler und importierter Äpfel.",
    keyQuestions: ["Wie unterscheiden sich Preis und Wirkung?", "Welche Daten könnten in eine Wirkungssteuer einfließen?", "Wie bleibt die Bewertung modellhaft und nicht personenbezogen?"],
    topics: ["Produktwirkung", "Wirkungssteuer", "Wahre Preise"],
    methods: ["Scorecard", "Wirkungssteuer", "Positive Netto-Wirkung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    legalNotice: "Illustratives Modellbeispiel. Keine Steuer-, Rechts-, Förder-, Anlage- oder Unternehmensberatung; keine amtliche Bewertungsmethode.",
  ...
  "beispiel-konzern": {
    ...
    subtitle: "Wie Unternehmensdaten in produktbezogene Wirkung übersetzt werden können",
    fileName: "Beispiel-Konzern.pdf",
    filePath: "public/downloads/originals/Beispiel-Konzern.pdf",
    contentHtmlPath: "content/documents/online/beispiel-konzern.inc",
    documentType: "fallbeispiel",
    status: "aktuell",
    visibility: "public",
    audience: ["Unternehmen", "Investoren", "Methodik"],
    level: "intermediate",
    summaryShort: "Illustratives Fallbeispiel zur Übersetzung von CSRD-/ESG-Daten in produktbezogene Wirkungslogik.",
    whatToExpect: "Ein modellhafter Weg von Nachhaltigkeitsdaten zur Produktscorecard, ohne eine reale Unternehmensbewertung zu behaupten.",
    keyQuestions: ["Wie werden Unternehmensdaten produktbezogen?", "Wo endet Reporting und wo beginnt Rückkopplung?", "Welche Schutzlinien braucht ein Modellbeispiel?"],
    topics: ["CSRD", "Produktscorecard", "Unternehmenswirkung"],
    methods: ["Produktwirkung", "Scorecard", "Wirkungscontrolling"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    legalNotice: "Illustratives Modellbeispiel. Keine tatsächliche Unternehmensbewertung, kein Rating und keine Rechts-, Prüfungs-, Steuer-, Anlage- oder Unternehmensberatung.",
    editorialNote: "Öffentliche Fassung nach Red-Flag-Prüfung freigegeben.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Praxisbeispiele",
  ...
  "wp-einkommen": {
    ...
    subtitle: "Ein neuer Blick auf soziale Sicherheit in der Wirkungsökonomie",
    fileName: "WP_Einkommen.pdf",
    filePath: "public/downloads/originals/WP_Einkommen.pdf",
    contentHtmlPath: "content/documents/online/wp-einkommen.inc",
    documentType: "working-paper",
    status: "aktuell",
    visibility: "public",
    audience: ["Politik", "Soziales", "Wissenschaft"],
    level: "expert",
    summaryShort: "Working Paper zur Idee eines Wirkungseinkommens als sozialer Sicherungs- und Rückkopplungslogik.",
    whatToExpect: "Eine konzeptionelle Einordnung, wie Einkommen, Automatisierung, soziale Sicherheit und positive Netto-Wirkung zusammengedacht werden können.",
    keyQuestions: ["Wie verändert Automatisierung die Einkommensfrage?", "Was unterscheidet Wirkungseinkommen von Arbeits- oder Grundeinkommen?", "Welche Schutzlinien braucht ein solches Modell?"],
    topics: ["Wirkungseinkommen", "Soziale Sicherheit", "Arbeit"],
    methods: ["Wirkungsarchitektur", "Positive Netto-Wirkung", "Systemische Rückkopplung"],
    impactFields: ["Mensch", "Demokratie"],
    legalNotice: "Konzeptionelles Working Paper. Keine Rechts-, Steuer-, Sozial-, Förder-, Anlage- oder Rentenberatung und keine politische Programmatik.",
    editorialNote: "Öffentliche Fassung nach Red-Flag-Prüfung freigegeben.",
    downloadAllowed: true,
    previewAllowed: true,
  ...
  "nats-woek-allgemein": {
    ...
    subtitle: "Vortragsfolien zur Grundidee der Wirkungsökonomie",
    fileName: "NATS_WOeK_allgemein.pdf",
    filePath: "public/downloads/originals/NATS_WOeK_allgemein.pdf",
    contentHtmlPath: "content/documents/online/nats-woek-allgemein.inc",
    documentType: "vortrag",
    status: "aktuell",
    visibility: "public",
    audience: ["Einstieg", "Praxis", "Veranstaltungen"],
    level: "intro",
    summaryShort: "Vortragsunterlage zur Verschiebung von Kapital als Maßstab hin zu Wirkung als Kompass.",
    whatToExpect: "Folienhafte Einführung in Grundbegriffe, Beispiele und Schutzlinien der Wirkungsökonomie.",
    keyQuestions: ["Warum reicht Kapital als Maßstab nicht aus?", "Was bedeutet Wirkung als Kompass?", "Welche Missverständnisse muss die WÖk vermeiden?"],
    topics: ["Einführung", "Wirkung statt Kapital", "Vortrag"],
    methods: ["Wirkungslogik", "Systembild", "Schutzlinien"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    legalNotice: "Vortragsunterlage. Keine Rechts-, Steuer-, Förder-, Anlage-, Unternehmens- oder Politikberatung.",
    editorialNote: "Öffentliche Fassung nach Red-Flag-Prüfung freigegeben.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Einstieg & Vorträge",
    order: 322
  },
  "woek-master-items-register": {
    title: "WÖk-Masterregister v1.5",
    subtitle: "Führendes MasterItems-Register mit Zwei-Ebenen-, Quellen- und Prüfarchitektur",
    fileName: "WOeK_Masterregister_v1.5_2026-08-21.xlsx",
    filePath: "assets/downloads/woek-register/v1.5/WOeK_Masterregister_v1.5_2026-08-21.xlsx",
    contentHtmlPath: "content/documents/online/woek-master-items-register.inc",
    documentType: "datenregister",
    status: "führend",
    visibility: "expert_public",
    audience: ["Methodik", "Daten", "Wissenschaft"],
    level: "expert",
    summaryShort: "Führendes Register mit 621 stabilen MasterItems, expliziter Trennung vom Wirkindikatorenregister sowie sichtbaren offenen Mapping- und Prüfstatus.",
    whatToExpect: "Ein technisches Register für Expert:innen: Wirkungsobjekt, StateVariable- und Indicator-Mappingstatus, Regeln, Quellenfunktion, Systemgrenzen, Datenqualität und Assurance.",
    keyQuestions: ["Welche MasterItems und Prüfpfade sind aktuell geführt?", "Welche Zuordnungen bleiben OPEN_REVIEW_REQUIRED?", "Wie bleiben MasterItem, Indikator, Beobachtung und Wirkung getrennt?"],
    topics: ["WÖk-ID", "MasterItems", "Wirkindikatorenregister", "Staatliche Nachhaltigkeitsarchitektur"],
    methods: ["MasterItem → StateVariable → Indicator → Observation", "Datenqualität & Assurance"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    legalNotice: "Technisches Register. Keine amtliche Klassifikation, keine Rechts-, Steuer-, Förder-, Anlage- oder Unternehmensberatung.",
    editorialNote: "Führende Fassung v1.5, Stand 21. August 2026. Alle 621 IDs aus v1.4 bleiben unverändert. Offene Mappings, Kalibrierungen und Benchmarks bleiben offen; leere Eingaben bleiben unbewertet.",
    replaces: ["woek-master-items-v1-2"],
    downloadAllowed: true,
    previewAllowed: true,
    section: "Register & Daten",
    order: 324
  },
  "sexarbeit-als-soziale-infrastruktur": {
    ...
    fileName: "Sexarbeit-als-soziale-Infrastruktur.pdf",
    filePath: "public/downloads/originals/Sexarbeit-als-soziale-Infrastruktur.pdf",
    contentHtmlPath: "content/documents/online/sexarbeit-als-soziale-infrastruktur.inc",
    documentType: "konzeptpapier",
    status: "aktuell",
    visibility: "expert_public",
    audience: ["Politik", "Soziales", "Wissenschaft"],
    level: "expert",
    summaryShort: "Konzeptpapier zur funktionalen Einordnung von Sexarbeit als soziale Infrastruktur und Regulierungsfrage.",
    whatToExpect: "Eine wirkungsökonomische Einordnung mit Fokus auf Schutz, Rechte, Realität, Risiken und institutionelle Rückkopplung.",
    keyQuestions: ["Warum greift eine rein moralische Betrachtung zu kurz?", "Welche Wirkungsrisiken entstehen durch Verdrängung?", "Wie können Schutz, Rechte und Regulierung zusammen gedacht werden?"],
    topics: ["Sexarbeit", "Soziale Infrastruktur", "Regulierung"],
    methods: ["Wirkungsanalyse", "Schutzarchitektur", "SDG+"],
    impactFields: ["Mensch", "Demokratie"],
    legalNotice: "Konzeptpapier. Keine Rechts-, Sozial-, Gesundheits-, Sicherheits- oder Beratungsleistung und keine Bewertung einzelner Personen oder Gruppen.",
    editorialNote: "Aus der DOCX-Quelle als öffentliche PDF- und Onlinefassung erzeugt; das Word-Dokument bleibt nicht downloadbar.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Wirkungsfelder",
    order: 326
  },
  "illusionmaschine-buerokratieabbau": {
    title: "IllusionMaschine Bürokratieabbau",
    subtitle: "Warum weniger Regeln nicht automatisch mehr Wirkung erzeugen",
    fileName: "IllusionMaschine-Buerokratieabbau.pdf",
    filePath: "public/downloads/originals/IllusionMaschine-Buerokratieabbau.pdf",
    contentHtmlPath: "content/documents/online/illusionmaschine-buerokratieabbau.inc",
    documentType: "working-paper",
    status: "aktuell",
    visibility: "public",
    audience: ["Politik", "Verwaltung", "Methodik"],
    level: "expert",
    summaryShort: "Working Paper zur Frage, wann Bürokratieabbau Wirkung schafft und wann er nur Schutz- und Rückkopplungsfunktionen abbaut.",
    whatToExpect: "Eine systemische Einordnung von Bürokratie, Regulierung, Reparaturaufwand und Wirkungsarchitektur.",
    keyQuestions: ["Wann ist Bürokratie Reparaturfolge falscher Anreize?", "Wann schützt Verwaltung reale Wirkungsgrenzen?", "Wie unterscheidet man Vereinfachung von Schutzabbau?"],
    topics: ["Bürokratie", "Regulierung", "Wirkungsarchitektur"],
    methods: ["Systemanalyse", "Wirkungsfolgenabschätzung", "Rückkopplung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    legalNotice: "Working Paper. Keine Rechts-, Verwaltungs-, Steuer-, Förder-, Anlage- oder Politikberatung.",
    editorialNote: "Öffentliche Fassung nach Red-Flag-Prüfung freigegeben.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Staat & Demokratie",
    order: 328
  },
  "wp-rente": {
...
function applyReviewReleaseOverrides(doc) {
  const override = REVIEW_RELEASE_OVERRIDES.get(doc.id);
  return override ? { ...doc, ...override } : doc;
}

const DOCUMENTS = [
  {
    id: "nachhaltigkeit-als-systemresilienz-definition-und-klimamodell-v1-0",
    slug: "nachhaltigkeit-als-systemresilienz-definition-und-klimamodell-v1-0",
    title: "Nachhaltigkeit als Systemresilienz v1.0",
    subtitle: "Archivierte erste Online-Ausgabe der Fachveröffentlichung",
    fileName: "Nachhaltigkeit_als_Systemresilienz_Definition_und_Klimamodell_v1.0.pdf",
    filePath: "public/downloads/originals/Nachhaltigkeit_als_Systemresilienz_Definition_und_Klimamodell_v1.0.pdf",
    documentType: "grundlagenpapier",
    status: "archiviert",
    visibility: "archive",
    audience: ["Fachöffentlichkeit", "Wissenschaft", "Methodik"],
    level: "expert",
    summaryShort: "Erste Online-Ausgabe der Fachveröffentlichung, für bestehende Zitate unverändert erhalten.",
    whatToExpect: "Die kompaktere v1.0-Ausgabe ohne die vollständige Abbildungs- und Formelstrecke. Für die vollständige Fachfassung gilt v1.1.",
    keyQuestions: ["Wo liegt die vollständige Fachfassung?", "Welche erste Online-Ausgabe bleibt zitierfähig?"],
    topics: ["Nachhaltigkeit", "Resilienz", "Systemresilienz", "Archiv"],
    methods: ["Systemresilienz", "Wirkungsarchitektur", "Nichtkompensation"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["nachhaltigkeit-als-systemresilienz-definition-und-klimamodell"],
    version: "1.0",
    date: "2026-07-30",
    replacedBy: "nachhaltigkeit-als-systemresilienz-definition-und-klimamodell",
    editorialNote: "Archivierte erste Online-Ausgabe. Nicht still überschrieben; die vollständige Fachfassung mit gesetzten Formeln und Abbildungen ist Version 1.1.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 208
  ...
  },
  {
    ...
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "wirkungssteuer-wstg-3-0"],
    version: "v1.0",
    date: "2026-05",
  ...
  },
  {
    ...
    subtitle: "Zitierfähiger historischer Entwicklungsstand vor der Gesamtneufassung 3.0",
    ...
    level: "juristisch",
    summaryShort: "Historische Diskussionsfassung des Wirkungssteuergesetzes vom Oktober 2025; ersetzt durch die Gesamtneufassung WStG 3.0.",
    whatToExpect: "Die unveränderte, zitierfähige historische Quellenfassung. Für den aktuellen fachlichen Stand gilt die Gesamtneufassung 3.0 vom 17. August 2026.",
    ...
    impactFields: ["Staat & Demokratie"],
    relatedDocuments: ["wirkungssteuer-wstg-3-0", "wirkungsrat-konzept", "technische-leitlinien-wustg"],
    version: "Oktober 2025",
    date: "2025-10",
    replacedBy: "wirkungssteuer-wstg-3-0",
    successorUrl: "bibliothek/wirkungssteuer-wstg-3-0/",
    successorLabel: "WStG 3.0 öffnen",
    historicalNotice: "Diese Fassung dokumentiert den Entwicklungsstand von 2025. Sie ist durch die modulare Gesamtneufassung 3.0 ersetzt.",
    editorialNote: "Historische Originalfassung; nicht still überschrieben.",
    legalNotice: "Historische Diskussionsfassung. Nicht amtlich. Keine Rechts-, Steuer- oder Anlageberatung.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Recht & Steuerung",
    order: 205
  ...
  {
    id: "wirkungssteuer-wstg-3-0",
    slug: "wirkungssteuer-wstg-3-0",
    title: "Wirkungssteuer 3.0 und Wirkungssteuergesetz (WStG) 3.0",
    subtitle: "Gesamtneufassung 2026: Systemarchitektur, Gesetzesentwurf, Kommentierung, Steuerartenatlas und Umsetzungspfad",
    author: "Natalie Weber",
    publicationLabel: "Führender Referenz- und Gesetzesentwurf",
    fileName: "Wirkungssteuer_WStG_3.0_Gesamtneufassung_2026.pdf",
    filePath: "public/downloads/originals/Wirkungssteuer_WStG_3.0_Gesamtneufassung_2026.pdf",
    contentHtmlPath: "content/documents/online/wirkungssteuer-wstg-3-0.inc",
    documentType: "gesetzesentwurf",
    status: "führend",
    visibility: "public",
    audience: ["Politik", "Verwaltung", "Steuerrecht", "Wissenschaft", "Fachöffentlichkeit"],
    level: "juristisch",
    summaryShort: "Die Gesamtneufassung 3.0 ordnet Wirkungssteuer als modulare Rückkopplungsarchitektur über bestehende Steuerarten: Scorecards liefern Evidenz, der Gesetzgeber bleibt Tarifgeber.",
    whatToExpect: "47 Seiten mit 125 vollständig kommentierten Paragrafen, Steuerartenatlas, Daten- und Registerarchitektur, Wirkungsnachweiskonto, Governance, Rechtsschutz, KI, EU-Pfad, Digitalem Produktpass und Umsetzungshorizont bis 2040.",
    keyQuestions: [
    ...
    topics: ["Wirkungssteuer", "WStG 3.0", "Steuerartenatlas", "Wirkungsnachweiskonto", "EU-Steuerrecht", "Digitaler Produktpass", "Governance", "Rechtsschutz"],
    methods: ["Wirkungsrückkopplung", "Scorecards", "Nichtkompensation", "Reverse Merit Order", "WÖk-IDs", "Evaluation"],
    impactFields: ["Mensch", "Planet", "Demokratie", "Staat & Recht", "Wirtschaft & Kapital"],
    relatedDocuments: ["wstg-oktober-2025", "wirkungsrat-konzept", "technische-leitlinien-wustg", "woek-begriffsleitfaden-fuehrend", "woek-master-items-register"],
    version: "3.0 · Gesamtneufassung 2026",
    date: "2026-08-17",
    isLeadingReference: true,
    replaces: ["wstg-oktober-2025"],
    legalNotice: "Referenz- und Diskussionsentwurf. Kein geltendes Recht und keine Rechts-, Steuer-, Finanz- oder Anlageberatung. Tarife, Schwellen und Module sind, soweit nicht ausdrücklich anders bezeichnet, WÖk-Entwurfs- oder Simulationsparameter.",
    editorialNote: "Echte Gesamtneufassung. Die Fassung 2.0 und das Working Paper vom Oktober 2025 bleiben unverändert und zitierfähig archiviert.",
    downloadAllowed: true,
    previewAllowed: true,
    includeInFullKnowledgeLibrary: true,
    section: "Recht & Steuerung",
  ...
  },
  {
    ...
    audience: ["Methodik", "Daten", "Wissenschaft"],
    level: "technisch",
    summaryShort: "Führendes Register mit 621 stabilen MasterItems, getrennter Messontologie, staatlichen Referenzquellen und sichtbaren offenen Mappingstatus.",
    whatToExpect: "Ein technisches Register mit Wirkungsobjekten, Mappingstatus, Regeln, Systemgrenzen, Quellenfunktion, Kalibrierungsstatus und Assurance.",
    keyQuestions: ["Welche MasterItems und Prüfpfade liegen der WÖk zugrunde?", "Welche Zustands- und Indikatorzuordnungen sind noch offen?"],
    topics: ["WÖk-IDs", "MasterItems", "Wirkindikatorenregister", "Registerarchitektur"],
    methods: ["MasterItem → StateVariable → Indicator → Observation", "Datenqualität & Assurance"],
    impactFields: ["Daten & Infrastruktur"],
    relatedDocuments: ["technische-leitlinien-wustg"],
    version: "v1.5",
    date: "2026-08-21",
    legalNotice: "Arbeits- und Governance-Modell. Keine amtliche Klassifikation und keine automatische Entscheidung.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Technische Anlagen",
    order: 420
  ...
  {
    id: "woek-master-items-register-v1-4",
    slug: "woek-master-items-register-v1-4",
    title: "WÖk-Masterregister v1.4 (historische Fassung)",
    subtitle: "Ersetzte technische Registerfassung vom 16. August 2026",
    fileName: "WOeK_Masterregister_v1.4_FINAL_2026-08-16.xlsx",
    filePath: "assets/downloads/woek-register/v1.4/WOeK_Masterregister_v1.4_FINAL_2026-08-16.xlsx",
    documentType: "datenregister",
    status: "ersetzt",
    visibility: "expert_public",
    audience: ["Methodik", "Daten", "Wissenschaft"],
    level: "technisch",
    summaryShort: "Historische v1.4-Fassung mit 621 WÖk-IDs; für aktuelle Anwendungen gilt v1.5.",
    whatToExpect: "Unveränderte historische Registerdatei zur Nachvollziehbarkeit des v1.4-Standes.",
    keyQuestions: ["Wie sah das Register vor der expliziten Zwei-Ebenen-Architektur aus?"],
    topics: ["WÖk-IDs", "Register", "Versionierung"],
    methods: ["WÖk-IDs", "Datenqualität & Assurance"],
    impactFields: ["Daten & Infrastruktur"],
    relatedDocuments: ["woek-master-items-register"],
    version: "v1.4",
    date: "2026-08-16",
    legalNotice: "Historische Arbeits- und Governance-Fassung. Keine amtliche Klassifikation und keine automatische Entscheidung.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 421
  ...
  },
  {
    ...
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.7.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.7.pdf",
    contentHtmlPath: "content/documents/online/woek-begriffsleitfaden-fuehrend.inc",
    documentType: "redaktionsgrundlage",
    status: "führend",
    visibility: "public",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Führende Sprach- und Methodenreferenz v1.7: staatliche Prüfrahmen objektspezifisch einordnen, Wirkungsrelevanz statt Rechtsform anwenden und den WÖk-Zusatznutzen additiv bestimmen.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit DNS/GGO/GFA/eNAP, § 7 BHO/VV-BHO, anwendbaren Fachrahmen, Problem Review, Goal Review, Wirkpfad, Gegenfaktum, Attribution, Zwei-Ebenen-Registerarchitektur, Nichtkompensation und Reality Check.",
    keyQuestions: ["Welcher staatliche Prüfrahmen gilt für welchen Gegenstand?", "Was leisten DNS, GGO/GFA/eNAP und BHO/VV-BHO bereits?", "Was ergänzt die WÖk spezifisch?", "Wie werden MasterItem, Indikator, Beobachtung, Wirkung und Attribution getrennt?"],
    topics: ["Begriffe", "Glossar", "Sprachregelwerk", "DNS", "GFA", "eNAP", "BHO", "VV-BHO", "Wirkungsrelevanz", "Objektspezifische Prüfarchitektur", "Problem Review", "Goal Review", "Masterregister", "Wirkindikatorenregister", "Reality Check"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "leitbild-mensch-planet-demokratie"],
    version: "v1.7",
    date: "2026-08-21",
    editorialNote: "Vollständige, geprüfte Version 1.7. Sie ergänzt v1.6 um Wirkungsrelevanz statt Rechtsform sowie § 7 BHO/VV-BHO und objektspezifische Prüfrahmen. Version 1.0 bis 1.6 bleiben zitierfähig erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
    isLeadingReference: true,
    section: "Führende Referenzen",
    order: 430
  },
  {
    id: "woek-begriffsleitfaden-fuehrend-v1-6",
    slug: "woek-begriffsleitfaden-fuehrend-v1-6",
    title: "WÖk-Begriffsleitfaden führend v1.6",
    subtitle: "Zitierfähige Archivfassung der maßgeblichen Sprachreferenz",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.6.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.6.pdf",
    documentType: "redaktionsgrundlage",
    status: "archiviert",
    visibility: "archive",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Archivierte Fassung v1.6 mit der staatlichen Nachhaltigkeits- und Folgenprüfungsarchitektur sowie der Zwei-Ebenen-Registerlogik.",
    whatToExpect: "Die frühere, zitierfähige Fassung. Für Wirkungsrelevanz, § 7 BHO/VV-BHO und die objektspezifische staatliche Prüfarchitektur gilt v1.7.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.6?", "Wo ist die aktuelle Fassung v1.7?"],
    topics: ["Begriffe", "Glossar", "Archiv", "DNS", "GFA", "eNAP", "Masterregister", "Wirkindikatorenregister"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
    version: "v1.6",
    date: "2026-08-21",
    replacedBy: "woek-begriffsleitfaden-fuehrend",
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.7.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 434
  ...
  {
    id: "woek-begriffsleitfaden-fuehrend-v1-5",
    slug: "woek-begriffsleitfaden-fuehrend-v1-5",
    title: "WÖk-Begriffsleitfaden führend v1.5",
    subtitle: "Zitierfähige Archivfassung der maßgeblichen Sprachreferenz",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.5.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.5.pdf",
    documentType: "redaktionsgrundlage",
    status: "archiviert",
    visibility: "archive",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Archivierte Fassung v1.5 des Begriffsleitfadens mit der IOOI- und Wirkungsarchitektur-Präzisierung vom 15. August 2026.",
    whatToExpect: "Die frühere, zitierfähige Fassung. Für den aktuellen Begriffsstand gilt v1.7.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.5?", "Wo ist die aktuelle Fassung v1.7?"],
    topics: ["Begriffe", "Glossar", "Archiv", "IOOI", "Wirkungsarchitektur"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
    version: "v1.5",
  ...
  {
    id: "woek-begriffsleitfaden-fuehrend-v1-4",
    slug: "woek-begriffsleitfaden-fuehrend-v1-4",
    title: "WÖk-Begriffsleitfaden führend v1.4",
    subtitle: "Zitierfähige Archivfassung der maßgeblichen Sprachreferenz",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.4.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.4.pdf",
    documentType: "redaktionsgrundlage",
    status: "archiviert",
    visibility: "archive",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Archivierte Fassung v1.4 des Begriffsleitfadens; sie dokumentiert den vorherigen IOOI-Stand und bleibt für frühere Zitate unverändert erhalten.",
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.7.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.4?", "Wo ist die aktuelle Fassung v1.7?"],
    topics: ["Begriffe", "Glossar", "Archiv", "IOOI", "Wirkungsarchitektur"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
  ...
  {
    id: "woek-begriffsleitfaden-fuehrend-v1-3",
    slug: "woek-begriffsleitfaden-fuehrend-v1-3",
    title: "WÖk-Begriffsleitfaden führend v1.3",
    subtitle: "Zitierfähige Archivfassung der maßgeblichen Sprachreferenz",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.3.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.3.pdf",
    documentType: "redaktionsgrundlage",
    status: "archiviert",
    visibility: "archive",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Archivierte Fassung v1.3 des Begriffsleitfadens mit der damals führenden Resilienzsystematik.",
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.7.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.3?", "Wo ist die aktuelle Fassung v1.7?"],
    topics: ["Begriffe", "Glossar", "Archiv", "Wirkungsresilienz"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
    version: "v1.3",
  ...
  {
    id: "woek-begriffsleitfaden-fuehrend-v1-2",
    slug: "woek-begriffsleitfaden-fuehrend-v1-2",
    title: "WÖk-Begriffsleitfaden führend v1.2",
    subtitle: "Zitierfähige Archivfassung der maßgeblichen Sprachreferenz",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.2.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.2.pdf",
    documentType: "redaktionsgrundlage",
    status: "archiviert",
    visibility: "archive",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Archivierte Fassung v1.2 des Begriffsleitfadens; für frühere Zitate unverändert erhalten.",
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.7.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.2?", "Wo ist die aktuelle Fassung v1.7?"],
    topics: ["Begriffe", "Glossar", "Archiv"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
    version: "v1.2",
  ...
  {
    id: "woek-begriffsleitfaden-fuehrend-v1-0",
    slug: "woek-begriffsleitfaden-fuehrend-v1-0",
    title: "WÖk-Begriffsleitfaden führend v1.0",
    subtitle: "Zitierfähige Archivfassung der maßgeblichen Sprachreferenz",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.0.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.0.pdf",
    documentType: "redaktionsgrundlage",
    status: "archiviert",
    visibility: "archive",
    audience: ["Redaktion", "Fachöffentlichkeit", "Akademie"],
    level: "fortgeschritten",
    summaryShort: "Archivierte Fassung v1.0 des Begriffsleitfadens; für frühere Zitate unverändert erhalten.",
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.7.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.0?", "Wo ist die aktuelle Fassung v1.7?"],
    topics: ["Begriffe", "Glossar", "Archiv"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
  ...
  },
  {
    ...
    title: "Nachhaltigkeit ist keine Strategie. Sie ist eine Systemarchitektur.",
    subtitle: "Warum Nachhaltigkeit im kapitalszentrierten Steuerungsmodell strukturell unterbestimmt bleibt",
    fileName: "Nachhaltigkeit-Systemarchitektur-v1.2.pdf",
    filePath: "public/downloads/originals/Nachhaltigkeit-Systemarchitektur-v1.2.pdf",
    contentHtmlPath: "content/documents/online/nachhaltigkeit-systemarchitektur-v1.2.inc",
    documentType: "working-paper",
    status: "aktuell",
    visibility: "public",
    audience: ["Fachöffentlichkeit", "Wissenschaft", "Methodik"],
    level: "expert",
    summaryShort: "Version 1.2 des Grundlagenpapiers: Nachhaltigkeit als langfristig gesicherte Wirkungsresilienz des gekoppelten Systems Mensch-Planet-Demokratie.",
    whatToExpect: "Eine fachlich dichte Herleitung von Systemarchitektur und Systemresilienz mit Rückstell- und Regenerationsmechanismen, acht Analysebausteinen, Nichtkompensation und Regimeresilienz-Abgrenzung.",
    keyQuestions: ["Warum bleibt Nachhaltigkeit im kapitalszentrierten Steuerungsmodell strukturell unterbestimmt?", "Wie unterscheiden sich Systemarchitektur, Systemresilienz und langfristige Wirkungsresilienz?", "Wie machen Rückstellungen, Regeneration, Lernen und Nicht-Externalisierung ein System nachhaltig?"],
    topics: ["Nachhaltigkeit", "Systemarchitektur", "Systemresilienz", "Wirkungsresilienz", "Transformation"],
    methods: ["Wirkungsarchitektur", "Systemresilienz", "SDGs & SDG+", "Reverse Merit Order", "Nichtkompensation"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["systemmodell-wirkungsoekonomie", "grundlagenpapier-wirkungsoekonomie", "woek-begriffsleitfaden-fuehrend", "standardwerk-neue-ordnung-wohlstands-2026"],
    version: "1.2 · 2026.1",
    date: "2026-07-30",
    legalNotice: "Keine Rechts-, Steuer-, Anlage-, Kredit-, Versicherungs-, Förder- oder Unternehmensberatung.",
    editorialNote: "Version 1.2 · 2026.1 präzisiert Nachhaltigkeit als langfristig gesicherte Wirkungsresilienz und trennt die acht Analysebausteine sauber. Die PDF-Versionen 1.0 und 1.1 bleiben unter ihren ursprünglichen Downloadpfaden als zitierfähige historische Fassungen erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Grundlagen & Leitbild",
    order: 206
  ...
  {
    id: "nachhaltigkeit-systemarchitektur-v1-1",
    slug: "nachhaltigkeit-systemarchitektur-v1-1",
    title: "Nachhaltigkeit ist keine Strategie. Sie ist eine Systemarchitektur. v1.1",
    subtitle: "Zitierfähige Archivfassung der Resilienzpräzisierung",
    fileName: "Nachhaltigkeit-Systemarchitektur-v1.1.pdf",
    filePath: "public/downloads/originals/Nachhaltigkeit-Systemarchitektur-v1.1.pdf",
    documentType: "working-paper",
    status: "archiviert",
    visibility: "archive",
    audience: ["Fachöffentlichkeit", "Wissenschaft", "Methodik"],
    level: "expert",
    summaryShort: "Archivierte Fassung v1.1 des Grundlagenpapiers; für frühere Zitate unverändert erhalten.",
    whatToExpect: "Die frühere, zitierfähige Resilienzpräzisierung. Für den aktuellen Begriffsstand gilt Version 1.2 · 2026.1.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.1?", "Wo ist die aktuelle Fassung?"],
    topics: ["Nachhaltigkeit", "Systemarchitektur", "Systemresilienz", "Archiv"],
    methods: ["Wirkungsarchitektur", "Systemresilienz", "Nichtkompensation"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["nachhaltigkeit-systemarchitektur"],
    version: "1.1",
    date: "2026-07-30",
    replacedBy: "nachhaltigkeit-systemarchitektur",
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.2 · 2026.1.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 207
  ...
  {
    id: "nachhaltigkeit-als-systemresilienz-definition-und-klimamodell",
    slug: "nachhaltigkeit-als-systemresilienz-definition-und-klimamodell",
    title: "Nachhaltigkeit als Systemresilienz",
    subtitle: "Resilienzdefinition, Kugelmodell, Klima-Beispiel und mathematische Herleitung",
    fileName: "Nachhaltigkeit_als_Systemresilienz_Definition_und_Klimamodell_v1.1.pdf",
    filePath: "public/downloads/originals/Nachhaltigkeit_als_Systemresilienz_Definition_und_Klimamodell_v1.1.pdf",
    contentHtmlPath: "content/documents/online/nachhaltigkeit-als-systemresilienz-definition-und-klimamodell-v1.1.inc",
    documentType: "grundlagenpapier",
    status: "aktuell",
    visibility: "public",
    audience: ["Fachöffentlichkeit", "Wissenschaft", "Methodik", "Akademie"],
    level: "expert",
    summaryShort: "Fachveröffentlichung zur langfristig gesicherten Wirkungsresilienz mit Kugel-Becken-Modell, Klimaformeln und MPD-Herleitung.",
    whatToExpect: "Eine nachvollziehbare Verbindung von allgemeiner Resilienzdefinition, Stabilitätslandschaft, Rückstellung, Dämpfung, Anpassung, Transformation, Klimasystem und Nichtkompensation im MPD-Referenzrahmen.",
    keyQuestions: ["Wie unterscheiden sich Resilienz, Systemresilienz, Wirkungsresilienz und Nachhaltigkeit?", "Was erklären die acht Analysebausteine?", "Warum genügt Rückkehr in den alten Zustand nicht immer?"],
    topics: ["Nachhaltigkeit", "Resilienz", "Systemresilienz", "Wirkungsresilienz", "Klima", "Stabilitätslandschaft"],
    methods: ["Systemresilienz", "Wirkungsarchitektur", "Nichtkompensation", "SDGs & SDG+"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend", "nachhaltigkeit-systemarchitektur", "systemmodell-wirkungsoekonomie", "grundlagenpapier-wirkungsoekonomie"],
    version: "1.1",
    date: "2026-07-30",
    legalNotice: "Keine Rechts-, Steuer-, Anlage-, Kredit-, Versicherungs-, Förder- oder Unternehmensberatung.",
    editorialNote: "Vollständige Fachfassung mit gesetzten Formeln und Abbildungen. Die frühere v1.0-PDF bleibt als erste Online-Ausgabe zitierfähig erhalten; v1.1 ist die führende Fassung.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Grundlagen & Leitbild",
    order: 205,
    ...
    replaces: ["nachhaltigkeit-als-systemresilienz-definition-und-klimamodell-v1-0"]
  },
  {
    id: "wirkungsbasiertes-value-pricing",
    slug: "wirkungsbasiertes-value-pricing",
    ...
    author: "Natalie Weber",
    publicationLabel: "Dossier und fachliches Detailkonzept",
    fileName: "Wirkungsbasiertes_Value_Pricing_v1.2.pdf",
    filePath: "public/downloads/originals/Wirkungsbasiertes_Value_Pricing_v1.2.pdf",
    contentHtmlPath: "content/documents/online/wirkungsbasiertes-value-pricing-v1.2.inc",
    documentType: "dossier",
    status: "aktuell",
    visibility: "public",
    audience: ["Unternehmen", "Beratung", "Einkauf", "Controlling", "Fachöffentlichkeit"],
    level: "expert",
    summaryShort: "Dossier v1.2 zur Vergütung nach zurechenbarem Kundenwert: Es verbindet Value-based Pricing mit einer getrennten Prüfung positiver Netto-Wirkung für Mensch, Planet und Demokratie.",
    whatToExpect: "Ein fachliches Arbeitsmodell für Leistungen und Angebote: Kundenwert, Attribution, Wirkungsrisiken, Nichtkompensation, Wirkungsgrenzen, Erschwinglichkeit und faire Lastenverteilung werden getrennt ausgewiesen und in einen verantworteten Preis-Korridor überführt.",
    keyQuestions: [
      "Wie wird der ökonomische Kundenwert einer Leistung von Aufwand und Umsatz unterschieden?",
      "Wie werden Kundenwert und Netto-Wirkung getrennt geprüft, ohne sie zu einer Euro-Summe zu verrechnen?",
      "Welche Rolle spielen Attribution, Datenqualität, Wirkungsgrenzen und faire Risikoteilung bei einem Preis-Korridor?"
    ],
    topics: ["Value-based Pricing", "Kundenwert", "Wirkungscontrolling", "Scorecards", "Nichtkompensation", "Preis-Korridor"],
    methods: ["Wirkungscontrolling", "Wirkpfad", "Wirkungszurechnung", "Scorecards", "T-SROI"],
    impactFields: ["Mensch", "Planet", "Demokratie", "Ökonomie"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "whitepaper-t-sroi", "woek-begriffsleitfaden-fuehrend"],
    version: "v1.2 · Erstveröffentlichung 4. Mai 2026 · aktualisierte Fassung August 2026",
    date: "2026-05-04",
    legalNotice: "Fachliches Arbeitsmodell, kein allgemein anerkannter Norm-, Prüf- oder Vertragsstandard. Keine Rechts-, Steuer-, Finanz-, Preis-, Unternehmens- oder Vertragsberatung. Keine automatische Preisformel und keine Personenbewertung.",
    downloadAllowed: true,
    previewAllowed: true,
    includeInFullKnowledgeLibrary: true,
  ...
  {
    id: "klimawandel-finanzmarkt",
    slug: "klimawandel-finanzmarkt",
    title: "Klimawandel und der Finanzmarkt",
    subtitle: "Versicherbarkeit, Sustainable Finance, Stranded Assets und die stille Neubewertung von Vermögen",
    fileName: "woek_dossier_klimawandel_finanzmarkt_v1_0.pdf",
    filePath: "assets/downloads/woek_dossier_klimawandel_finanzmarkt_v1_0.pdf",
    contentHtmlPath: "content/documents/online/klimawandel-finanzmarkt.inc",
    documentType: "dossier",
    status: "aktuell",
    visibility: "public",
    audience: ["Bürger:innen", "Unternehmen", "Investor:innen", "Politik", "Fachöffentlichkeit"],
    level: "fortgeschritten",
    summaryShort: "Dossier zur stillen Neubewertung von Klimarisiken im Finanzmarkt: Versicherbarkeit, Kreditwürdigkeit, Sustainable Finance, Stranded Assets und Wirkungskapital.",
    whatToExpect: "Eine umfassende Online- und PDF-Fassung mit verständlicher Einführung, Versicherungs- und Kreditlogik, Sustainable-Finance-Kontext, Stranded-Asset-Risiken, Checklisten, Glossar und Quellenapparat.",
    keyQuestions: [
    ...
    topics: ["Klimawandel", "Finanzmarkt", "Versicherbarkeit", "Kreditwürdigkeit", "Sustainable Finance", "Stranded Assets", "Klimarisiko", "Wirkungskapital", "Positive Netto-Wirkung"],
    methods: ["Wirkungsanalyse", "Wirkungsrisiko", "Wirkungspfad-Analyse", "Wirkungsrückkopplung", "Nichtkompensation"],
    impactFields: ["Planet", "Mensch", "Demokratie", "Finanzsystem & Kapital", "Wirtschaft & Unternehmen"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "nachhaltigkeit-systemarchitektur", "systemmodell-wirkungsoekonomie", "fuenf-wellen-wirkungsentfaltung", "wirkungsoekonomie-lieferkette"],
    version: "v1.0",
    date: "2026-06-29",
    legalNotice: "Keine Rechts-, Versicherungs-, Kredit-, Förder-, Steuer- oder Anlageberatung; keine Bewertung einzelner Anbieter, Produkte, Personen oder Portfolios; keine amtliche Bewertungsmethode.",
    editorialNote: "Umfassende Dossierfassung zum Zusammenhang von Klimawandel, Versicherbarkeit, Kapitalmärkten und wirkungsökonomischer Rückkopplung.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Wirkungsfelder",
    order: 332
  ...
  const body = `
      ...
      <section class="section section-muted">
        ...
        <div class="document-reading-path-grid">
          ...
          ${path("Für Politik und Verwaltung", "Recht, Wirkungshaushalt, Wirkungsrat und Schutzlinien.", ["grundlagenpapier-wirkungsoekonomie", "wirkungssteuer-wstg-3-0", "wirkungsrat-konzept"])}
...
function detailPage(doc, prefix = "../../") {
  ...
  const actionLinks = [
    ...
    href ? `<a class="btn btn-primary" href="${href}">${doc.fileType === "xlsx" ? "XLSX herunterladen" : "PDF öffnen"}</a>` : "",
...
const initialModel = [...DOCUMENTS, ...EXTRA_ARCHIVE].map((doc) => ensureFields(applyReviewReleaseOverrides(doc)));
