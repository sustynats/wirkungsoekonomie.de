...
const DOCUMENTS = [
  ...
  },
  {
    ...
    level: "fortgeschritten",
    summaryShort: "Führende Sprachreferenz v1.2 mit Nachhaltigkeit als langfristiger Wirkungsresilienz sowie der Acht-Punkte-Systematik der Stabilitätslandschaft.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit Definitionen, Abgrenzungen, Stabilitätslandschaft, Rückstell- und Dämpfungsfähigkeit, Quellen und bevorzugten Formulierungen.",
    ...
    version: "v1.2",
    date: "2026-07-30",
    editorialNote: "Aus der kumulativen Markdown-Quelle und dem versionierten Systematik-Delta als öffentliche Onlinefassung und PDF-Exportfassung veröffentlicht. Version 1.0 und 1.1 bleiben als zitierfähige ältere Fassungen erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.2.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.0?", "Wo ist die aktuelle Fassung v1.2?"],
    ...
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.2.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 431
  ...
  },
  {
    ...
    contentHtmlPath: "content/documents/online/nachhaltigkeit-systemarchitektur-v1.1.inc",
    documentType: "working-paper",
    status: "aktuell",
    visibility: "public",
    audience: ["Fachöffentlichkeit", "Wissenschaft", "Methodik"],
    level: "expert",
    summaryShort: "Version 1.1 des Grundlagenpapiers: Nachhaltigkeit als langfristige Wirkungsresilienz des gekoppelten Systems Mensch–Planet–Demokratie.",
    whatToExpect: "Eine fachlich dichte Herleitung von Systemarchitektur und Systemresilienz mit Rückstell- und Regenerationsmechanismen, Walker-Dimensionen, Nichtkompensation und Regimeresilienz-Abgrenzung.",
    ...
    date: "2026-07-30",
    legalNotice: "Keine Rechts-, Steuer-, Anlage-, Kredit-, Versicherungs-, Förder- oder Unternehmensberatung.",
    editorialNote: "Version 1.1 präzisiert Nachhaltigkeit als langfristige Wirkungsresilienz. Die PDF-Version 1.0 bleibt unter ihrem ursprünglichen Downloadpfad als zitierfähige historische Fassung erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Grundlagen & Leitbild",
    order: 206
