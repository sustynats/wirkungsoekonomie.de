...
const DOCUMENTS = [
  ...
  },
  {
    ...
    level: "fortgeschritten",
    summaryShort: "Führende Sprach- und Methodenreferenz v1.6: staatliche Nachhaltigkeits- und Folgenprüfung fair einordnen, Problem und Ziel vor Wirkungsempfehlung prüfen und MasterItems von Indikatoren trennen.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit staatlicher Nachhaltigkeitsarchitektur, Problem Review, Goal Review, Wirkpfad, Gegenfaktum und Attribution, Zwei-Ebenen-Registerarchitektur, Resilienz, Nichtkompensation, Reality Check und Lernschleife.",
    keyQuestions: ["Was leisten DNS, GGO/GFA, Nachhaltigkeitsprüfung und eNAP/eGFA bereits?", "Was ergänzt die WÖk spezifisch?", "Wie werden MasterItem, Zustandsvariable, Indikator, Beobachtung, Wirkung und Attribution getrennt?"],
    topics: ["Begriffe", "Glossar", "Sprachregelwerk", "DNS", "GFA", "eNAP", "Problem Review", "Goal Review", "Masterregister", "Wirkindikatorenregister", "Reality Check", "Wirkungsarchitektur"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "leitbild-mensch-planet-demokratie"],
    version: "v1.6",
    date: "2026-08-21",
    editorialNote: "Vollständige, geprüfte Version 1.6. Sie erkennt die bestehende staatliche Folgen- und Nachhaltigkeitsarchitektur an, präzisiert den additiven WÖk-Beitrag und trennt Masterregister und Wirkindikatorenregister. Version 1.0 bis 1.5 bleiben zitierfähig erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
    isLeadingReference: true,
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung. Für die staatliche Nachhaltigkeitsarchitektur und die Zwei-Ebenen-Registerlogik gilt v1.6.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.5?", "Wo ist die aktuelle Fassung v1.6?"],
    ...
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.6.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 431
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.6.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.4?", "Wo ist die aktuelle Fassung v1.6?"],
    topics: ["Begriffe", "Glossar", "Archiv", "IOOI", "Wirkungsarchitektur"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.6.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.3?", "Wo ist die aktuelle Fassung v1.6?"],
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.6.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.2?", "Wo ist die aktuelle Fassung v1.6?"],
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.6.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.0?", "Wo ist die aktuelle Fassung v1.6?"],
    topics: ["Begriffe", "Glossar", "Archiv"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
