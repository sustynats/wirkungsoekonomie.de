...
const DOCUMENTS = [
  ...
  },
  {
    ...
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit Definitionen, Abgrenzungen, bevorzugten Formulierungen und Begriffen, die vermieden werden sollen.",
    ...
    version: "v1.0",
    date: "2026-05-21",
    editorialNote: "Aus der Markdown-Quelle als öffentliche Onlinefassung und PDF-Exportfassung veröffentlicht.",
    downloadAllowed: true,
    previewAllowed: true,
  ...
  },
  {
    ...
    filePath: "public/downloads/originals/Nachhaltigkeit-Systemarchitektur.pdf",
    contentHtmlPath: "content/documents/online/nachhaltigkeit-systemarchitektur.inc",
    documentType: "working-paper",
    status: "aktuell",
    visibility: "public",
    audience: ["Fachöffentlichkeit", "Wissenschaft", "Methodik"],
    level: "expert",
    summaryShort: "Grundlagenpapier zur systemischen Einordnung von Nachhaltigkeit als interdependente Wirkungsarchitektur.",
    whatToExpect: "Eine fachlich dichte Herleitung, warum Nachhaltigkeit nicht als additive Zusatzstrategie genügt, sondern als gekoppelte Systemarchitektur mit Rückkopplungen, Nichtkompensation und Netto-Wirkung verstanden werden muss.",
    keyQuestions: ["Warum bleibt Nachhaltigkeit im kapitalszentrierten Steuerungsmodell strukturell unterbestimmt?", "Wie wird aus Zielkatalogen eine interdependente Wirkungsarchitektur?", "Welche Rolle spielen Netto-Wirkung, Rückkopplung, Resonanz und Reverse Merit Order?"],
    topics: ["Nachhaltigkeit", "Systemarchitektur", "Transformation"],
    methods: ["Wirkungsarchitektur", "SDGs & SDG+", "Reverse Merit Order", "Nichtkompensation"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    ...
    date: "2026-02-19",
    legalNotice: "Keine Rechts-, Steuer-, Anlage-, Kredit-, Versicherungs-, Förder- oder Unternehmensberatung.",
    editorialNote: "Aus der Word-Quelle als Onlinefassung aufbereitet; PDF-Fassung aus dem vorhandenen Kerndokument übernommen.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Grundlagen & Leitbild",
    order: 206
