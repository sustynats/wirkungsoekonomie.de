...
const REVIEW_RELEASE_OVERRIDES = new Map(Object.entries({
  ...
  "woek-master-items-register": {
    ...
    subtitle: "Technisches Register der WÖk-IDs und Wirkungsitems",
    fileName: "WOeK_Master_Items_final_v1.2.pdf",
    filePath: "public/downloads/originals/WOeK_Master_Items_final_v1.2.pdf",
    ...
    level: "expert",
    summaryShort: "PDF-Register der WÖk-Master-Items zur methodischen Nachvollziehbarkeit der Wirkungsitem-Struktur.",
    whatToExpect: "Ein technisches Register für Expert:innen; kein narrativer Einstieg und keine amtliche Klassifikation.",
    keyQuestions: ["Welche Items sind im WÖk-System angelegt?", "Wie sind SDG-/SDG+-Bezüge strukturiert?", "Welche Datenbasis braucht methodische Weiterarbeit?"],
    topics: ["WÖk-ID", "Datenregister", "Wirkungsitems"],
    methods: ["WÖk-ID", "Register", "SDG+"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    ...
    editorialNote: "Öffentliche Fachfassung nach Red-Flag-Prüfung freigegeben. Die XLSX-Arbeitsdatei bleibt intern.",
    downloadAllowed: true,
    previewAllowed: true,
