...
const DOCUMENTS = [
  ...
  },
  {
    ...
    contentHtmlPath: "content/documents/online/nachhaltigkeit-als-systemresilienz-definition-und-klimamodell-v1.0.inc",
    documentType: "grundlagenpapier",
    status: "aktuell",
    visibility: "public",
    ...
    date: "2026-07-30",
    legalNotice: "Keine Rechts-, Steuer-, Anlage-, Kredit-, Versicherungs-, Förder- oder Unternehmensberatung.",
    editorialNote: "Erstveröffentlichung. Sie führt die verbindliche Begriffshierarchie, das Kugel-Becken-Modell, die acht Analysebausteine und die vereinfachte Klima- und MPD-Herleitung zusammen.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Grundlagen & Leitbild",
    order: 205
