...
const DOCUMENTS = [
  ...
  },
  {
    ...
    title: "WÖk-Begriffsleitfaden führend v1.1",
    subtitle: "Maßgebliche Sprachreferenz der Wirkungsökonomie",
    fileName: "WOeK_Begriffsleitfaden_fuehrend_v1.1.pdf",
    filePath: "public/downloads/originals/WOeK_Begriffsleitfaden_fuehrend_v1.1.pdf",
    ...
    level: "fortgeschritten",
    summaryShort: "Führende Sprachreferenz v1.1 mit Nachhaltigkeit als langfristiger Wirkungsresilienz des gekoppelten Systems Mensch–Planet–Demokratie.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit Definitionen, Abgrenzungen, Rückstell- und Regenerationsmechanismen, Quellen und bevorzugten Formulierungen.",
    ...
    version: "v1.1",
    date: "2026-07-30",
    editorialNote: "Aus der Markdown-Quelle als öffentliche Onlinefassung und PDF-Exportfassung veröffentlicht. Version 1.0 bleibt als zitierfähige Archivfassung erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.1.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.0?", "Wo ist die aktuelle Fassung v1.1?"],
    ...
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.1.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 431
