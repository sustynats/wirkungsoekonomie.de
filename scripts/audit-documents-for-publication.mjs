...
const REVIEW_RELEASE_OVERRIDES = new Map(Object.entries({
  ...
  "woek-master-items-register": {
    ...
    subtitle: "Führendes technisches Register für WÖk-IDs, Bewertungsregeln, Quellen und Prüfstatus",
    ...
    level: "expert",
    summaryShort: "Führendes Register mit 621 WÖk-IDs, 28 Regeln, getrennten Schwellen- und Benchmarkstatus sowie sichtbaren offenen Prüfbedarfen.",
    whatToExpect: "Ein technisches Register für Expert:innen: Itemlogik, Regelzuordnung, Quellenfunktion, Systemgrenzen, Datenqualität, Assurance, Kalibrierungs- und Benchmarkstatus.",
    keyQuestions: ["Welche WÖk-IDs und Prüfpfade sind aktuell geführt?", "Wann bleibt ein Messwert bewusst unbewertet?", "Welche Benchmarks sind aktiv validiert und welche noch offen?"],
    topics: ["WÖk-ID", "Datenregister", "Scorecards", "Benchmarks"],
    methods: ["WÖk-ID", "Scorecards", "Datenqualität & Assurance"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    ...
    editorialNote: "Führende Fassung v1.4, Stand 16. August 2026. FINAL bezeichnet die kanonische Registerfassung, nicht die abgeschlossene Validierung jeder Schwelle. Leere Eingaben bleiben unbewertet.",
...
const DOCUMENTS = [
  ...
  },
  {
    ...
    audience: ["Methodik", "Daten", "Wissenschaft"],
    level: "technisch",
    summaryShort: "Führendes Register mit 621 WÖk-IDs, 28 Regeln, getrennten Schwellen- und Benchmarkstatus sowie Prüfprotokoll.",
    whatToExpect: "Ein technisches Register mit Itemlogik, Regelzuordnung, Systemgrenzen, Quellenfunktion, Kalibrierungsstatus und Assurance.",
    keyQuestions: ["Welche Items und Prüfpfade liegen der WÖk zugrunde?"],
    topics: ["WÖk-IDs", "Indikatoren", "Register", "Scorecards"],
  ...
  },
  {
    ...
    level: "fortgeschritten",
    summaryShort: "Führende Sprach- und Methodenreferenz v1.5: IOOI ist eine externe, optionale Results Chain; die WÖk-Wirkungsarchitektur verbindet Vorwirkung, Evidenz, Bewertung, Schutz, Rückkopplung und Lernen.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit Systemhierarchie, sechsmoduliger Wirkungsarchitektur, Resilienz, IOOI, Wirkungspfad, Evidenz, Bewertung, Nichtkompensation, Wirkungsradar, Transformation, Rückkopplung, Quellen und Migrationsmatrix.",
    keyQuestions: ["Welche Begriffe und Quellenhierarchien sind maßgeblich?", "Wie werden Auslöser, Wirkungspotenzial, Wirkmechanismus, Wirkungsermittlung, Nachweis und Bewertung unterschieden?", "Wie ordnet die WÖk IOOI, Wirkungspfad, Nichtkompensation, Wirkungsradar und Rückkopplung ein?"],
    topics: ["Begriffe", "Glossar", "Sprachregelwerk", "Wirkungsresilienz", "Systemresilienz", "IOOI", "Wirkungspfad", "Wirkungsradar", "Wirkungsarchitektur"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "leitbild-mensch-planet-demokratie"],
    version: "v1.5",
    date: "2026-08-15",
    editorialNote: "Vollständige, geprüfte Version 1.5. Sie präzisiert IOOI als externe, optionale Results-Chain-Methode und ordnet die eigenständige WÖk-Wirkungsarchitektur, Wirkungspfade und das Wirkungsradar neu. Version 1.0 bis 1.4 bleiben als zitierfähige ältere Fassungen erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
    isLeadingReference: true,
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.5.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.4?", "Wo ist die aktuelle Fassung v1.5?"],
    ...
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.5.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 431
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.5.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.3?", "Wo ist die aktuelle Fassung v1.5?"],
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.5.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.2?", "Wo ist die aktuelle Fassung v1.5?"],
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.5.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.0?", "Wo ist die aktuelle Fassung v1.5?"],
    topics: ["Begriffe", "Glossar", "Archiv"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
