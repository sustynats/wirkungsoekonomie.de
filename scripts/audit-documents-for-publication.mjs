...
const DOCUMENTS = [
  ...
  },
  {
    ...
    level: "fortgeschritten",
    summaryShort: "Führende Sprachreferenz v1.4 mit Nachhaltigkeit als langfristiger Wirkungsresilienz sowie IOOI als Wirkpfad innerhalb der WÖk-Wirkungsarchitektur.",
    whatToExpect: "Ein verbindlicher Referenzrahmen für konsistente WÖk-Sprache mit Definitionen, Abgrenzungen, Resilienz, IOOI, Wirkpfad, Evidenz, Wirkungsbewertung, Nichtkompensation, Transformation, Rückkopplung, Quellen und bevorzugten Formulierungen.",
    keyQuestions: ["Welche Begriffe sind maßgeblich?", "Wie werden Auslöser, Wirkungspotenzial, Wirkmechanismus und Wirkungsnachweis unterschieden?", "Wie ordnet die WÖk IOOI, Bewertung, Nichtkompensation und Rückkopplung ein?"],
    topics: ["Begriffe", "Glossar", "Sprachregelwerk", "Wirkungsresilienz", "Systemresilienz", "IOOI", "Wirkungsarchitektur"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["grundlagenpapier-wirkungsoekonomie", "leitbild-mensch-planet-demokratie"],
    version: "v1.4",
    date: "2026-08-14",
    editorialNote: "Aus der kumulativen Markdown-Quelle und versionierten Resilienz- sowie IOOI-Deltas als öffentliche Onlinefassung und PDF-Exportfassung veröffentlicht. Version 1.0 bis 1.3 bleiben als zitierfähige ältere Fassungen erhalten.",
    downloadAllowed: true,
    previewAllowed: true,
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.4.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.3?", "Wo ist die aktuelle Fassung v1.4?"],
    ...
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.4.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 431
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.4.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.2?", "Wo ist die aktuelle Fassung v1.4?"],
  ...
  },
  {
    ...
    whatToExpect: "Die frühere, zitierfähige Fassung der WÖk-Sprachreferenz. Für den aktuellen Begriffsstand gilt v1.3.",
    keyQuestions: ["Wie lautete der dokumentierte Begriffsstand v1.0?", "Wo ist die aktuelle Fassung v1.3?"],
    topics: ["Begriffe", "Glossar", "Archiv"],
    methods: ["Begriffliche Orientierung"],
    impactFields: ["Mensch", "Planet", "Demokratie"],
    relatedDocuments: ["woek-begriffsleitfaden-fuehrend"],
    ...
    date: "2026-05-21",
    replacedBy: "woek-begriffsleitfaden-fuehrend",
    editorialNote: "Archivierte Originalfassung. Nicht still überschrieben; für den aktuellen Begriffsstand siehe Version 1.3.",
    downloadAllowed: true,
    previewAllowed: true,
    section: "Archiv",
    order: 431
