...
const configuration = { schema_version: '1.0', version: '2026-09-10-bridge-2', processing_mode: 'dropbox_chatgpt_bridge',
  visual_generation_provider: 'chatgpt_bridge', schedule: { discovery: 'HH:05/20/35/50', processing: 'HH:00 Europe/Berlin', import: 'every 5 minutes' },
