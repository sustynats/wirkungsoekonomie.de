...
import { PROCESSOR_VERSION, PROCESSOR_CONTRACT, PROCESSOR_QUEUE_POLICY, PROCESSOR_SHARDS, PREFLIGHT_FOLDERS } from './processor.mjs';

const root = fileURLToPath(new URL('../../../', import.meta.url));
const config = { version: PROCESSOR_VERSION, queue_policy: PROCESSOR_QUEUE_POLICY, base_contract: 'contract-2026-09-10-bridge-3.json',
