...
export const EDITORIAL_REQUEST_CONTRACT={schema_version:'3.0',workflow:'single_final_approval',
  instructions:[
    ...
    preview:{type:'object',required:['format','title','markdown','sources','checks'],properties:{format:{enum:['news','opinion_analysis','book_review','listened','watched']},title:{type:'string',minLength:5,maxLength:250},subtitle:{type:'string',maxLength:1000},markdown:{type:'string',minLength:100,maxLength:100000},sources:{type:'array',minItems:1,maxItems:40,items:{type:'object',required:['url','title','publisher'],properties:{
    ...
    source_media:{type:['object','null'],required:['show','episode_title','original_release_date','original_url'],properties:{
