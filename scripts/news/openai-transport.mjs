...
export const SINGLE_CALL_INSTRUCTIONS = [
  ...
  'Reihenfolge: Erst alle Lesertext- und Gate-Felder (headline bis publication_gate, visuals, media_impact), dann als letztes Feld impact_assessment. Nach impact_assessment darf nichts fehlen, weil davor alles vollständig ist.',
