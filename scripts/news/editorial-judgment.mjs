...
export function editorialContentSnapshot(analysis) {
  const keys = ["title", "subtitle", "teaser", "seo_description", "analysis_variant", "editorial_genre", "lead_statement", "sections", "claim_ledger", "source_snapshot", "monitoring", "impact_assessment", "impact_history", "subject_dimensions", "direction_finding", "assessment_context", "assessment_condition", "author_perspective", "author_perspective_position", "executive_finding", "navigation_groups", "editorial_rules_version", "related_analysis_slugs", "title_image"];
...
export function sanitizeEditorialJudgment(raw, sourceIds) {
  return {
    ...
    author_perspective_position: 'last',
