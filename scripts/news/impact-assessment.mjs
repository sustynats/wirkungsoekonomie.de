...
export const IMPACT_DIMENSION_SCHEMA = {
  ...
  direction: DIRECTIONS.join('|'), magnitude: '0..5; null nur insufficient_basis', evidence: Object.keys(EVIDENCE).join('|'),
...
export const IMPACT_PROMPT_RULE = `Wirkungsticker2.1/all-dimensions-1: MPD sichtbar. Begründeter Pfad: modelled,magnitude0..5. Unzureichende Grundlage nach gezielter Recherche: insufficient_basis,open,null,not_assessable,missing,unknown,dominance=none,ex_ante,leere Pfadlisten,second_pass mit research_result/reviewed_source_ids. 0=begründet vernachlässigbar; nie fehlende Daten. Keine Pflichtpfade/Faktoren erfinden. Relevanz≠Tragweite≠Eintritt≠Evidenz. Unsicherer Eintritt≠offene Richtung. news_event/evaluation_target/baseline/counterfactual/reference_frame trennen. Politische Forderung: Maßnahme bewerten, Kommunikation nur bei Kommunikationsgegenstand. Dossier-Gegenstand erhalten. Pfade mit Empfängern,Mechanismus,Bedingung,Raum,Zeit,Ordnungen1–3,Quellenbindung/Quellenfunktion,Annahmen,Grenzen. supported_mechanism vs model_hypothesis; Hypothesen nur low/not_assessable. Geringe Evidenz/high_uncertainty: zweiter Recherchepass mit Ergebnis,magnitude_range. Keine erfundenen Quellen,Fakten,Prozente. research_sources: echte URL,Funktion,kurzer exakter Belegauszug; Ereignis≠Folgenbeleg. Wissenschaft/Recht/Statistik für Mechanismus,Referenz,Gegenevidenz gezielt ergänzen. Hauptpfade ex_ante/ongoing; ongoing braucht beobachtetes Signal. Belegte Zustandsänderungen separat in observed_effects mit eigenen Faktoren,Empfängern,Zeit und Attribution. Schaden≠Risiko; Beobachtung≠Ursachennachweis. Server leitet Ring aus Zeitstatus ab und bewahrt original/current_potential_assessment. R/I/D/U/V/S je0..5 mit Begründung: Summe/6; Grenzen0=>0,>0<1.5=>1,<2.5=>2,<3.5=>3,<4.5=>4,sonst5. Keine Faktoren aus Relevanz/Evidenz/Eintritt rückwärts erfinden. Konkret begründete schwere Schutzgrenze=>mindestens4; ex ante nur bei genau diesem bedingten Grenzpfad. Nichtkompensation/Reverse Merit Order, keine gemittelte MPD-Gesamtnote. Vergleichbare positive/negative Hauptpfade: höchste Stufe je Richtung, Differenz≤1=>mixed/balanced,≥2=>mixed/dominant. Negative Schutzgrenze begrenzt zuerst. Kleine Nebenrisiken,Schutzplanken,Restschaden,besserer Entwurf,politische Reaktion,fremder Nutzen sind kein Ausgleich. Politische Kooperation: Macht-/Mehrheits-/Amts-/Personal-/Budget-/Institutionenpfade und Normalisierung prüfen. Energie: EE-Ausbau/Hürden,Netze,Speicher,fossile Bindungen,Emissionen,Importabhängigkeit und gekoppelte Folgen für Gesundheit,Versorgung,Arbeit,Verteilung,Demokratie. Keine Ressort-/Parteienautomatik. system_check: MPD-Verbindungen,Ordnungen1–3,Enablement,Gegenevidenz,Quellenunabhängigkeit,Rechtsstatus. Programme sind keine Folgenbeweise; bedingt und quellengetreu formulieren.`;
