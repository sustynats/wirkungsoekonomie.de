...
export const MEDIA_PROMPT_RULES = [
  ...
  "Sachverhalt vor Frame; Attribution sichtbar. Wirkungspotenzial/-risiko ist keine eingetretene Wirkung.",
  "media_trigger ist nur Vorprüfung. Bei true und Publikation: media_impact als Pflichtobjekt, nie null/fehlend; vollständiges Schema oder {relevant:false,reason:Begründung}. Bei false meist null; evidenzgetrennter Befund darf ergänzen. Ablehnung bleibt knapp.",
  ...
  "Politisch symmetrisch prüfen: alle Lager, Regierung/Opposition, Wirtschaft, Verbände, NGOs, Gewerkschaften, Behörden, Medien. Keine Personen-/Parteien-/Outlet-Scores.",
  "Kommunikationswirkung von Ereigniswirkung/MPD trennen. Potenzial/Risiko bedingt ex ante; Reichweite, Likes, Wiederholung und Viralität sind kein Wirkungsnachweis.",
