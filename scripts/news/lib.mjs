...
export function buildAnalysisPrompt(stories) {
  ...
  const lines = [
    ...
    "material_development_review ist nur ein Prüfsignal. Neue Kandidatur-, Rücktritts-, Koalitions-, Regierungsbildungs- oder Ergebnisangaben mit dem bisherigen Stand vergleichen: materielle Aussage = material_update, anderes Medium allein = Dublette. Vor einem behaupteten Kurswechsel frühere Bedingungen und Originalzeitpunkte prüfen; neuere Klarstellungen können ältere offene Antworten überholen. Quellen chronologisch prüfen, spätere Nachträge einbeziehen. Videoüberschrift ist kein geprüfter Originalton. Zeitkritik erhöht Prüfpriorität, nie Evidenzgrad. Gleiche Regeln für alle Parteien/Medien; Landtagswahl und Regierungschefwahl trennen.",
