  ...
  return `<div class="news-story-visual" data-news-story-visual>
    <figure class="news-story-visual__frame">
      ...
      <div class="news-story-visual__content">
        ...
        <div class="news-story-visual__panel"><p class="news-story-visual__kicker">Relevanz &amp; Richtung</p>${renderDimensionMeters(story.analysis, { compact: true })}<p class="news-story-visual__legend">Einordnung dieser Entwicklung, keine Gesamtbewertung des Themenfelds.<br>Balken: Relevanz · Zeichen: Potenzial / Risiko, kein Wirkungsnachweis.</p><div class="news-story-visual__chips">${renderStatusChip(story.analysis.status)}${renderAnalysisTypeChip(story.analysis.analysis_type, { note: false })}</div></div>
      </div>
