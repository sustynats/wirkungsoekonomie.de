...
const contentFiles = ["src/content/docs", "blog", "journal", "podcast", "referenz", "bibliothek", "dokumente", "instrumente", "beispiele", "quellen", "export", "werkstatt", "werkzeuge", "anwendungen", "verstehen", "en"]
