...
function curatedIaEntries() {
  return [
    ...
    },
    {
      ...
      format: "Übersicht",
      impactSpaces: ["Mensch", "Planet", "Demokratie"],
      standards: ["SDG", "SDG+", "Agenda 2030", "IDGs"],
      instruments: ["WÖk-ID", "Scorecard", "Wirkungsbewertung", "Wirkungskompetenz"],
      tags: ["SDG", "SDGs", "SDG+", "Agenda 2030", "UN-Ziele", "Demokratie", "Medienqualität", "IDG", "IDGs", "Inner Development Goals", "Wirkungskompetenz"],
      aliases: ["Sustainable Development Goals", "Nachhaltigkeitsziele", "SDG Plus", "Inner Development Goals", "IDG", "IDGs"],
      body: "Der Referenzrahmen erklärt die offiziellen SDGs sowie SDG+ für Demokratie, Medienqualität, Rechtsstaatlichkeit, Diskursfähigkeit, institutionelles Vertrauen, Zusammenhalt und digitale Selbstbestimmung. Der Block zu IDGs und Wirkungskompetenz ordnet die Inner Development Goals als Kompetenzrahmen ein und erklärt Wirkungskompetenz als WÖk-spezifische Fähigkeit, Wirkung, Nebenwirkungen, Datenqualität, Unsicherheit, Systemzusammenhänge und Rückkopplung verantwortlich zu gestalten.",
      priority: 150,
    },
  ];
}
