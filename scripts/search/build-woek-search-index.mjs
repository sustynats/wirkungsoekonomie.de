...
const contentFiles = ["akademie", "lernen", "src/content/docs", "blog", "journal", "news", "wirkungsticker", "podcast", "referenz", "bibliothek", "dokumente", "instrumente", "beispiele", "quellen", "quellenarchiv", "export", "werkstatt", "werkzeuge", "methodik", "wirkungsfelder/gesundheit-pflege/dossiers", "anwendungen", "verstehen", "wirkungswissenschaften", "fragen", "faq", "en"]
