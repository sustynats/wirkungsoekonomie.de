...
const contentFiles = ["src/content/docs", "blog", "journal", "news", "podcast", "referenz", "bibliothek", "dokumente", "instrumente", "beispiele", "quellen", "quellenarchiv", "export", "werkstatt", "werkzeuge", "wirkungsfelder/gesundheit-pflege/dossiers", "anwendungen", "verstehen", "fragen", "faq", "en"]
