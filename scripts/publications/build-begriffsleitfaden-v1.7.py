...
def build_source() -> None:
    ...
    replacements = {
        ...
        "## 15.2 Verbindliche Migrationsmatrix": "## 15.2 Historische Migrationsmatrix aus Version 1.5 und v1.6\n\nDie folgende Matrix dokumentiert den damaligen v1.5-Migrationsauftrag. Sie ist kein offener v1.7-Release-Tracker. Für neue Inhalte gelten die Ergänzungen v1.6 und v1.7 sowie die aktuellen maschinenlesbaren Qualitätsgates.",
        "| P0 | Live-Fassung Begriffsleitfaden | Version 1.5 veröffentlichen, v1.4 als historische Fassung erhalten, aktuelle Downloads und Verweise umstellen. |": "| Erledigt v1.7 | Live-Fassung Begriffsleitfaden | Version 1.7 ist die führende Fassung; v1.6 und ältere Fassungen bleiben als historische, zitierfähige Entwicklungsstände erhalten. |",
    }
