...
test("eight visual anchors retain directions, evidence and working internal navigation", () => {
  ...
  for (const marker of ["news-feedback--closed", "news-feedback--broken", "Rückkopplung zum Anfang", "Rückkopplung unterbrochen", "news-systemic-visual--comparison", "news-mpd-balance", "Persönliche Einordnung der Autorin"]) assert.ok(html.includes(marker), marker);
