...
Vor dem Merge mit dem zwischenzeitlich fortgeschrittenen main `bf41b309d79fc81dad03028ec64287c462f66985` abgeglichen. Dessen Änderungen betreffen weder Parliament-App noch Parliament-Governance; der PR-Diff bleibt auf P1 begrenzt. 31/31 zusätzliche semantische Repository-Gates wurden lokal bestanden. Die nicht öffentliche, mit noindex gekennzeichnete UX-Vorlage liegt außerhalb des statischen Produktionsartefakts und löst nicht die branch-schreibende, unabhängige Hauptseiten-Projektion aus. Deren bereits auf main versionierte Auditmatrix wird durch P1 nicht ersetzt. Automatische Zwischenstände bleiben in den Merge-Eltern `62cb186db` und `b079b86c6` erhalten; insbesondere wird deren fachfremde Umfragen-Footer-Ergänzung nicht in den Parliament-PR übernommen.
