...
2. The intake trigger creates one focused evidence task.  It never fabricates a parliamentary phase, source passage or impact claim.
...
8. Recommendation candidates are blocked by boundary, evidence, mechanism, implementation, distribution and feedback gates.  Human red team and publication approval are separate steps.
