...
The production loop is editorial data work, not a development-agent loop. Rules, schemas, integrations, UI or security change only through a `method_change_request` or a normal software change.
