...
- Sechs zugehörige Methodenseiten nutzen dieselben Kennzahlenbausteine und verlinken den vollständigen Kontext.
- Rechner: zwei Mengeneingaben zum Einstieg, dann Vergleich und Jahresplanung. Die optionale Fachrechnung bleibt als Vertiefung erhalten; geänderte Mengen werden nicht ohne neue Begründung in Euro oder Profilpunkte übersetzt.
- Sieben bislang fehlende FAQ-Antworten ergänzt. Ziel-IDs sind inhaltlich befüllt, keine leeren Sprungmarken.
- Automatische Glossarverlinkung in selbsterklärenden Lernflächen deaktiviert; persönliche Merken-/Notizfunktionen dort ans Ende verschoben. Global öffnen Hash-Direktlinks ihre übergeordneten Details-Elemente.

## Publikationen und Nachvollziehbarkeit

Zwei neue, datierte PDFs entstehen aus denselben Inhaltsdaten wie die Seiten: ein zweiseitiger Einstieg und ein vollständiger Lernweg mit 21 Seiten. Die vorherige Impact-Erklärung bleibt archiviert. Die acht älteren Lesefassungen und das zusätzliche Fachpapier-Erratum werden nicht überschrieben. Der neue Publikationswächter dokumentiert die explizite Ablösung der geänderten lebenden Generatorquelle; alle übrigen historischen Quellenbindungen bleiben geprüft.

Primärquellen: UN SDG 12.3, World Bank zur Differenz-von-Differenzen und den Grenzen von Trendtests, Bundesregierung zur DNS 2025. WÖk-Rechenreferenz: T-SROI v1.1. Die Quellen liefern keine empirischen Werte für die Modellküche.
...
Lokaler Abschluss: Build inklusive Postbuild erfolgreich nach den dokumentierten Integrationskorrekturen; 31 semantische Staatsarchitektur-Gates und 6 Wirkungswissenschaften-Prüfungen bestanden. Artefaktprüfung: 0 fehlende Dateiziele, Datenschutz-Gate für 16.813 Textdateien bestanden, 784,0 MB unter dem Limit. Der erneute Seitenaudit erfasst 16.416 HTML-Seiten. Die sieben ergänzten FAQ-Ziele sind behoben; 245 redaktionell zu prüfende Fragmentverweise, 214 absichtliche JavaScript-Filter und 32 alte Glossar-Dispatch-Verweise bleiben getrennt dokumentiert. Diese verbleibenden Verweise werden nicht durch erfundene Zielabschnitte kaschiert.

Veröffentlichung erfolgt über das bestehende GitHub-Pages-Verfahren. PDF-Release: `woek-lernweg-2026-09-06`, gebunden an `6c0114dcab4ef6a4151345b9eea5da939f859349`. Die endgültige Produktions- und Live-Verifikation wird mit dem Abschlussbericht unter `outputs/learning-review-2026-09-06` dokumentiert; GitHub Actions enthält die unabhängigen Release-Protokolle.
