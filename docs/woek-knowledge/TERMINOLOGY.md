...
| **Nichtkompensationsprinzip** | „Gute Werte in einem Bereich dürfen schwere Schäden in einem anderen Bereich nicht verdecken." | Präzisiert in `docs/gesetze/WUStG_Technische_Leitlinien_v2.1_Entwurf.md` §2.13. |
| **Reverse Merit Order (RMO)** | „Das schwächste zentrale Wirkungsfeld begrenzt die Gesamtbewertung." Formal: `FinalScore = min(Kernfeldscores)`. | Kernfelder (Produkt-Detailkonzept): Klima · Ressourcen & Kreislauf · Arbeit & Fairness · Gesundheit & Sicherheit. Formel u.a. `content/studienskripte/woek-g-v34.md`, WUStG-Leitlinien §2.12. |
...
- Wirkung, Wirkungspotenzial, Wirkungsrisiko, Netto-Wirkung, Transformationswirkung, Wirkungslenkung, Wirkungsarchitektur **nicht vermischen**.
- „Wirkstoff" nur als Analogie. Reichweite ≠ Wirkung. Reporting ≠ Rückkopplung.
