# Wirkungsticker · Projektauftrag und Leistungsbeschreibung
...
## Ausgangsfrage
Wie können Menschen aktuelle Nachrichten auf ihre mögliche Bedeutung für Mensch, Planet und Demokratie prüfen, ohne Quelleninhalt, Vermutung und Bewertung zu verwechseln? Das Projekt ist ein internes Eigenvorhaben des Wirkungsinstituts. Natalie Weber trägt die fachliche und redaktionelle Verantwortung; es wird kein bezahlter externer Auftrag behauptet.

## Leistungsumfang
Eine überschaubare Auswahl quellengebundener Wirkungsnachrichten, stabile und fortschreibbare Akten, klar getrennte Zusammenfassung und Analyse, Quellenlinks, Versions- und Korrekturhinweise sowie eine nutzbare mobile Ausgabe. Installation und Benachrichtigungen bleiben freiwillig. Die fachliche Arbeit umfasst Quellenpflege, Auswahlregeln, Prüfmaßstäbe und verständliche Darstellung.
