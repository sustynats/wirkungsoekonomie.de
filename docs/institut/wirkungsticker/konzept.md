# Wirkungsticker · Redaktionskonzept und Lernschleife
...
## Arbeitskette
Quellenregister → Import → Normalisierung und Dublettenprüfung → Relevanz/Materialität → quellengebundene Analyse → Qualitätsgate → Veröffentlichung → Beobachtung und Korrektur. Bei neuer materieller Entwicklung wird eine bestehende Akte fortgeschrieben. Technisches Scheitern einer Analyse ist keine fachliche Ablehnung.

## Inhaltliche Schichten
Die Quellenzusammenfassung beschreibt den gesicherten Ausgangspunkt. Der Faktencheck trennt bestätigte Aussagen, Behauptungen und offene Punkte. Der Folgencheck erläutert Mechanismen, mögliche Folgen erster bis dritter Ordnung, Betroffene, Gegenläufe und Unsicherheiten. Medien- und Sprachwirkung betrachtet eine konkrete kommunikative Handlung mit Wirkungspotenzial, Resonanzraum und Wirkpfad.
