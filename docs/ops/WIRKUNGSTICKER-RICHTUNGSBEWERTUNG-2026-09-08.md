...
### Bestätigung im regulären Produktionslauf

Korrekturcommit `a8767e3548`; erster regulärer Lauf damit: `34252031186`, Nachrichtenprüfung 16:37:16 bis 16:39:37 UTC. Der Transportzähler bestätigt den zuvor nur vermuteten Referenzfall: 15 tatsächlich mitgelieferte Belegkennungen in sechs Pfaden wurden auf die zugehörige Quelle aufgelöst, null unbekannte Verweise. In dieser Antwort trat kein Richtungs-/Pfadfehler mehr auf. Die Mechanismen und Richtungsurteile wurden nicht umgeschrieben.

Der Lauf enthält zwei kostenpflichtige Nachrichtenprüfungen und noch keine Erstveröffentlichung: eine redaktionelle Dublettenentscheidung und eine Antwort mit `CLAIM_NUMBER_NOT_IN_EVIDENCE`. Dort fehlte das Jahr in den unmittelbar zitierten Textstellen. Es wird nicht automatisch aus der Überschrift an jede Zahl angehängt; ein möglicher Zeitbezug muss korrekt belegt bleiben. Deshalb keine erzwungene Veröffentlichung und keine allgemeine Stabilitätsentwarnung. Die verbleibende Queue und die regulären Wiederholungen bleiben bestehen; Rückstellungen auf Kapazität sind kein Nachweis erledigter Qualitätsprüfungen.

Kostenstand bis 18:45 Uhr Berlin am 08.09.2026 (inklusive Ablehnungen und Wiederholungen, Reparatur-/Aufholbetrieb, keine Routine-Stichprobe): unmittelbare Nachrichten 2,923674 USD bzw. geschätzt 2,993609 EUR mit 19 Prozent Steuerreserve, 36 Erstveröffentlichungen und acht Updates. Das sind rund 8,32 Cent je Erstveröffentlichung bzw. 6,80 Cent je Erstveröffentlichung oder Update. Separat: Autorenanalysen 4,223931 USD mit konservativen Schätzungen, Hintergrund-Batch 0,118206 USD abgerechnet und keine offenen Reservierungen. Gespeicherter ECB-Kurs vom 07.09.2026: 1 EUR = 1,1622 USD. Keine Rechnung und kein Nachweis eines dauerhaften Viercentniveaus. Die halbstündliche Stabilisierungskontrolle bleibt aktiv.
