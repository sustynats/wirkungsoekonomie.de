const CACHE='woek-redaktion-shell-v8';
const SHELL=['./','./redaktion.css','./redaktion.js','./review-state.js','./betrieb-view.js','./parked-review.js','./feedback-limits.js','./manifest.webmanifest'];
