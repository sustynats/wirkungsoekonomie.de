...
const ToolExplanationLayer = (() => {
  ...
  const tools = {
    ...
    scanner: {
      ...
      purpose: "Der Scanner hilft, Texte, Produkte, Unternehmen oder Maßnahmen als Wirkungsfrage zu lesen. Er ersetzt keinen journalistischen Faktencheck, sondern ergänzt ihn um einen Folgencheck.",
      question: "Welche Wirkungspotenziale, Risiken, blinden Flecken, Datenlücken und Gegenfragen werden sichtbar?",
      ...
      difference: "Die Wirkungsökonomie trennt Faktencheck und Folgencheck. Faktencheck fragt: Stimmt das? Folgencheck fragt: Was kann das auslösen? Der Scanner zeigt deshalb Hinweise und Gegenfragen, keine Wahrheitseinstufung und kein Personen-Scoring.",
      ...
      links: [
        ["Folgencheck", "/begriffe/folgencheck/"],
