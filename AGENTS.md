...
- Fuer das zentrale MPD-Bewertungs- und Darstellungsmodell gilt docs/news/IMPACT-SEMANTICS-2.md. docs/news/WIRKUNGSPOTENZIAL-DARSTELLUNG.md dokumentiert nur den abgeloesten Stand 1.2. Konkrete moegliche Zustandsaenderung und Bedingung auch in der Uebersicht zeigen. Massnahmenfolge, erklaerte Absicht, Verfahrensschritt, Risikobegrenzung und politische Reaktion getrennt fuehren; keine gemittelte Richtungsampel. Historische Mischurteile ohne gepruefte Pfadrollen sind keine belastbare Gesamtbewertung, nicht automatisch positiv oder negativ umzuschreiben.
...
- Die MPD-Uebersicht zeigt ausschliesslich die Tragweite des jeweiligen Wirkpfads als Balken (0 bis 5; unbekannt bleibt null), analytische Richtung und Zeitstatus getrennt. Systemische Relevanz steht separat auf Meldungsebene. Offen, neutral und nicht materiell sind verschiedene Befunde. Nachrichtenanlass und Wirkungsgegenstand sind getrennt; politische Forderungen werden zuerst als vorgeschlagene Massnahme betrachtet. Die zentrale Daten- und Darstellungslogik steht in scripts/news/impact-assessment.mjs. Die Darstellung ist, sichtbar durch Text, Icon und kontrastreiche Kennzeichnung, nicht nur durch Farbe. Positive Potenziale und negative Risiken nicht als eingetretene Wirkung ausgeben. Fehlende Bewertung, fehlender belastbarer Wirkpfad und unklare Wirkungsrichtung sind unterschiedliche Zustaende. Gegenlaeufige Pfade bedeuten keine ausgeglichene Bilanz; neue gemischte Befunde brauchen jeweils einen konkreten positiven und negativen Mechanismus mit Quellenbezug. Eine Rechtsgrenze ist kein positiver Gegenpfad. Listen- und Detailseiten verwenden denselben Befund. Keine zusaetzliche KI-Neuanalyse oder Bildgenerierung allein fuer diese Darstellung.
