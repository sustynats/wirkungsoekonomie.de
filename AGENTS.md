...
- Grundsaetzlich in allen Ticker-Artikeln und Analysen: Jeder dargestellte Wirkpfad zeigt Richtung, Bedingung und Evidenzstatus; reine Wirkungsfeld-, Zustaendigkeits- oder Bezugsuebersichten als solche benennen. Keine Richtung aus Thema, SDG-Zuordnung oder Relevanzbalken ableiten. Fehlende Richtungseinschaetzung ist offen, nicht neutral. Historischen Pfaden keine Richtung erfinden; bei redaktioneller Neupruefung versioniert ergaenzen.
- Die MPD-Uebersicht zeigt Relevanzbalken und analytische Richtung getrennt, sichtbar durch Text, Icon und kontrastreiche Kennzeichnung, nicht nur durch Farbe. Positive Potenziale und negative Risiken nicht als eingetretene Wirkung ausgeben. Vorhandene Tendenzbefunde auf Listen- und Detailseiten konsistent wiederverwenden; fehlende Befunde offen lassen. Bei neuen Nachrichten die kurze Tendenz direkt je Basisdimension fuehren, auch ohne optionale Diagramme. Keine zusaetzliche KI-Neuanalyse oder Bildgenerierung allein fuer diese Darstellung.
