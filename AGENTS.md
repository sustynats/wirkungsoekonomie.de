...
- Potenzialpruefung: Fehlender Umsetzungsbeschluss, unbekannter Eintritt oder fehlende gemessene Folgen sind allein kein Grund fuer eine leere Tragweite. Den berichteten Sachverhalt bzw. das Risiko bewerten, nicht automatisch die Meldung oder Warnung. Mechanismusrecherche ist nicht auf Nachrichtenfeed-Domains begrenzt; bestehende Rechte-/Quellenpruefung bleibt verbindlich. Zugangsfehler bleiben Recherchebedarf, nicht abgeschlossener fachlicher Befund. Balken zeigen die begruendete numerische Tragweite, der Ring nur das Stadium Potenzial/laufend/beobachtet. Eine offene Richtung beseitigt weder Pfad noch Tragweite. Historische Null-Datensaetze sind nachzupruefen und duerfen nicht als vollstaendig bewerteter Bestand gezaehlt oder neu freigegeben werden. Dauer und Unumkehrbarkeit beziehen sich auf denselben Zustand der Empfaenger, nicht auf unterschiedliche Betriebs-, Massnahmen- oder Nachwirkungszeiträume. Unbekannt ist keine niedrige Faktorenstufe.
