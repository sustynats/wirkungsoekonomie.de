...
- Produktinvariante Wirkungsticker (Präzisierung 14.09.2026, ersetzt die numerische Vollständigkeitspflicht): Mensch, Planet und Demokratie bleiben sichtbar. Modellierte Pfade brauchen belegte Ausgangspunkte, Bedingungen, Empfänger, Referenzraum, Zeitraum und begründete Tragweite. Nach gezielter Recherche darf eine Dimension ausdrücklich offen / nicht ausreichend bewertbar bleiben (insufficient_basis, magnitude=null). Fehlende Daten sind weder Stufe 0 noch neutral. Keine Pfade oder Faktoren zum Füllen von Pflichtfeldern erfinden. Richtung, Tragweite, Eintritt, Evidenz, Systemrelevanz und Attribution bleiben getrennt. Ein bekannter Pfad mit offener Richtung kann eine begründete Tragweite haben. Diese fachliche Präzisierung setzt die frühere Pflicht zu drei numerischen Pfaden außer Kraft.
