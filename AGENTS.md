...
- Visual-Pruefung fuer jede Analyse verbindlich mitdenken: eine erklaerende Grafik ist der Regelfall, nicht ein nachtraeglicher Schmuck. Bestehende Pfeilketten werden im gemeinsamen Markdown-Renderer als Ablaufgrafik dargestellt; historische Tabellen-/Auszugsdarstellungen sind an den Manuskript-Hash gebunden. Konkreter Ablauf, Gegenueberstellung oder Systemzusammenhang statt MPD-Profil als Ersatz. Keine Grafik erzwingen, wenn sie keinen Erkenntnisgewinn bringt; den Verzicht im internen Review begruenden. Bestand und letzte 30 Ausgaben mit `node scripts/news/audit-editorial-visuals.mjs --check-latest` pruefen. Details: docs/news/ERKLAERENDE-VISUALISIERUNGEN.md.

- Erklaerende Visualisierungen gelten fuer alle Beitragsarten: regulaere Nachrichten, Meinung & Analyse, Buch & Wirkung, Nachgehoert und Nachgesehen. Wo eine Grafik das Verstaendnis verbessert, vorhandene Diagramm-/Visualisierungsbausteine fuer Wirkpfade, Zeitverlaeufe, Vergleiche oder Zielkonflikte verwenden. Das MPD-Profil ersetzt eine solche inhaltliche Erklaerung nicht. Keine Dekorationsdiagramme, erfundenen Messwerte oder scheinbar beobachteten Kausalitaeten; Daten, Modellannahmen, Bedingungen und Unsicherheit nachvollziehbar kennzeichnen. Persoenliche Beitraege bleiben an die bestehende Freigabe gebunden.
- Natalies persoenliche Einordnung steht grundsaetzlich am Ende des redaktionellen Haupttexts, nach Kontext, Originalargument und fachlicher Erschliessung. Das gilt auch fuer Buch & Wirkung, Nachgehoert und Nachgesehen; Quellen und formale Metadaten duerfen anschliessend folgen. Bestehende freigegebene Manuskripte werden deshalb nicht still umgeschrieben; Aenderungen gehen als versionierte Vorschau erneut zur Freigabe.
...
- Produktinvariante Wirkungsticker (erneute direkte Nutzerentscheidung 14.09.2026, ersetzt die frühere heutige Null-Ausnahme für neue Veröffentlichungen): Jede regulär neu veröffentlichte oder neu freigegebene Nachricht zeigt für Mensch, Planet und Demokratie begründete modellierte Pfade und numerische Tragweite 0 bis 5. Fehlende Messdaten, fehlende Umsetzung oder unsicherer Eintritt sind nicht fehlendes Wirkungspotenzial. Quellengebundene bedingte Modellhypothesen mit Empfängern, Referenzraum, Zeitraum, begründeten Faktoren und Bandbreiten sind zulässig; Evidenz und Eintritt bleiben getrennt. Keine Pfade oder Faktoren erfinden. Wenn eine Dimension trotz Recherche nicht vertretbar modelliert werden kann, bleibt der neue Beitrag vor Veröffentlichung im Recherche-/Prüfstatus. Historische insufficient_basis/null-Daten, Originalprofile und bezahlte Journale bleiben unverändert lesbar; keine automatische Rückwärtsbefüllung, Umpolung oder neue kostenpflichtige Bestandsanalyse.
...
- Potenzialpruefung: Fehlender Umsetzungsbeschluss, unbekannter Eintritt oder fehlende gemessene Folgen sind allein kein Grund fuer eine leere Tragweite. Den berichteten Sachverhalt bzw. das Risiko bewerten, nicht automatisch die Meldung oder Warnung. Mechanismusrecherche ist nicht auf Nachrichtenfeed-Domains begrenzt; bestehende Rechte-/Quellenpruefung bleibt verbindlich. Zugangsfehler bleiben Recherchebedarf, nicht abgeschlossener fachlicher Befund. Balkenskala, Ring und Richtung bleiben auch bei einer begruendet offenen Tragweite sichtbar; gestrichelte Skala ist keine Nullbewertung.
