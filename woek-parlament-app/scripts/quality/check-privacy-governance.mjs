...
for (const [key, expected] of Object.entries({ advertising_networks: false, google_analytics: false, mailchimp: false, email_open_tracking: false, email_click_tracking: false, parliament_client_analytics: true })) {
  if (register.tracking?.[key] !== expected) fail(`tracking policy ${key} must be explicitly ${expected}.`);
}
for (const requiredText of ["Wirkungsradar", "Double Opt-in", "Vercel", "Supabase", "IONOS", "Google Analytics", "Mailchimp", "90 Tagen", "Do Not Track"]) {
