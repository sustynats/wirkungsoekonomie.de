...
const report = { base_commit: base, phase: "P4", policy: "No published paragraph removed; navigation labels may be regrouped. Canonical data untouched.", total_text_objects: records.length, missing: missing.length, records };
