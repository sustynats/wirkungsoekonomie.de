...
- Mechanism: citywide coordination can reduce search/information friction and improve matching between pregnant/postpartum people and available midwives.
- Competence: `LAND_DISTRICT_COORDINATION_WITH_MIDWIFE_PROVIDER_AND_INSURANCE_DEPENDENCIES`.
- Boundary: better matching does not create additional midwife capacity by itself.
- Risks/omissions: real-time availability, matching criteria, language/accessibility, digital/non-digital fallback, provider participation, duplication with existing services.
...
- Why assessable: an incentive lever is identifiable even though amount/form is not specified; missing design belongs in Delivery/Resource gaps rather than automatic RNAA.
- Mechanism: financial/non-financial incentives can change participation, workload acceptance, location or retention, potentially increasing effective availability.
- Risks/trade-offs: windfall/selection effects, provider redistribution without net capacity, administrative burden, short-lived participation, inequitable geographic targeting.
...
- Mechanism: removing redundant documentation/process requirements can release staff time and reduce administrative burden.
- Noncompensation hard guard: relief must not remove requirements necessary for medication safety, safeguarding, infection control, rights, quality assurance, billing integrity or incident traceability.
- Competence: `MIXED_FEDERAL_LAND_INSURANCE_PROVIDER_REGULATORY_AND_DOCUMENTATION_RULES`.
...
- Mechanism: adequate staffed time and operating resources can reduce rushed/omitted care and increase continuity, responsiveness and safe delivery.
- Competence: `MIXED_PROVIDER_GKV_PFLEGEVERSICHERUNG_LAND_AND_WORKFORCE_DEPENDENCIES`.
- Risks: nominal funding without available workforce, poor skill mix, resource capture without bedside time, workload redistribution.
...
- Mechanism: qualified mobile assistants can extend practice reach into homes, perform delegated/support tasks and reduce avoidable travel/access barriers for frail or immobile people.
- Competence: `MIXED_AMBULATORY_SELF_GOVERNANCE_PROVIDER_AND_LAND_COORDINATION_WITH_PROFESSIONAL_SCOPE_RULES`.
...
- Mechanism: geriatric expertise can improve multidimensional assessment, medication/function/cognition coordination and care planning for frail older people.
- Risks: shortage of geriatric staff, parallel teams without integration, referral bottlenecks, urban concentration.
...
- Mechanism: additional clinically appropriate home nursing can close care gaps after/between medical contacts and support safe treatment at home.
- Competence: `PRIMARILY_GKV_PROVIDER_FRAMEWORK_WITH_LAND_LOCAL_CAPACITY_AND_COORDINATION_DEPENDENCIES`.
...
- Mechanism: accessible psychosocial support can address distress, isolation, adjustment and navigation burdens alongside physical care.
...
- Mechanism: dementia-sensitive environments/processes and trained staff can reduce disorientation, avoidable distress and unsafe care transitions.
- Competence: `HOSPITAL_PROVIDER_AND_LAND_PLANNING_FUNDING_WITH_WORKFORCE_DELIVERY`.
...
- Mechanism: removing physical, sensory, communication and digital barriers can enable safer, more independent and timely access to hospital services.
- Competence: `LAND_PROVIDER_BUILDING_SERVICE_AND_DIGITAL_ACCESSIBILITY_GOVERNANCE`.
...
- Mechanism: early discharge planning, medication/information transfer and confirmed follow-up can reduce handoff failures and unsafe gaps after hospitalisation.
- Competence: `MIXED_HOSPITAL_GKV_PROVIDER_AND_POST_ACUTE_CARE_FRAMEWORK_WITH_LAND_OVERSIGHT`.
...
- Mechanism: better GP palliative-care competence can improve earlier recognition, symptom management, goals-of-care conversations and appropriate escalation/referral.
...
- Mechanism: adequate financing can support time-intensive palliative work, coordination and availability that otherwise may be underprovided.
- Competence: `PRIMARILY_GKV_PAYMENT_AND_PROVIDER_DELIVERY_WITH_LAND_ADVOCACY_COORDINATION_DEPENDENCIES`.
- Risks: payment without additional service capacity, coding/activity incentives, unequal provider participation, workforce bottlenecks.
- Boundary: higher reimbursement is input; benefit requires additional appropriate care and patient-centred outcomes.
- Reality check: participating capacity/time, access/waiting, service intensity when clinically appropriate, symptom/crisis outcomes, caregiver burden, equity and cost per additional service capacity.

## P23 terminal result

All 13 deterministic P23 children are now explicitly source-bound Fach-terminal.

`BE_BSW_P23_CHILD_FACH_COMPLETE = PASS_13_OF_13_SOURCE_BOUND`

Together with #240 comment `5452692674`, this permits:
`BE_BSW_P23_FACH_COMPLETE = PASS_SOURCE_BOUND`
...
On fresh exact-current-main, materialise these 13 exact child decisions losslessly against the child IDs/spans from merged #321. Preserve all six compound parents as versioned non-counting parents. Do not alter the already terminal clean P23 records. Then consume the newer explicit P24 Fach handoff already present in #240 (`5452737343`) idempotently, producing its requested deterministic child/continuation objects without synthesising child Fach. Recompute residuals SET-WISE and run all GitHub-first gates. No Vercel Preview/build/deploy/promotion.
