...
### Current-system / source-claim guards

1. **Berlin is not at a zero baseline for sustainable construction.** Berlin already operates explicit sustainable-construction governance and procurement practice; the 2025 ABau revision integrates climate protection and sustainability into Land construction procedures, and Berlin's sustainable-building Fachdialog addresses circular and timber construction. Current references: https://www.berlin.de/rbmskzl/aktuelles/pressemitteilungen/2025/pressemitteilung.1598321.php and https://www.berlin.de/nachhaltige-beschaffung/umweltanforderungen/spezifische-beschaffungshinweise/nachhaltiges-bauen/fachdialoge/ . Holz-/Modulbau is also already being delivered in Berlin school construction, e.g. the 2026 HoMEB project at Schätzelberg-Grundschule: https://mein.berlin.de/vorhaben/2026-01428/ . P57 must therefore be assessed as additional funding/design/research/scale delta, not invention from zero.
2. **The source's `fast 40 % der CO₂-Emissionen` construction claim is boundary-dependent.** UBA material shows roughly 40% for the broad building system when indirect/lifecycle emissions are included, whereas direct building-sector emissions are far lower; the construction/building system is also highly resource- and waste-intensive. References: https://www.umweltbundesamt.de/sites/default/files/medien/376/dokumente/bundespreis_umwelt_und_bauen_preistraegerbuch_2021_online_barrierefrei.pdf , https://www.umweltbundesamt.de/themen/klima-energie/energiesparen/energiesparende-gebaeude and https://www.umweltbundesamt.de/daten/ressourcen-abfall/verwertung-entsorgung-ausgewaehlter-abfallarten/bauabfaelle . Do not render the programme sentence as a boundary-free direct-emissions fact.
3. **`ökologisch`, `biobasiert`, `regional` and `modular` are not automatic positive-impact labels.** Fach approval below requires lifecycle GHG/resource/land/biodiversity/durability/reuse/fire/health/performance evidence, additionality and affordability/delivery measurement. Biogenic feedstocks can create land-use/biodiversity/import effects; modularity can improve standardisation/waste but can also lock in designs or shift impacts upstream.
4. **Berlin already has a real Umweltbildungs baseline.** On 25.08.2026 the Senate described the Britz Umweltbildungszentrum as one of seven Land-funded environmental-education institutions; district coordination offices and the Natur-/Umwelt-/Klima-/Nachhaltigkeitsbildungs network already exist. References: https://www.berlin.de/rbmskzl/aktuelles/pressemitteilungen/2026/pressemitteilung.1706692.php and https://www.berlin.de/ba-treptow-koepenick/politik-und-verwaltung/aemter/umwelt-und-naturschutzamt/naturschutz/artikel.1282072.php . P57 funding/network proposals therefore mean continuation, stabilisation or expansion, not creation from zero.
...
- `evidence_level = MEDIUM_FOR_FUNDING_TO_ADOPTION_AND_MODULAR_DELIVERY_MECHANISM / NET_LIFECYCLE_AND_HOUSING_OUTCOME_PENDING`
- Problem/goal: construction creates material, embodied-carbon, cost and delivery pressures; a targeted Land programme can alter technology/design adoption in segments where Berlin has funding/ownership/procurement leverage.
- `A→M→ΔZ`: programme criteria + finance for qualifying modular systems → lower adoption/financing risk and potentially more repeatable prefabrication/reuse-compatible delivery → possible reductions in construction time, waste and lifecycle emissions while increasing housing delivery capacity.
- Existing-system guard: Berlin already uses modular/wood construction and sustainability requirements; only the **additional** programme criteria/capacity are attributable.
- Material omissions: programme budget, eligibility, lifecycle thresholds, QNG/whole-life method, reuse/disassembly, durability, fire/acoustic/indoor-air performance, local planning/site constraints, embodied vs operating emissions, rent/total-cost guard and additionality to federal/other Land funding.
- Distribution: social/municipal tenants, Land housing companies/cooperatives/providers, construction workforce/SMEs, neighbourhood/site impacts and future operating-cost bearers.
...
- `evidence_level = MEDIUM_FOR_R_AND_D_KNOWLEDGE_MECHANISM / COMMERCIAL_AND_ENVIRONMENTAL_OUTCOME_PENDING`
- Mechanism: targeted research can improve material performance, testing, certification, circularity and substitution options, reducing technical/knowledge barriers to lower-impact materials.
- Competence: `LAND_BERLIN_RESEARCH_INNOVATION_AND_PUBLIC_CONSTRUCTION_LEVERS_WITH_FEDERAL_EU_STANDARDS_AND_MARKET_DEPENDENCIES`.
- Omissions/risks: exact funding route, TRL/application target, feedstock source, land/biodiversity competition, chemicals/additives, durability/fire/moisture, recyclability, end-of-life, certification, scale economics, import leakage and crowd-out of other high-value research.
...
- `evidence_level = MEDIUM_FOR_FUNDING_TO_CAPACITY_AND_ACCESS_MECHANISM / BEHAVIOUR_AND_ENVIRONMENTAL_OUTCOME_PENDING`
- Existing-system guard: Berlin already funds institutions/network capacity. Assess only continuation stability, incremental capacity, access and quality versus current baseline.
- `A→M→ΔZ`: stable/additional support for labs/gardens/centres/learning sites → more durable staff/programme/place capacity and lower access barriers → more/diverse learning experiences and potentially improved knowledge/agency.
- Omissions: budget/additionality, provider selection, geographic coverage, staffing, accessibility/inclusion, curriculum link, learning goals/evaluation and opportunity cost.
- Distribution: children/youth/adults, districts, low-access groups, disability/language, formal vs non-formal learners/providers.
...
#### Mandatory deterministic repair: `BE-BSW-P57-U09-A05-5d5da2733c91`

Frozen atom incorrectly fuses two sentences because punctuation/whitespace was lost:
`Berlin soll Umweltbildung als öffentliche Aufgabe begreifen und dauerhaft verankern.Wir fordern: Planungssichere Förderung für Projekte, Institutionen und Multiplikatoren, die kontinuierlich Umweltbildung leisten.`

Preserve the original A05 ID/text/hash as a versioned **zero-count parent** and create exactly two deterministic semantic children using the established child-ID convention:

**Child 1 exact text:** `Berlin soll Umweltbildung als öffentliche Aufgabe begreifen und dauerhaft verankern.`
- `terminal_fach_state = REVIEWED_NOT_ASSESSABLE_WITH_EXACT_REASON`
- Exact reason: a durable public-task/institutionalisation target is identifiable, but the source specifies no legal status, responsible authority, statutory/administrative vehicle, budget obligation, service standard or measurable additional coverage beyond Berlin's existing Umweltbildungs infrastructure. Preserve as governance target; do not infer a new effect.

**Child 2 exact text:** `Wir fordern: Planungssichere Förderung für Projekte, Institutionen und Multiplikatoren, die kontinuierlich Umweltbildung leisten.`
- `terminal_fach_state = EXPLICIT_FACH_APPROVED`
- `impact_direction = POSITIVE_CONTINUITY_AND_PROVIDER_CAPACITY_POTENTIAL / FUNDING_ADDITIONALITY_AND_QUALITY_DEPENDENT`
- `evidence_level = HIGH_FOR_FUNDING_STABILITY_TO_PROVIDER_CONTINUITY_MECHANISM / EDUCATIONAL_AND_BEHAVIOURAL_OUTCOME_PENDING`
- Mechanism: more predictable multi-period finance can reduce stop-start/projectification risk, retain skilled staff and improve planning/continuity of provision.
- Existing-system guard: current Land/district funding exists; measure is stability/coverage/design delta, not a zero-to-one creation.
...
- `evidence_level = MEDIUM_FOR_CURRICULUM_EXPOSURE_AND_KNOWLEDGE_MECHANISM / LONG_TERM_BEHAVIOUR_AND_ENVIRONMENTAL_OUTCOME_PENDING`
- Current-baseline guard: sustainability/global-learning themes already exist in Berlin curricula/materials. Interpret `Rückkehr` only as source wording; assess the actual proposed delta as more explicit/regular embedding beginning grade 1.
- Competence: `LAND_BERLIN_CURRICULUM_SCHOOL_GOVERNANCE_WITH_LISUM_BERLIN_BRANDENBURG_COORDINATION` as applicable.
- Omissions: exact subject/cross-curricular design, hours/competencies, teacher preparation/materials, crowd-out, assessment, age-appropriate pedagogy and distinction between knowledge, values and behaviour.
...
- `evidence_level = MEDIUM_FOR_NETWORK_COORDINATION_MECHANISM / LEARNER_AND_ENVIRONMENTAL_OUTCOME_PENDING`
- Existing-system guard: a Berlin network already exists. Credit only additional coordination quality, coverage, shared standards/resources or reduced duplication.
...
- `evidence_level = MEDIUM_FOR_INFORMATION_ACCESS_MECHANISM / LEARNING_AND_BEHAVIOURAL_OUTCOME_PENDING`
- Mechanism: freely available digital tools can lower information/identification barriers and complement place-based learning.
- Omissions/risks: existing-tool baseline/additionality, editorial/scientific quality, accessibility, privacy/data minimisation, device/digital divide, maintenance/vendor lock-in, species/location data sensitivity and real pedagogical integration.
- Boundary: downloads/users/features do not prove learning, behaviour or biodiversity outcome; digital offer must complement rather than displace accessible physical/experiential provision where material.
- Reality check: active/return use, accessibility, validated identification accuracy, learning gains, reach across groups and maintenance/privacy performance.

### F. P57 terminality

After the P56→P57 pre-consumption and the U09-A05 deterministic two-child repair:
- `P57-U01 = VERSIONED_ZERO_COUNT / CONSUMED_BY_P56_CROSS_PAGE_REPAIR`;
- structural/context units U02/U05/U06/U08 = reviewed zero-count;
- original frozen A05 = versioned zero-count parent;
- deterministic children required under U09-A05 = `2`;
- explicit Fach original atoms = `U04-A01`, `U04-A02`, `U09-A03`, `U09-A06`, `U09-A07`, `U09-A08`;
- explicit Fach deterministic child = `U09-A05 child 2`;
- exact RNAA original = `U04-A03`;
- exact RNAA deterministic child = `U09-A05 child 1`;
- all remaining U03/U07/U09 rationale/goal/guard atoms = explicit reviewed non-effect classifications above.
...
Current exact GitHub main verified in this controller pass: `2f5d5d896eb1a8e851529a31139bfa57b00eca84` (merged PR #324, technical BSW materialisation through P29). Before writing, re-read exact current main and newest #240/#241. Consume every unmaterialised authoritative BSW Fach handoff **P30→P57 in source order, idempotently and losslessly**. Preserve all existing source IDs/text/hashes and current-law/current-programme/source-claim/competence/additionality/noncompensation guards. Create only deterministic repairs explicitly authorised by each page-specific handoff, including the P56→P57 semantic context replacement and the two U09-A05 children above. No technical Fach/DNS/Recommendation/score synthesis.
