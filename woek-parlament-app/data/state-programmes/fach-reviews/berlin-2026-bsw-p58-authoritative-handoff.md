...
### Current Berlin baseline / additionality / legal guards

1. **BSR is already a public Berlin utility, not a private zero baseline.** Berlin's Beteiligungsdatenbank identifies the Berliner Stadtreinigungsbetriebe as an Anstalt des öffentlichen Rechts with the Land as 100% guarantor; BSR itself describes its waste, street-cleaning and winter-service functions as public-law tasks. References: https://www.berlin.de/sen/finanzen/vermoegen/beteiligungen/beteiligungsdatenbank/index.php/detail/34 and https://www.bsr.de/berichte-und-recht . Therefore U01's `starke öffentliche Stadtreinigung`/`aus einer Hand` language is primarily a governance/coordination target unless a concrete transfer of additional functions is specified; do not render it as creation of public waste management from zero.
2. **Berlin already has a scaled low-barrier bulky-waste/reuse baseline.** BSR reports 616 Kieztage from April 2023 through December 2025, over 260,000 visitors and over 4,500 tonnes, supplementing 14 recycling yards; current 2026 borough Kieztage continue free household bulky-waste/electrical/textile collection and reuse markets. References: https://geschaeftsbericht.bsr.de/2025/nachhaltig-wirtschaften.html and, current example 28.08.2026, https://www.berlin.de/ba-treptow-koepenick/aktuelles/pressemitteilungen/2026/pressemitteilung.1701491.php . U03 must therefore be assessed as a frequency/coverage/mobile-service delta, not zero-to-one creation.
3. **Winter-service duties are already legally allocated and cost recovery for substitute action already exists.** Under current Berlin practice, Anlieger generally carry winter-service duty on adjacent sidewalks; BSR already covers roads, cycle facilities, stops, specified public areas and sidewalks without Anlieger. If duties are breached, Ordnungsämter can order Ersatzvornahme at the liable Anlieger's cost; this was actively used in the 2026 ice crisis. References: https://www.berlin.de/ba-reinickendorf/aktuelles/pressemitteilungen/2025/pressemitteilung.1619984.php , https://service.berlin.de/dienstleistung/326714/ and https://www.berlin.de/ba-tempelhof-schoeneberg/aktuelles/pressemitteilungen/2026/pressemitteilung.1642110.php . Thus U02-A04 is **existing enforcement/cost-recovery baseline**, not a novel effect lever as written.
4. **The 2026 ice crisis demonstrates a genuine coordination/capacity problem but not a simple ownership solution.** Boroughs, Senate, BSR and others required emergency coordination and substitute work; capacity and grit were limiting. Reference: https://www.berlin.de/ba-mitte/aktuelles/pressemitteilungen/2026/pressemitteilung.1639853.php . Moreover the 03.02.2026 VG Berlin decision held that a general emergency authorisation for de-icing agents lacked legal basis; StrReinG environmental restrictions remain a hard design constraint: https://www.berlin.de/gerichte/verwaltungsgericht/presse/pressemitteilungen/2026/pressemitteilung.1640447.php . Any centralisation must preserve safety, environmental and due-process requirements.
...
- `evidence_level = HIGH_FOR_RESPONSIBILITY_REALLOCATION_TO_COORDINATION_MECHANISM / NET_SAFETY_AND_COST_OUTCOME_PENDING`
- `A→M→ΔZ`: statutory/operational transfer of currently fragmented sidewalk/cycle winter duties to BSR → clearer responsibility, central dispatch/prioritisation and potentially fewer coverage gaps → potentially safer/more reliable mobility during snow/ice.
- Competence/delivery: `LAND_BERLIN_STRREING_AND_BSR_GOVERNANCE`; requires explicit legal scope, financing, equipment/staffing, borough interfaces, private-frontage handling, liability and service priorities.
- Existing-system guard: BSR already performs extensive winter-service tasks and substitute action; measure is an additional duty transfer.
- Risks/trade-offs: very large staffing/equipment/cost increase; central capacity bottlenecks during simultaneous citywide ice; weaker local immediacy; priority conflicts; environmental constraints on de-icing agents; potential fee/tax incidence.
- Distribution: pedestrians, wheelchair/rollator users, children/older people, cyclists, boroughs, owners/tenants and taxpayers/fee payers; prioritise schools/ÖPNV/health/accessibility hazards transparently.
...
- `evidence_level = HIGH_FOR_PRICE_DISTANCE_ACCESS_MECHANISM / NET_ILLEGAL_DUMPING_AND_RESOURCE_OUTCOME_PENDING`
- Current-baseline guard: Kieztage/recycling yards/booked pickup already exist. Assess the incremental universal/frequency/service guarantee, not a zero-to-one offer.
- Mechanism: predictable no-user-price local collection → lower time/transport/price friction → more lawful capture/reuse/recycling and potentially fewer illegal deposits.
- Omissions/risks: exact household-vs-site model, appointment/curb logistics, eligible waste, staffing/fleet/storage, peak loads, reuse sorting, displacement of existing services, induced disposal versus repair/reuse, city cost and fee incidence.
- Distribution: households without cars/mobility, low income, older/disabled residents, dense housing, all boroughs; avoid unequal site/frequency access.
...
- `evidence_level = HIGH_FOR_PROXIMITY_ACCESS_MECHANISM / NET_RESOURCE_AND_CLEANLINESS_OUTCOME_PENDING`
- Existing-system guard: current Kieztage are already mobile neighbourhood offers. New effect exists only if this adds frequency, materials, routes, reach or continuity beyond that baseline.
...
#### Mandatory deterministic split: `BE-BSW-P58-U05-A03-9857baf83960`

Frozen atom combines two independent design propositions:
`Wir wollen klare, nachvollziehbare Regeln und konsequente Kontrolle, aber auch günstige, niedrigschwellige Entsorgungsmöglichkeiten für alle.`

Preserve original A03 ID/text/hash as versioned **zero-count parent** and create exactly two deterministic semantic children using the established child-ID convention:

**Child 1 exact text:** `Wir wollen klare, nachvollziehbare Regeln und konsequente Kontrolle.`
- `terminal_fach_state = REVIEWED_NOT_ASSESSABLE_WITH_EXACT_REASON`
- Exact reason: a compliance/enforcement direction is identifiable, but no changed rule, inspection frequency, responsible body, evidence/procedure, sanction, staffing or current-baseline delta is specified. Preserve as governance design target; do not infer increased enforcement effect.

**Child 2 exact text:** `Wir wollen günstige, niedrigschwellige Entsorgungsmöglichkeiten für alle.`
- `terminal_fach_state = REVIEWED_NOT_ASSESSABLE_WITH_EXACT_REASON`
...
- `evidence_level = HIGH_FOR_DEDICATED_TEAM_TO_RESPONSE_ACCOUNTABILITY_MECHANISM / CLEANLINESS_AND_COST_OUTCOME_PENDING`
- Mechanism: stable territorial teams → clearer ownership/local knowledge/shorter handoffs → potentially faster recurring-problem response and cleaner public space.
- Existing-system guard: BSR already has district/route cleaning duties; require proof of new team model, additional capacity or changed task allocation.
...
- `evidence_level = HIGH_FOR_OPERATIONAL_SERVICE_LEVEL_MECHANISM / NET_COST_AND_PREVENTION_OUTCOME_PENDING`
- Mechanism: explicit response SLA → quicker removal of hazards/visual disorder and potentially less accumulation at known hotspots.
- Omissions: what counts as report/contamination, start/stop clock, verification, hazardous waste, access/private-property boundaries, peak-load exceptions, staffing/fleet and prioritisation.
- Distribution: high-reporting vs low-reporting areas, vulnerable pedestrian routes, parks, housing estates; prevent SLA from biasing resources toward digitally vocal neighbourhoods.
...
- `evidence_level = HIGH_FOR_SUPPORT_TO_PARTICIPATION_AND_COLLECTION_OUTPUT / DURABLE_BEHAVIOUR_AND_CLEANLINESS_OUTCOME_PENDING`
- Existing-system guard: campaign already ran citywide in 2026. Assess permanence, support level, reach and complementarity as the delta.
- Mechanism: predictable BSR material/logistics + schools/clubs/neighbourhood mobilisation → lower participation friction and more organised local cleanup → temporary cleanliness/engagement gains and potentially stronger awareness.
- Hard guard: volunteer/school/community labour must supplement, not replace, statutory/professional cleaning or hazardous-waste handling.
...
- `evidence_level = HIGH_FOR_FUNDING_PRIORITY_TO_R_AND_D_CAPACITY_MECHANISM / REPLACEMENT_AND_TRANSLATIONAL_OUTCOME_PENDING`
- Existing-system guard: Berlin/Charité/Bund already operate 3R/alternatives research and funding. Credit only an additional Berlin funding-priority delta.
- `A→M→ΔZ`: redirect/increase eligible public research funding toward animal-free methods → more R&D/validation/standardisation/translation capacity → potentially more questions addressed with valid non-animal methods and fewer/less burdensome animal experiments where replacement is scientifically and regulatorily accepted.
- Competence/boundary: Land-controlled university/research/funding programmes can create incentives; federal/EU scientific/regulatory requirements and independent research governance remain binding.
- Omissions: which public funds, priority weight, eligibility, peer-review/scientific-quality criteria, method-validation pathway, transition, protected fundamental/research obligations, additionality to existing Charité/Bf3R/Bund funding.
- Noncompensation: animal-welfare benefit cannot justify scientifically invalid/unsafe methods; scientific utility cannot erase avoidable animal harm where validated alternatives exist. Keep both protection dimensions visible.
- Reality check: additional funded replacement projects/capacity, validation/acceptance, actual substitution/reduction by research field, translational performance, research quality/safety and crowd-out; grant count alone is not replacement outcome.

### G. P58 terminality

After the U05-A03 two-child semantic repair:
- structural/context U04/U07/U09 = reviewed zero-count;
- U08 = reviewed source diagnosis/history/rationale zero-count;
- original U05-A03 = versioned zero-count parent;
- deterministic children required under U05-A03 = `2`, both exact RNAA for underspecified governance/access targets;
- explicit Fach original atoms = `U02-A03`, `U03-A02`, `U03-A03`, `U05-A05`, `U05-A06`, `U06-A04`, `U10-A06`;
- exact RNAA original = `U01-A04`, `U10-A05`;
- U02-A04 = existing-baseline restatement, zero-count;
- all other diagnosis/goal/causal/normative atoms = explicit reviewed non-effect classifications above.
...
Current exact GitHub main re-verified immediately before this handoff: `2f5d5d896eb1a8e851529a31139bfa57b00eca84` (merged PR #324, technical BSW materialisation through P29). Before write, re-read exact current main and newest #240/#241. Consume every still-unmaterialised authoritative BSW Fach handoff **P30→P58 in source order, idempotently and losslessly**. Preserve original IDs/text/hashes and all current-law/current-programme/source-claim/competence/additionality/noncompensation guards. Create only deterministic splits/repairs explicitly authorised by page-specific handoffs, including P58-U05-A03's two exact children. No technical Fach/DNS/Recommendation/score synthesis.
