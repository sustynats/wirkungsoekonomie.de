...
export const jurisdictions: Jurisdiction[] = [
  ...
  },
  {
    ...
    referenceFramework: [
      ...
      {
        id: "sachsen-anhalt-woek-sdg-plus",
        label: "SDG+ der Wirkungsökonomie",
        authority: "GLOBAL",
        stability: "ENDURING",
        description: "SDG+ ist eine transparente WÖk-Erweiterung, keine offizielle UN-Kategorie. Sie macht etwa Medien- und Informationsqualität, Rechtsstaatlichkeit, Diskursfähigkeit, institutionelles Vertrauen und digitale Selbstbestimmung genauer sichtbar.",
        sourceSlug: "woek-reference-framework"
      },
      {
        id: "sachsen-anhalt-mpd",
        label: "Mensch – Planet – Demokratie",
        authority: "CROSS_JURISDICTION",
        stability: "ENDURING",
        description: "Die WÖk ordnet Wirkungsräume systemisch. Mensch, Planet und Demokratie werden nicht zu drei frei verrechenbaren Säulen; Demokratie ist zugleich Wirkungsraum, Schutzgut und Korrekturraum.",
        sourceSlug: "woek-reference-framework"
      },
      {
