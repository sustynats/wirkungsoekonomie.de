...
test("only approved deep dives are projected and no recommendation is generated", () => {
  assert.deepEqual(Object.keys(missionDeepDives).sort(), ["WOEK-AKN-2026-M02", "WOEK-AKN-2026-M04"]);
...
test("restore-first audit records the recovered canonical Fachbestand", () => {
  ...
  assert.deepEqual(audit.after.full_deep_dives, ["WOEK-AKN-2026-M02", "WOEK-AKN-2026-M04"]);
