...
export default function Page() { return <><p className="shell"><InstitutionRegisterLink level="land">Landesbezogene Akten im gemeinsamen Register</InstitutionRegisterLink></p><StatesPage /><HomeStatesContext /></>; }
