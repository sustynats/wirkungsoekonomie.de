...
function Transparency() {
  return <div className="trust-center">
    <section className="trust-statement" aria-labelledby="trust-statement-title">
      ...
      <p>Das Wirkungsportal Parlament wird vom Institut für Wirkungsökonomie herausgegeben. Es ist kein Angebot des Deutschen Bundestages, keiner Partei und keiner Fraktion. Es untersucht parlamentarische Entscheidungen: vor einer Abstimmung ihr Wirkungspotenzial, im Rückblick beobachtete Veränderungen und den belegbaren Beitrag der Entscheidung. Grundlage sind offengelegte Quellen, Annahmen und Grenzen.</p>
    </section>
    ...
    <section className="reference-framework" id="referenzrahmen" aria-labelledby="reference-framework-title">
      <div className="reference-framework-intro">
        ...
        <h2 id="reference-framework-title">Woran wird Wirkung gemessen?</h2>
          <p className="lead">Wirkung ist zunächst eine Zustandsveränderung. Ob sie wünschenswert, schädlich oder gemischt ist, braucht einen offengelegten Maßstab. Das Portal verwendet dafür keinen Bauchentscheid und kein Parteiprogramm, sondern einen öffentlich vereinbarten Referenzrahmen.</p>
      </div>
