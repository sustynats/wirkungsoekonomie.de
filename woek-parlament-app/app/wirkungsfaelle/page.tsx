...
export default function ImpactCasesPage() {
  ...
  return <main className="shell content-page impact-case-index">
    <header className="page-intro">
      ...
      <p className="lead">Ein Gesetzentwurf, ein Kabinettsbeschluss und die spätere Verkündung können Stationen derselben Sache sein. Deshalb bündelt ein WÖk-Wirkungsfall den fachlich zusammengehörenden Wirkungsgegenstand - ohne Prozessschritte doppelt zu bewerten.</p>
    </header>
    ...
    <section className="section section-compact" aria-labelledby="current-impact-cases">
      <p className="eyebrow">Gemeinsames Fachmodell</p><h2 id="current-impact-cases">Aktuelle WÖk-Wirkungsfälle</h2>
