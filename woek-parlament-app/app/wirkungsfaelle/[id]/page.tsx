...
export default async function ImpactCasePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="shell content-page"><p className="record-context"><Link href="/wirkungsfaelle">Wirkungsfälle</Link><span aria-hidden="true">/</span><span>{record.title}</span></p><GovernmentImpactCase record={record} includeProcess={false} />
