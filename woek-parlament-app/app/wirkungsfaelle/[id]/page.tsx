...
export default async function ImpactCasePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <div className="shell content-page"><nav className="breadcrumb" aria-label="Pfad"><Link href="/wirkungsfaelle">Wirkungsfälle</Link><span aria-hidden="true">/</span><span>{record.title}</span></nav><GovernmentImpactCase record={record} includeProcess={false} />
