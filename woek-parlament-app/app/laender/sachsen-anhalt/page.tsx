...
export const metadata = {
  ...
  description: "Originalprogramme, vollständige freigegebene WÖk-Wirkungsakten und strukturierte Zusageregister zur Landtagswahl Sachsen-Anhalt 2026."
};
  ...
  return (
    <main>
      <section className="shell state-hero-shell">
        <div className="state-hero">
          <div>
            ...
            <h1>Welche Vorschläge machen die Programme für Sachsen-Anhalt - und welche Wirkungen sind fachlich zu prüfen?</h1>
            <p className="lead">Zur Landtagswahl am {electionDate} dokumentiert das Portal die Wahlprogramme mit Originalquelle, Fassung, vollständiger freigegebener WÖk-Wirkungsakte und Zusageregister.</p>
            <div className="hero-actions">
              <Link className="button button-primary" href="#wahlprogramme">6 Wahlprogramme und Wirkungsakten</Link>
          ...
          <aside className="state-hero-fact" aria-label="Einordnung des Wahlbereichs">
            ...
            <h2>Programme sind Versprechen, noch keine eingetretene Wirkung.</h2>
            <p>Die veröffentlichten Fachakten halten getrennt fest, was vorgeschlagen wird, welche Wirkungspfade und Risiken dokumentiert sind und welche Evidenz- oder Datenfragen offen bleiben. Eine Parteizugehörigkeit ist kein Bewertungskriterium.</p>
            <dl>
              <div><dt>Wahltag</dt><dd>{electionDate}</dd></div>
              <div><dt>28 Landesziele</dt><dd>mit Fundstelle und SDG-Bezug</dd></div>
              <div><dt>Wahlprogramme</dt><dd>6 vollständige WÖk-Wirkungsakten</dd></div>
            </dl>
          </aside>
        </div>
      </section>
      ...
      <section className="shell section section-surface state-publication-status" aria-labelledby="state-status-title">
        <div><p className="eyebrow">Referenzrahmen, Programme und Wirkungsakten</p><h2 id="state-status-title">Landesziele, Programmquellen und Wirkungsprüfung bleiben getrennt nachvollziehbar.</h2><p className="lead">Die landeseigenen Nachhaltigkeitsziele sind mit ihren Fundstellen veröffentlicht. Für jedes der sechs vorliegenden Wahlprogramme gibt es eine vollständige freigegebene WÖk-Wirkungsakte und ein Zusageregister.</p></div>
        <ul>
          ...
          <li><strong>2. Programme und Wirkungsakten</strong><span>Die sechs vorhandenen Programme liegen mit Fassung, Fundstellen, strukturierten Zusagen und vollständiger WÖk-Wirkungsakte vor.</span></li>
      ...
      <section className="shell section" id="wahlprogramme" aria-labelledby="state-programmes-title">
        <div className="section-heading"><div><p className="eyebrow">Wahlprogramme im Wirkungscheck</p><h2 id="state-programmes-title">Sechs Programme. Sechs vollständige Wirkungsakten.</h2><p className="lead">Die Akten verbinden Programmfassung, Originalfundstellen, strukturierte Zusagen und die vollständige freigegebene WÖk-Wirkungsanalyse. Sie bewerten keine Parteien oder Personen und geben keine Wahlempfehlung.</p></div></div>
        <div className="source-register state-programme-register">
          {saxonyAnhaltElectionProgrammes.map((programme) => {
            ...
            return <article key={programme.sourceKey} data-woek-preview-card={review ? "published" : "fact-only"}>
              ...
              {review ? <Link className="text-link" href={`/laender/sachsen-anhalt/wahlprogramme/${programme.sourceKey}`}>Wirkungsakte ansehen <span aria-hidden="true">→</span></Link> : <p><strong>Fachakte derzeit nicht verfügbar.</strong></p>}
            </article>;
          })}
        </div>
      </section>
      ...
      <section className="shell section state-next" aria-labelledby="state-next-title">
        ...
        <ol>
          <li><span>01</span><div><h3>Wahlprogramme</h3><p>Welche Vorschläge stehen in den Originalfassungen? Die freigegebenen Wirkungsakten zeigen Wirkungspfade, Risiken, Bedingungen und offene Evidenzfragen.</p></div></li>
