...
export const metadata: Metadata = {
  title: "Nachhaltigkeitsziele Sachsen-Anhalt | Wirkungsportal Parlament",
...
export default function SaxonyAnhaltTargetsPage() {
  ...
  return <main className="shell content-page state-targets-page">
    <nav className="breadcrumb" aria-label="Pfad"><Link href="/laender">Länder</Link><span aria-hidden="true">/</span><Link href="/laender/sachsen-anhalt">Sachsen-Anhalt</Link><span aria-hidden="true">/</span><span>Landesziele</span></nav>
