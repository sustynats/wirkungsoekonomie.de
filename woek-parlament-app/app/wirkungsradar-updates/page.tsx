  ...
  return (
    <div className="shell content-page">
      ...
      <section className="subscription-boundary" aria-labelledby="communication-boundary-title">
        ...
        <div><p>Jede Nachricht enthält den parlamentarischen Gegenstand, den aktuellen Verfahrensstand, die wichtigste offene Wirkungsfrage und den Link zu Quellen und Analyse.</p><p>Eine allgemeine Nachricht wird nur an bestätigte Anmeldungen versendet. Abgeordnete und Mandatsbüros werden nicht über eine bloße Erstkontaktmail in einen regelmäßigen Verteiler aufgenommen.</p></div>
      </section>
