...
def validate() -> dict:
    ...
    require(berlin_fach["summary"]["remaining_page_review_envelopes"] == 1190, "ISSUE_241_BE_FACH_ENVELOPE_COUNT_DRIFT")
    require(berlin_fach["summary"]["remaining_exact_effect_objects_identified"] == 0, "ISSUE_241_BE_FACH_EXACT_OBJECT_COUNT_DRIFT")
    require(berlin_fach["summary"]["remaining_review_scope_count"] == 1190, "ISSUE_241_BE_FACH_SCOPE_COUNT_DRIFT")
    ...
    require(berlin_state["spd_materialised_terminal_pages"] == spd_scope["materialized_page_set"] == [22, 23, 24, 25], "ISSUE_241_BE_SPD_TERMINAL_PAGE_DRIFT")
    ...
    require(current_readiness["blocking_lanes"]["berlin"]["remaining_review_envelopes"] == 1190, "ISSUE_241_CURRENT_GOLDEN_BE_RESIDUAL_DRIFT")
    ...
    require(current_readiness["blocking_lanes"]["berlin"]["remaining_review_scopes"] == 1190, "ISSUE_241_CURRENT_GOLDEN_BE_SCOPE_DRIFT")
    ...
    require(fach[0]["remaining_review_envelopes"] == 1190, "ISSUE_241_BE_FACH_FINITE_ENVELOPE_DRIFT")
    require(fach[0]["remaining_exact_effect_objects_identified"] == 0, "ISSUE_241_BE_FACH_FINITE_EXACT_OBJECT_DRIFT")
    require(fach[0]["remaining_review_scopes"] == 1190, "ISSUE_241_BE_FACH_FINITE_SCOPE_DRIFT")
