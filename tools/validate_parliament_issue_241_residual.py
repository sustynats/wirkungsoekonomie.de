...
def validate() -> dict:
    ...
    require(berlin_fach["summary"]["remaining_review_scope_count"] == 1232, "ISSUE_241_BE_FACH_SCOPE_COUNT_DRIFT")
    ...
    require(current_readiness["blocking_lanes"]["berlin"]["remaining_review_scopes"] == 1232, "ISSUE_241_CURRENT_GOLDEN_BE_SCOPE_DRIFT")
    ...
    require(fach[0]["remaining_review_scopes"] == 1232, "ISSUE_241_BE_FACH_FINITE_SCOPE_DRIFT")
