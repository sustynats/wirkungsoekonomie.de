...
def validate(actual: dict, expected: dict) -> None:
    ...
    if (berlin["programme_analysis_complete"], berlin["programme_analysis_open"], berlin["remaining_review_envelopes"], berlin["remaining_exact_effect_objects_identified"], berlin["remaining_review_scopes"]) != (3, 9, 1259, 0, 1259):
