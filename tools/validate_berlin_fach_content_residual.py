...
def validate_boundary(matrix: dict, register: dict) -> None:
    ...
    expected = {
        ...
        "remaining_genuine_fach_review_required": 1228,
        "remaining_review_scope_count": 1228,
        "remaining_page_review_envelopes": 1228,
        "remaining_exact_effect_objects_identified": 0,
        "remaining_exact_effect_object_count": None,
        "terminal_source_objects": 1149,
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "programmes_open": 9,
        "terminal_source_objects": 1149,
        "remaining_review_envelopes": 1228,
        "remaining_exact_objects": 0,
        "remaining_review_scopes": 1228,
        "known_segmentation_defects": 2,
