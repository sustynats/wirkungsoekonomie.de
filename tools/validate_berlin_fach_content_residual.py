...
def validate_boundary(matrix: dict, register: dict) -> None:
    ...
    require(matrix.get("base_main_commit") == "272c427673c3b1da847af5294ed744c84c2b85cd", "base main commit drift")
    ...
    expected = {
        ...
        "remaining_genuine_fach_review_required": 1260,
        "remaining_review_scope_count": 1260,
        "remaining_page_review_envelopes": 1260,
        "remaining_exact_effect_objects_identified": 0,
        "remaining_exact_effect_object_count": None,
        "terminal_source_objects": 305,
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "programmes_open": 9,
        "terminal_source_objects": 305,
        "remaining_review_envelopes": 1260,
        "remaining_exact_objects": 0,
        "remaining_review_scopes": 1260,
        "known_segmentation_defects": 2,
