...
def validate_boundary(matrix: dict, register: dict) -> None:
    ...
    require(matrix.get("base_main_commit") == "130d94a7b4f1ab8d7c6addcd4783123d5d43fdec", "base main commit drift")
    ...
    expected = {
        ...
        "remaining_genuine_fach_review_required": 1259,
        "remaining_review_scope_count": 1259,
        "remaining_page_review_envelopes": 1259,
        "remaining_exact_effect_objects_identified": 0,
        "remaining_exact_effect_object_count": None,
        "terminal_source_objects": 346,
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "programmes_open": 9,
        "terminal_source_objects": 346,
        "remaining_review_envelopes": 1259,
        "remaining_exact_objects": 0,
        "remaining_review_scopes": 1259,
        "known_segmentation_defects": 2,
