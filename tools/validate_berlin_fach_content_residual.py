...
def validate_boundary(matrix: dict, register: dict) -> None:
    ...
    expected = {
        ...
        "remaining_genuine_fach_review_required": 1224,
        "remaining_review_scope_count": 1224,
        "remaining_page_review_envelopes": 1224,
        "remaining_exact_effect_objects_identified": 0,
        "remaining_exact_effect_object_count": None,
        "terminal_source_objects": 1235,
...
def main() -> None:
    ...
    print(json.dumps({
        ...
        "programmes_open": 9,
        "terminal_source_objects": 1235,
        "remaining_review_envelopes": 1224,
        "remaining_exact_objects": 0,
        "remaining_review_scopes": 1224,
        "known_segmentation_defects": 2,
